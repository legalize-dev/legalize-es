...
Pueden declararse zonas de especial protección de la calidad acústica (ZEPCA) aquellas áreas en las que por sus singularidades características se considera conveniente conservar una calidad acústica de interés especial, siempre que no estén comprendidas en las zonas de ruido descritas en el artículo 6 de esta Ley, que no se sobrepase entre las 8 h y las 21 h un valor límite de inmisión L<sub>Ar</sub> de 50 dB(A) y entre las 21 h y las 8 h un valor límite de inmisión L<sub>Ar</sub> de 40 dB(A). En estas zonas el valor límite de inmisión se considera el valor del ruido de fondo más 6 dB(A).
