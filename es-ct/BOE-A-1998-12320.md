...
## TÍTULO IV. Gestión del dominio público portuario adscrito a Puertos de la Generalidad
...
La cuantía básica de la tarifa es de 12,09 euros por cada 100 toneladas de registro bruto (o por cada 100 unidades de arqueo) o fracción, en función del tiempo de estancia, con los siguientes coeficientes:
...
La cuantía básica de esta tarifa es de 1,56 euros, con los siguientes coeficientes:
...
| Concepto | Navegación y cruceros turísticos | Navegación y cruceros turísticos |
| --- | --- | --- |
| Concepto | Interior en la UE | Exterior en la UE |
| A) Pasajeros: |  |  |
| Bloque I | 2,27 euros | 5,20 euros |
| Bloque II | 0,81 euros | 2,61 euros |
| Buque turístico local | 0,05 euros | – |
| B) Vehículos: |  |  |
| Motocicletas y vehículos o remolques de dos ruedas | 1,30 euros | 1,96 euros |
| Coches, turismos y demás vehículos automóviles | 3,57 euros | 4,55 euros |
| Autocares y demás vehículos de tr. colectivo | 16,26 euros | 26,02 euros |
...
| Pesetas/unidad de carga | Con carga | Con carga | Vacía |
| --- | --- | --- | --- |
| Pesetas/unidad de carga | Embarque | Desembarque | Vacía |
| Contenedor menor de 20' | 26,36 euros | 40,46 euros | 3,07 euros |
| Contenedor mayor de 20' | 43,52 euros | 66,21 euros | 6,13 euros |
| Plataforma con contenedor menor de 20' | 28,20 euros | 42,30 euros | 4,91 euros |
| Plataforma con contenedor mayor de 20' | 47,21 euros | 69,89 euros | 6,13 euros |
| Semirremolque | 47,21 euros | 69,89 euros | 6,13 euros |
| Camión con caja de hasta 6 m. | 29,43 euros | 43,52 euros | 6,13 euros |
| Camión con caja de hasta 12 m. | 49,65 euros | 72,34 euros | 12,26 euros |
...
| --- | --- |
| 1. Utilización de las aguas del puerto | 0,54 euros |
| 2. Anclaje a muerto | 1,08 euros |
| 3. Atraque en punta | 1,30 euros |
| 4. Atraque de costado | 3,55 euros |
| 5. Botadura en zona de tierra | 0,54 euros |
| Servicios adicionales: |  |
| a) Atraque con amarra a muerto | 0,32 euros |
| b) Acometidas de agua | 0,32 euros |
| c) Recogida de basura | 0,22 euros |
| d) Vigilancia general de la zona | 0,22 euros |
| e) Atraque o fondeo en instalaciones exclusivamente de temporada | 0,43 euros |
| f) Acometidas de energía eléctrica | 0,22 euros |
| g) Cabrestantes y escalas en zonas de botadura | 0,22 euros |
| h) Personal de ayuda en zonas de botadura | 0,43 euros |
...
| Mercancías | Sup. cubierta | Sup. descubierta |
| --- | --- | --- |
| Zonas de tránsito: |  |  |
| Días 1 al 3 | 0,32 euros |  |
| Días 4 al 10 | 0,54 euros | 0,22 euros |
| Días 11 al 17 | 1,08 euros | 0,32 euros |
| Días 18 en adelante | 2,15 euros | 0,87 euros |
| Zonas de almacenaje | 0,43 euros | 0,22 euros |
| Otros usos: |  |  |
| Temporada alta (del 1 de junio al 30 de septiembre) | 2,70 euros |  |
| Temporada baja | 1,30 euros |  |
...
a) Rampa de botadura: 6,49 euros por operación, por día de utilización y por metros de eslora, y no incluye el vehículo ni el remolque.

b) Carros de botadura:

Izada o botadura: 0,65 euros por metro lineal de eslora por manga.

Estancia en la zona de reparación: 0,32 euros por día y por metro lineal de eslora por manga.

c) Pórticos elevadores:

Izada o botadura: 14,99 por metro de eslora.

Inmovilización: 20,01 euros por hora. La prestación de este servicio queda condicionada a la disponibilidad del servicio.

Estancia en la zona de reparación: 2,26 euros por día y por metro lineal de eslora.
...
Subida o bajada: 19,44 euros por operación.

1. Es de aplicación en las operaciones de menos de treinta minutos. Para operaciones de más de treinta minutos, la cuantía es de 9,72 euros cada media hora o fracción de exceso.

2. Estancias: 0,22 euros por metro cuadrado y día. Las embarcaciones pesqueras disfrutan de un día de carencia.
...
Recogida de desperdicios: 1,53 euros por metro de eslora y por semana o fracción.

Suministro de energía y agua: 0,36 euros por metro de eslora por día.

Alquiler de máquina de limpieza a presión: 26,17 euros por hora.
