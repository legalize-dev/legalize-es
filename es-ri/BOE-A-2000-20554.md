...
2. Para los vertidos procedentes de usuarios domésticos, el importe del canon se obtendrá aplicando al volumen de agua consumido en el período de facturación el coeficiente 0,26.
...
I = 0,26*Q(K1*SS/SS<sub>0</sub> + K2*DQO/DQO<sub>0</sub> + K3*C/C<sub>0</sub>)
