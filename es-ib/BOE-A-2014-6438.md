...
a) Para los núcleos existentes de carácter tradicional que tengan unas tipologías predominantes de casco antiguo y de zonas intensivas y con una población inferior a 3.000 habitantes, la proporción de espacios libres públicos no podrá ser inferior a 1,5 m2 por habitante.

b) Para los núcleos del mismo carácter y tipología anteriores y con una población entre 3.000 y 6.000 habitantes, la proporción no podrá ser inferior a 3 m2 por habitante.

c) Para el resto de casos, la proporción no será inferior a 5 m2 por habitante.
