...
### CAPÍTULO IV. Tasa por la licencia de pesca continental y la matrícula de embarcaciones
...
|  |  | EUROS |
| --- | --- | --- |
| TARIFA 1. | Construcción, reconstrucción o aumento de volumen de edificaciones. Establecimiento de estaciones de servicio e instalación de aparatos distribuidores de gasolina y lubricantes: | Construcción, reconstrucción o aumento de volumen de edificaciones. Establecimiento de estaciones de servicio e instalación de aparatos distribuidores de gasolina y lubricantes: |
| TARIFA 1. | 1. Con presupuesto hasta 3.000 euros: | 37,80 |
| TARIFA 1. | 2. Con presupuesto de 3.000 a 6.000 euros: | 73,50 |
| TARIFA 1. | 3. Con presupuesto de 6.000 a 12.000 euros: | 95,50 |
| TARIFA 1. | 4. Con presupuesto de 12.000 a 30.000 euros: | 149,10 |
| TARIFA 1. | 5. Con presupuesto de más de 30.000 euros: | 199,50 |
| TARIFA 2. | Realización de obras de conservación de edificaciones: | Realización de obras de conservación de edificaciones: |
| TARIFA 2. | 1. Con presupuesto hasta 3.000 euros: | 31,50 |
| TARIFA 2. | 2. Con presupuesto de 3.000 a 6.000 euros: | 39,90 |
| TARIFA 2. | 3. Con presupuesto de más de 6.000 euros: | 52,50 |
| TARIFA 3. | Construcción de cierre o muro de sostenimiento o contención: | Construcción de cierre o muro de sostenimiento o contención: |
| TARIFA 3. | 1. Cierre no diáfano (obra de fábrica o seto vivo), por metro lineal: | 3,57 (T.m.26) |
| TARIFA 3. | 2. Cierre diáfano (estaca y alambre o malla), por metro lineal: | 1,73 (T.m.26) |
| TARIFA 3. | 3. Muro de contención o de sostenimiento, por metro lineal: | 4,83 (T.m.26) |
| TARIFA 4. | Canalización subterránea de agua, electricidad, gas, teléfono, etc.: | Canalización subterránea de agua, electricidad, gas, teléfono, etc.: |
| TARIFA 4. | 1. Conducción por las zonas de protección: | 1,73 (T.m.27) |
| TARIFA 4. | 2. Cruce de calzada hasta diámetro de 1,00 metros por metro lineal: | 4,83 (T.m.27) |
| TARIFA 4. | 3. Cruce de calzada por medio de obra de fábrica o puente, incluido desvío provisional: | 150,20 |
| TARIFA 5. | Instalación de tendidos aéreos: | Instalación de tendidos aéreos: |
| TARIFA 5. | 1. Cada poste o torre metálica para la línea alta tensión en zonas de protección: | 10,34 (T.m.50) |
| TARIFA 5. | 2. Cada poste para línea de baja tensión u otros tendidos en zonas de protección: | 4,83 (T.m.34) |
| TARIFA 5. | 3. Cruce de carretera con línea de alta tensión: por cada metro lineal sobre la explanación: | 4,10 (T.m.50) |
| TARIFA 5. | 4. Cruce de carretera con línea de baja tensión y otros tendidos: por cada metro lineal sobre la explanación: | 2,94 (T.m.34) |
| TARIFA 5. | 5. Cada centro de transformación en zonas de protección: | 57,80 |
| TARIFA 6. | Vías de acceso, intersecciones y enlaces: | Vías de acceso, intersecciones y enlaces: |
| TARIFA 6. | 1. Construcción, reparación y acondicionamiento de vías de acceso a fincas, pavimentaciones, aparcamientos o aceras: | 37,80 |
| TARIFA 6. | 2. Construcción de intersecciones a nivel y enlaces a distinto nivel: | 194,30 |
| TARIFA 7. | Acopio materiales de cantera y forestales: | Acopio materiales de cantera y forestales: |
| TARIFA 7. | 1. Por tiempo inferior a seis meses: | 34,10 |
| TARIFA 7. | 2. Hasta un año: | 55,10 |
| TARIFA 8. | Obras y aprovechamientos de naturaleza diversa: | Obras y aprovechamientos de naturaleza diversa: |
| TARIFA 8. | 1. Corte y plantación de arbolado: | 37,80 |
| TARIFA 8. | 2. Instalación de básculas: | 37,80 |
| TARIFA 8. | 3. Construcción de fosa séptica en zona de protección: | 41,00 |
| TARIFA 8. | 4. Construcción de depósito subterráneo de agua o gas y arquetas: | 38,50 |
| TARIFA 8. | 5. Instalación de señales informativas y carteles, por unidad: | 34,10 |
| TARIFA 8. | 6. Demolición de edificios: | 34,10 |
| TARIFA 8. | 7. Explanación y relleno de fincas: | 34,10 |
| TARIFA 8. | 8. Para toda clase de obras no comprendidas en los apartados anteriores: | 34,10 |
...
| 8. | Paso de vehículos pesados por carreteras con limitación de tonelaje: | 20 euros por viaje y km recorrido. (Mínimo 1.000 euros y máximo 30.000 euros por km recorrido). |
...
|  | 3. Por la realización de la inspección a la explotación necesaria para la expedición de un documento de exportación TRACES. Tasa por inspección. | 50 |
