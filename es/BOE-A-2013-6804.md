...
| **Nombre/ Tipología/ periodo de devengo ejercicio t** | **Denominación del Plan y fecha de implantación** | **N.º opciones** | **N.º Acciones afectadas** | **Precio de ejercicio** **(€)** | **Plazo de ejercicio** | **N.º opciones** | **N.º Acciones afectadas** | **Precio de ejercicio** **(€)** | **Plazo de ejercicio** | **Condiciones para su ejercicio** | **N.º Precio Importe** |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **Nombre/ Tipología/ periodo de devengo ejercicio t** | **Denominación del Plan y fecha de implantación** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Acciones entregadas durante el ejercicio t** |
| **Consejero 1** | **Plan 1** |  |  |  |  |  |  |  |  |  |  |
| **Consejero 1** | **Plan 2** |  |  |  |  |  |  |  |  |  |  |
...
| **Nombre/ Tipología/período de devengo total en ejercicios** | **Ejercicio t** | **Ejercicio t-1** | **Ejercicio t** | **Ejercicio t-1** |
| --- | --- | --- | --- | --- |
| **Nombre/ Tipología/período de devengo total en ejercicios** | **Aportación del ejercicio por parte de la sociedad** **(miles €)** | **Aportación del ejercicio por parte de la sociedad** **(miles €)** | **Importe de los fondos acumulados** **(miles €)** | **Importe de los fondos acumulados** **(miles €)** |
| **Consejero 1** |  |  |  |  |

**iv) Otros beneficios (en miles de €)**

| **Nombre/ Tipología** | **Tipo de interés de la operación** | **Tipo de interés de la operación** | **Características esenciales de la operación** | **Características esenciales de la operación** | **Importes eventualmente devueltos** | **Importes eventualmente devueltos** |
| --- | --- | --- | --- | --- | --- | --- |
...
| **Nombre/ Tipología** | **Ejercicio t** | **Ejercicio t-1** | **Ejercicio t** | **Ejercicio t-1** |
| --- | --- | --- | --- | --- |
| **Nombre/ Tipología** | **Primas de seguros de vida** | **Primas de seguros de vida** | **Garantías constituidas por la sociedad a favor de los consejeros** | **Garantías constituidas por la sociedad a favor de los consejeros** |
| **Consejero 1** |  |  |  |  |
| **Consejero 2** |  |  |  |  |
...
| **Nombre/ Tipología/ periodo de devengo ejercicio t** | **N.º opciones** | **N.º Acciones afectadas** | **Precio de ejercicio** **(€)** | **Plazo de ejercicio** | **N.º opciones** | **N.º Acciones afectadas** | **Precio de ejercicio** **(€)** | **Plazo de ejercicio** | **Condiciones para su ejercicio** | **N.º Precio Importe** |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **Nombre/ Tipología/ periodo de devengo ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Titularidad de opciones al principio del ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Opciones asignadas durante el ejercicio t** | **Acciones entregadas durante el ejercicio t** |
| **Consejero 1** |  |  |  |  |  |  |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | **Retribución devengada en la Sociedad** | **Retribución devengada en la Sociedad** | **Retribución devengada en la Sociedad** | **Retribución devengada en la Sociedad** | **Retribución devengada en sociedades del grupo** | **Retribución devengada en sociedades del grupo** | **Retribución devengada en sociedades del grupo** | **Retribución devengada en sociedades del grupo** | **Totales** | **Totales** | **Totales** |
| **Consejero 1** |  |  |  |  |  |  |  |  |  |  |  |
| **Total:** |  |  |  |  |  |  |  |  |  |  |  |
