...
| --- | --- | --- | --- |
| Pesca artesanal (Inferior a 12 metros). | Pesca artesanal (Inferior a 12 metros). | 20,01 | 31,73 |
...
| Resto flota. | HOK (anzuelo). | 5,33 | 59,90 |
| Resto flota. | DTS (arrastre). | 6,20 | 91,35 |
| Resto flota. | PS (cerco). | 6,82 | 171,92 |
