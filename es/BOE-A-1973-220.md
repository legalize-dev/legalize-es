...
El coeficiente K1 se aplicará a las tarifas base de cada concesión (T0), obteniéndose así las tarifas revisadas para el momento t (Tt):

### Tt = Kt . T0

Los símbolos empleados representan lo siguiente:

Kt-1 Corresponde al valor del coeficiente K1, obtenido en la revisión inmediatamente anterior a aquella de que se trate.
