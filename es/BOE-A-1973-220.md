...
El coeficiente K<sub>t</sub> se aplicará a las tarifas inicialmente aprobadas en el Decreto de Adjudicación (T<sub>0</sub>), obteniéndose así la tarifa, revisada por el momento t (T<sub>t</sub>).
