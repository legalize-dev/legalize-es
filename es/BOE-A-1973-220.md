...
| K<sub>t</sub> = 0,30 | H<sub>t</sub> | + 0,12 | E<sub>t</sub> | + 0,08 | S<sub>t</sub> | + 0,50 |
| --- | --- | --- | --- | --- | --- | --- |
| K<sub>t</sub> = 0,30 | H<sub>0</sub> | + 0,12 | E<sub>0</sub> | + 0,08 | S<sub>0</sub> | + 0,50 |

El coeficiente K<sub>t</sub> se aplicará a les tarifas inicialmente aprobadas en el Decreto de adjudicación (T<sub>0</sub>), obteniéndose así la tarifa revisada para el momento t (T<sub>t</sub>).
...
El coeficiente K<sub>t</sub> se calculará a través de los índices de precios para revisión de contratos de obras del Estado que publica periódicamente el Gobierno.
