...
pdf_url: "https://www.boe.es/boe/dias/2021/09/23/pdfs/BOE-A-2021-15436.pdf"
subjects: ["Consumidores y usuarios", "Consumo de energía", "Energía eléctrica", "Información", "Reglamentaciones técnicas"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2021-15436"
...
references_previous: "DE CONFORMIDAD con BOE-A-2020-16350"
---
...
![1](https://www.boe.es/datos/imagenes/disp/2021/228/15436_5241.png)

– Si no se dispone de Progh o no se dispone de P<sub>h</sub> para la hora h:

### Error_horario<sub>h</sub> = 1

– Si Progh> 0 kWh:

• Si Progh > 5 % de la potencia contratada máxima o P<sub>h</sub>> 5 % de la potencia contratada máxima:

![2](https://www.boe.es/datos/imagenes/disp/2021/228/15436_5322.png)

• Si Progh≤ 5 % de la potencia contratada máxima y P<sub>h</sub>< 5 % de la potencia contratada máxima:

### Error_horario<sub>h</sub> = 0

– Si Progh = 0 kWh:

### Si P<sub>h</sub> = 0 kWh → Error<sub>horario</sub><sub>h</sub> = 0

### Si P<sub>h</sub> > 0 kWh → Error<sub>horario</sub><sub>h</sub> = 1
...
– P<sub>h</sub>: Consumo horario de energía en la hora h (kWh) registrado en el concentrador principal, incluyendo la energía autoconsumida.

– Prog<sub>h</sub>: Último programa de consumo horario para la hora h (kWh) recibido.

– Error_previsión: Desviación mensual del consumo respecto a los programas (%).

– Error<sub>horario</sub><sub>h</sub>: Desvío horario del consumo respecto a los programas en la hora h.
