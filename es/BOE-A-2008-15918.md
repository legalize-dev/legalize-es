...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 001. Expediente de contrato de obras. | 001. Expediente de contrato de obras. | 001. Expediente de contrato de obras. | 001. Expediente de contrato de obras. | 001. Expediente de contrato de obras. |
| 017. Expediente de contrato de concesión de obra pública | 017. Expediente de contrato de concesión de obra pública | 017. Expediente de contrato de concesión de obra pública | 017. Expediente de contrato de concesión de obra pública | 017. Expediente de contrato de concesión de obra pública |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
...
| Fecha de Firma del Contrato. |  | X | X |  |
...
| Fecha Firma nuevo contrato (Reformados) |  | X | X | Solo para el caso de contratos reformados. |
...
| Cesionario. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
| Fecha de Cesión. (*) |  |  | X |  |
| Fecha de Resolución del Contrato. (*) |  |  | X |  |
| DATOS DE CERTIFICACIÓN/ABONO (Fase O) |  |  |  |  |
| Código tipo de Certificación. | X | X | X | Según la siguiente codificación: 01. Ordinaria. 02. De liquidación. 03. De importe cero. 04. Anticipada. 05. Final. |
|  | X | X | X | Según la siguiente codificación: 01. Ordinaria. 02. De liquidación. 03. De importe cero. 04. Anticipada. 05. Final. |
| Fecha de Recepción. (*) |  |  | X |  |
| Fecha de Certificación. |  | X | X |  |
| Indicador de Reanudación de la obra. (*) |  | X | X |  |
| Mes Certificado. |  | X | X |  |
| Importe que no se acredita. (*) |  | X | X |  |
| Importe que se acredita. (*) |  | X | X |  |
| Importe Ejecutado con anterioridad. (*) |  | X | X |  |
| Importe de Revisión de Precios. (*) |  | X | X |  |
| Importe de Anticipos no revisables. (*) |  | X | X |  |
| Importe de Anticipos revisables. (*) |  | X | X |  |
| Importe de Deducciones por Anticipos. (*) |  | X | X |  |
| Director de la Obra. |  | X | X | Nombre y apellidos del Director de obra. |
| Cesionario del Cobro (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
| Fecha de Cesión del Cobro (*) | X | X | X |  |

| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 002. Expediente de contrato de suministro. | 002. Expediente de contrato de suministro. | 002. Expediente de contrato de suministro. | 002. Expediente de contrato de suministro. | 002. Expediente de contrato de suministro. |
| 012. Expediente de contrato de servicios. | 012. Expediente de contrato de servicios. | 012. Expediente de contrato de servicios. | 012. Expediente de contrato de servicios. | 012. Expediente de contrato de servicios. |
| 019. Expediente de contrato de colaboración entre el sector público y el privado. | 019. Expediente de contrato de colaboración entre el sector público y el privado. | 019. Expediente de contrato de colaboración entre el sector público y el privado. | 019. Expediente de contrato de colaboración entre el sector público y el privado. | 019. Expediente de contrato de colaboración entre el sector público y el privado. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
...
|  |  |  |  | Según la siguiente codificación: 01. Ordinaria. 02. De liquidación. |
|  |  |  |  | Según la siguiente codificación: 01. Ordinaria. 02. De liquidación. |
| Fecha de Recepción. (*) |  |  | X |  |
| Cesionario del Cobro. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
| Fecha de Cesión del Cobro (*) | X | X | X |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 003. Expediente de contratación centralizada. | 003. Expediente de contratación centralizada. | 003. Expediente de contratación centralizada. | 003. Expediente de contratación centralizada. | 003. Expediente de contratación centralizada. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| Importe de Ejecución. |  |  | X |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 006. Expediente de contrato patrimonial. | 006. Expediente de contrato patrimonial. | 006. Expediente de contrato patrimonial. | 006. Expediente de contrato patrimonial. | 006. Expediente de contrato patrimonial. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| Importe de Ejecución. |  |  | X |  |
...
| Fecha de Firma del Contrato. |  | X | X |  |
| Código Tipo Contrato/Subexpediente. (*) |  |  | X | Codificación libre, a dos dígitos, personalizable por el Servicio gestor. |
| Fecha Firma nuevo contrato (Reformados). (*) |  | X | X | Sólo para el caso de contratos reformados. |
| Cesionario. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
| Fecha de Cesión (*) |  |  | X |  |
| DATOS DE CERTIFICACIÓN/ABONO (Fase O) |  |  |  |  |
| Cesionario del Cobro. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 007. Expediente de expropiaciones. | 007. Expediente de expropiaciones. | 007. Expediente de expropiaciones. | 007. Expediente de expropiaciones. | 007. Expediente de expropiaciones. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| SIN DATOS. |  |  |  |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 009. Expediente de intereses de demora. | 009. Expediente de intereses de demora. | 009. Expediente de intereses de demora. | 009. Expediente de intereses de demora. | 009. Expediente de intereses de demora. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| SIN DATOS. |  |  |  |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 010. Expediente de subvenciones. | 010. Expediente de subvenciones. | 010. Expediente de subvenciones. | 010. Expediente de subvenciones. | 010. Expediente de subvenciones. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| SIN DATOS. |  |  |  |  |
| DATOS DE ADJUDICACIÓN/ASIGNACIÓN (Fases A s/ retenido y A s/ disponible) |  |  |  |  |
| Fecha de Publicación en el B.O.E. (*) |  |  | X | Relativa a la norma por la que se efectúe la convocatoria de la subvención o, en su caso, de la norma por la que se posibilite la concesión de subvenciones sin previa convocatoria. |
| Normativa. |  |  | X | Codificación libre, de seis caracteres, personalizable por la Oficina contable, que identifique la norma a la que se refiere el dato anterior. |
| Finalidad. |  |  | X | Codificación libre, de seis caracteres, personalizable por la Oficina contable, que identifique la finalidad de la subvención. |
| DATOS DE CONTRATO/SUBEXPEDIENTE (Fase D) |  |  |  |  |
| Código Tipo Contrato/Subexpediente. (*) |  |  | X | Codificación libre, a dos dígitos, personalizable por el Servicio gestor. |
| Fecha de concesión. |  |  | X |  |
| Reintegros. (*) |  |  | X | Importe de los reintegros que se hubiesen producido. |
| Causa. (*) |  |  | X | Texto libre indicativo de la causa del reintegro de la subvención. |
| Cesionario. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
| Fecha de Cesión. (*) |  |  | X |  |
| DATOS DE CERTIFICACIÓN/ABONO (Fase O) |  |  |  |  |
| Cesionario del Cobro. (*) | X | X | X | Número de identificación fiscal y denominación del cesionario. |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 013. Expediente de transferencias. | 013. Expediente de transferencias. | 013. Expediente de transferencias. | 013. Expediente de transferencias. | 013. Expediente de transferencias. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| SIN DATOS. |  |  |  |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 014. Inversiones Militares FAS | 014. Inversiones Militares FAS | 014. Inversiones Militares FAS | 014. Inversiones Militares FAS | 014. Inversiones Militares FAS |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| SIN DATOS. |  |  |  |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 016. Contrato de Suministro Fabricación Ministerio de Defensa. | 016. Contrato de Suministro Fabricación Ministerio de Defensa. | 016. Contrato de Suministro Fabricación Ministerio de Defensa. | 016. Contrato de Suministro Fabricación Ministerio de Defensa. | 016. Contrato de Suministro Fabricación Ministerio de Defensa. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| Importe Ejecución. |  |  | X |  |
...
| Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente | Tipo de expediente |
| --- | --- | --- | --- | --- |
| 020. Expediente contrato de carácter administrativo especial. | 020. Expediente contrato de carácter administrativo especial. | 020. Expediente contrato de carácter administrativo especial. | 020. Expediente contrato de carácter administrativo especial. | 020. Expediente contrato de carácter administrativo especial. |
| 021. Encomiendas de Gestión. | 021. Encomiendas de Gestión. | 021. Encomiendas de Gestión. | 021. Encomiendas de Gestión. | 021. Encomiendas de Gestión. |
| 999. Otros expedientes. | 999. Otros expedientes. | 999. Otros expedientes. | 999. Otros expedientes. | 999. Otros expedientes. |
| Descripción de datos | Tipo de gestión | Tipo de gestión | Tipo de gestión | Observaciones |
| Descripción de datos | M | S | A | Observaciones |
| DATOS DE LICITACIÓN/ESTIMACIÓN (Fases RC y A s/ disponible) |  |  |  |  |
| Importe de Ejecución. (*) |  |  | X |  |
...
![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_003.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_004.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_005.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_006.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_007.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_008.png)

![](https://www.boe.es/datos/imagenes/disp/2008/239/15918_009.png)
