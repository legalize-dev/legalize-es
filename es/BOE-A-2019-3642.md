---
title: "Orden TMS/283/2019, de 12 de marzo, por la que se regula el Catálogo de Especialidades Formativas en el marco del sistema de formación profesional para el empleo en el ámbito laboral"
identifier: "BOE-A-2019-3642"
country: "es"
rank: "orden"
publication_date: "2019-03-14"
last_updated: "2019-03-14"
status: "in_force"
source: "https://www.boe.es/eli/es/o/2019/03/12/tms283"
department: "Ministerio de Trabajo, Migraciones y Seguridad Social"
pdf_url: "https://www.boe.es/boe/dias/2019/03/14/pdfs/BOE-A-2019-3642.pdf"
subjects: ["Capacitación profesional", "Catálogo Nacional de Cualificaciones Profesionales", "Empleo", "Formación profesional", "Servicio Público de Empleo Estatal"]
department_code: "9564"
rank_code: "1350"
ambito_code: "1"
official_number: "TMS/283/2019"
enactment_date: "2019-03-12"
official_journal: "Boletín Oficial del Estado"
journal_issue: "63"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2019/03/12/tms283"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2019-3642"
url_pdf: "https://www.boe.es/boe/dias/2019/03/14/pdfs/BOE-A-2019-3642.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2019-3642"
page_start: "24293"
page_end: "24313"
image_marker: "A"
legislative_status: "L"
alerts: "Trabajo y empleo"
references_previous: "DEROGA BOE-A-2010-4850; DE CONFORMIDAD con BOE-A-2017-7769; DE CONFORMIDAD con BOE-A-2015-9734"
references_subsequent: "CORRECCIÓN de errores BOE-A-2019-9425"
...
| Familia Profesional | Códigos | Denominación |
| --- | --- | --- |
| Familia Profesional | Áreas Profesionales | Áreas Profesionales |
| ADMINISTRACIÓN Y GESTIÓN. | ADGD | ADMINISTRACIÓN Y AUDITORIA. |
| ADMINISTRACIÓN Y GESTIÓN. | ADGG | GESTIÓN DE LA INFORMACIÓN Y COMUNICACIÓN. |
| ADMINISTRACIÓN Y GESTIÓN. | ADGN | FINANZAS Y SEGUROS. |
| ACTIVIDADES FÍSICAS Y DEPORTIVAS. | AFDA | ACTIVIDADES FÍSICO DEPORTIVAS RECREATIVAS. |
| ACTIVIDADES FÍSICAS Y DEPORTIVAS. | AFDP | PREVENCIÓN Y RECUPERACIÓN. |
| AGRARIA. | AGAJ | JARDINERÍA. |
| AGRARIA. | AGAN | GANADERÍA. |
| AGRARIA. | AGAR | FORESTAL. |
| AGRARIA. | AGAU | AGRICULTURA. |
| ARTES GRÁFICAS. | ARGA | ACTIVIDADES Y TÉCNICAS GRÁFICAS ARTÍSTICAS. |
| ARTES GRÁFICAS. | ARGC | ENCUADERNACIÓN INDUSTRIAL. |
| ARTES GRÁFICAS. | ARGG | DISEÑO GRÁFICO Y MULTIMEDIA. |
| ARTES GRÁFICAS. | ARGI | IMPRESIÓN. |
| ARTES GRÁFICAS. | ARGN | EDICIÓN. |
| ARTES GRÁFICAS. | ARGP | PREIMPRESIÓN. |
| ARTES GRÁFICAS. | ARGT | TRANSFORMACIÓN Y CONVERSIÓN EN INDUSTRIAS GRÁFICAS. |
| ARTES Y ARTESANÍAS. | ARTA | ARTESANÍA TRADICIONAL. |
| ARTES Y ARTESANÍAS. | ARTB | JOYERÍA Y ORFEBRERÍA. |
| ARTES Y ARTESANÍAS. | ARTG | FABRICACIÓN Y MANTENIMIENTO DE INSTRUMENTOS MUSICALES. |
| ARTES Y ARTESANÍAS. | ARTN | VIDRIO Y CERÁMICA ARTESANAL. |
| ARTES Y ARTESANÍAS. | ARTR | RECUPERACIÓN, REPARACIÓN Y MANTENIMIENTO ARTÍSTICOS. |
| ARTES Y ARTESANÍAS. | ARTU | ARTES ESCÉNICAS. |
| COMERCIO Y MARKETING. | COML | LOGÍSTICA COMERCIAL Y GESTIÓN DEL TRANSPORTE. |
| COMERCIO Y MARKETING. | COMM | MARKETING Y RELACIONES PÚBLICAS. |
| COMERCIO Y MARKETING. | COMT | COMPRAVENTA. |
| EDIFICACIÓN Y OBRA CIVIL. | EOCB | ALBAÑILERÍA Y ACABADOS. |
| EDIFICACIÓN Y OBRA CIVIL. | EOCE | ESTRUCTURAS. |
| EDIFICACIÓN Y OBRA CIVIL. | EOCJ | COLOCACIÓN Y MONTAJE. |
| EDIFICACIÓN Y OBRA CIVIL. | EOCO | PROYECTOS Y SEGUIMIENTO DE OBRAS. |
| EDIFICACIÓN Y OBRA CIVIL. | EOCQ | MAQUINARIA DE CONSTRUCCIÓN. |
| ELECTRICIDAD Y ELECTRÓNICA. | ELEE | INSTALACIONES ELÉCTRICAS. |
| ELECTRICIDAD Y ELECTRÓNICA. | ELEM | MÁQUINAS ELECTROMECÁNICAS. |
| ELECTRICIDAD Y ELECTRÓNICA. | ELEQ | EQUIPOS ELECTRÓNICOS. |
| ELECTRICIDAD Y ELECTRÓNICA. | ELES | INSTALACIONES DE TELECOMUNICACIÓN. |
| ENERGÍA Y AGUA. | ENAA | AGUA. |
| ENERGÍA Y AGUA. | ENAC | EFICIENCIA ENERGÉTICA. |
| ENERGÍA Y AGUA. | ENAE | ENERGÍAS RENOVABLES. |
| ENERGÍA Y AGUA. | ENAL | ENERGÍA ELÉCTRICA. |
| ENERGÍA Y AGUA. | ENAS | GAS. |
| FABRICACIÓN MECÁNICA. | FMEA | CONSTRUCCIONES AERONÁUTICAS. |
| FABRICACIÓN MECÁNICA. | FMEC | CONSTRUCCIONES METÁLICAS. |
| FABRICACIÓN MECÁNICA. | FMEF | FUNDICIÓN. |
| FABRICACIÓN MECÁNICA. | FMEH | OPERACIONES MECÁNICAS. |
| FABRICACIÓN MECÁNICA. | FMEM | PRODUCCIÓN MECÁNICA. |
| HOSTELERÍA Y TURISMO. | HOTA | ALOJAMIENTO. |
| HOSTELERÍA Y TURISMO. | HOTJ | JUEGOS DE AZAR. |
| HOSTELERÍA Y TURISMO. | HOTR | RESTAURACIÓN. |
| HOSTELERÍA Y TURISMO. | HOTT | TURISMO. |
| HOSTELERÍA Y TURISMO. | HOTU | AGROTURISMO. |
| INDUSTRIAS EXTRACTIVAS. | IEXD | PIEDRA NATURAL. |
| INDUSTRIAS EXTRACTIVAS. | IEXM | MINERÍA. |
| INFORMÁTICA Y COMUNICACIONES. | IFCD | DESARROLLO. |
| INFORMÁTICA Y COMUNICACIONES. | IFCM | COMUNICACIONES. |
| INFORMÁTICA Y COMUNICACIONES. | IFCT | SISTEMAS Y TELEMÁTICA. |
| INSTALACIÓN Y MANTENIMIENTO. | IMAI | MONTAJE Y MANTENIMIENTO DE INSTALACIONES. |
| INSTALACIÓN Y MANTENIMIENTO. | IMAQ | MAQUINARIA Y EQUIPO INDUSTRIAL. |
| INSTALACIÓN Y MANTENIMIENTO. | IMAR | FRÍO Y CLIMATIZACIÓN. |
| IMAGEN PERSONAL. | IMPE | ESTÉTICA. |
| IMAGEN PERSONAL. | IMPQ | PELUQUERÍA. |
| IMAGEN Y SONIDO. | IMSE | ESPECTÁCULOS EN VIVO. |
| IMAGEN Y SONIDO. | IMST | PRODUCCIONES FOTOGRÁFICAS. |
| IMAGEN Y SONIDO. | IMSV | PRODUCCIÓN AUDIOVISUAL. |
| INDUSTRIAS ALIMENTARIAS. | INAD | ALIMENTOS DIVERSOS. |
| INDUSTRIAS ALIMENTARIAS. | INAE | LÁCTEOS. |
| INDUSTRIAS ALIMENTARIAS. | INAF | PANADERÍA PASTELERÍA, CONFITERÍA Y MOLINERÍA. |
| INDUSTRIAS ALIMENTARIAS. | INAH | BEBIDAS. |
| INDUSTRIAS ALIMENTARIAS. | INAI | CÁRNICAS. |
| INDUSTRIAS ALIMENTARIAS. | INAJ | PRODUCTOS DE LA PESCA. |
| INDUSTRIAS ALIMENTARIAS. | INAK | ACEITES Y GRASAS. |
| INDUSTRIAS ALIMENTARIAS. | INAV | CONSERVAS VEGETALES. |
| MADERA, MUEBLE Y CORCHO. | MAMA | TRANSFORMACIÓN MADERA Y CORCHO. |
| MADERA, MUEBLE Y CORCHO. | MAMB | INSTALACIÓN Y AMUEBLAMIENTO. |
| MADERA, MUEBLE Y CORCHO. | MAMD | PRODUCCIÓN CARPINTERÍA Y MUEBLE. |
| MARÍTIMO PESQUERA. | MAPB | BUCEO. |
| MARÍTIMO PESQUERA. | MAPN | PESCA Y NAVEGACIÓN. |
| MARÍTIMO PESQUERA. | MAPU | ACUICULTURA. |
| QUÍMICA. | QUIA | ANÁLISIS Y CONTROL. |
| QUÍMICA. | QUIE | PROCESO QUÍMICO. |
| QUÍMICA. | QUIM | FARMAQUÍMICA. |
| QUÍMICA. | QUIO | PASTA, PAPEL Y CARTÓN. |
| QUÍMICA. | QUIT | TRANSFORMACIÓN DE POLÍMEROS. |
| SANIDAD. | SANP | SERVICIOS Y PRODUCTOS SANITARIOS. |
| SANIDAD. | SANS | SOPORTE Y AYUDA AL DIAGNÓSTICO. |
| SANIDAD. | SANT | ATENCIÓN SANITARIA. |
| SEGURIDAD Y MEDIO AMBIENTE. | SEAD | SEGURIDAD Y PREVENCIÓN. |
| SEGURIDAD Y MEDIO AMBIENTE. | SEAG | GESTIÓN AMBIENTAL. |
| SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD. | SSCB | ACTIVIDADES CULTURALES Y RECREATIVAS. |
| SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD. | SSCE | FORMACIÓN Y EDUCACIÓN. |
| SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD. | SSCG | ATENCIÓN SOCIAL. |
| SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD. | SSCI | SERVICIOS AL CONSUMIDOR. |
| TEXTIL, CONFECCIÓN Y PIEL. | TCPC | CALZADO. |
| TEXTIL, CONFECCIÓN Y PIEL. | TCPF | CONFECCIÓN EN TEXTIL Y PIEL. |
| TEXTIL, CONFECCIÓN Y PIEL. | TCPN | ENNOBLECIMIENTO DE MATERIAS TEXTILES Y PIELES. |
| TEXTIL, CONFECCIÓN Y PIEL. | TCPP | PRODUCCIÓN DE HILOS Y TEJIDOS. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVB | FERROCARRIL Y CABLE. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVG | ELECTROMECÁNICA DE VEHÍCULOS. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVI | CONDUCCIÓN DE VEHÍCULOS POR CARRETERA. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVL | CARROCERÍA DE VEHÍCULOS. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVO | AERONÁUTICA. |
| TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS. | TMVU | NÁUTICA. |
| VIDRIO Y CERÁMICA. | VICF | FABRICACIÓN CERÁMICA. |
| VIDRIO Y CERÁMICA. | VICI | VIDRIO INDUSTRIAL. |

> <small>Redactado conforme a la corrección de errores publicada en BOE núm. 149, de 22 de junio de 2019. [Ref. BOE-A-2019-9425](https://www.boe.es/buscar/doc.php?id=BOE-A-2019-9425)</small>
