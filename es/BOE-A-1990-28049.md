...
8.4.1 Denominación del producto.–La denominación del producto se efectuará de acuerdo con lo establecido en el apartado 8.3.2.

8.4.2 Lista de ingredientes.–Se indicará de acuerdo con lo especificado en el apartado 8.3.4, «Composición cualitativa».

8.4.3 Modo de empleo.–Se indicarán las leyendas «no ingerir directamente» y «para ser utilizado en productos alimenticios».
