...
pdf_url: "https://www.boe.es/boe/dias/2001/12/15/pdfs/A47624-47636.pdf"
subjects: ["Agencias de viajes", "Baleares", "Canarias", "Ceuta", "Dirección General de Aviación Civil", "Dirección General de la Marina Mercante", "Formularios administrativos", "Melilla", "Navieras", "Precios", "Subvenciones", "Tarifas", "Transportes aéreos", "Transportes marítimos"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2001/11/30/1316"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2001-23786"
url_pdf: "https://www.boe.es/boe/dias/2001/12/15/pdfs/A47624-47636.pdf"
page_start: "47624"
page_end: "47636"
image_marker: "A"
legislative_status: "L"
alerts: "Consumidores y usuarios; Transportes y tráfico"
references_previous: "DEROGA BOE-A-1999-17133; DEROGA BOE-A-1998-20643; DEROGA BOE-A-1998-20642; DEROGA BOE-A-1997-4584; DEROGA BOE-A-1997-3037; DEROGA BOE-A-1989-5901; DE CONFORMIDAD con BOE-A-2000-24357; DE CONFORMIDAD con BOE-A-1999-24786"
references_subsequent: "SE MODIFICA BOE-A-2007-18085; SE MODIFICA BOE-A-2005-3290; CORRECCIÓN de errores BOE-A-2002-1994; SE DICTA DE CONFORMIDAD BOE-A-2012-13947; SE DICTA DE CONFORMIDAD BOE-A-2006-14189; SE DICTA DE CONFORMIDAD BOE-A-2005-3595"
...
D./D.<sup>a</sup> ................................................................. Secretario del Excmo. Ayuntamiento.
...
> <small>Redactados los apartados Illes Balears y Tenerife conforme a la corrección de errores y erratas publicada en BOE núm. 28, de 1 de febrero de 2002. [Ref. BOE-A-2002-1994](https://www.boe.es/buscar/doc.php?id=BOE-A-2002-1994).</small>
...
| 7 | Tipo subvención. | Canarias-resto del territorio nacional: 1. |
| 7 | Tipo subvención. | Baleares-resto del territorio nacional: 2. |
| 7 | Tipo subvención. | Interinsular Canarias: 3. |
| 7 | Tipo subvención. | Interinsular Balear: 5. |
| 7 | Tipo subvención. | Melilla: 6. |
| 7 | Tipo subvención. | Ceuta: 7. |
| 7 | Tipo subvención. | Obligaciones de servicio público: 8. |
| 7 | Tipo subvención. | Caracteres permitidos: 1-8. No se aceptará el carácter «espacio» (ASCII 32 decimal). |
| 7 | Tipo subvención. | Esta tabla es susceptible de variación en el futuro. |
...
| 8 | Denominación tarifa. | Residente Canarias: RC. |
| 8 | Denominación tarifa. | Residente Baleares: RB. |
| 8 | Denominación tarifa. | Insular Canarias: IC. |
| 8 | Denominación tarifa. | Insular Balear: IB. |
| 8 | Denominación tarifa. | Residente Melilla: RM. |
| 8 | Denominación tarifa. | Residente Ceuta: RE. |
| 8 | Denominación tarifa. | El campo deberá estar justificado a la izquierda, rellenándose con espacios (ASCII 32 decimal) hasta completar la longitud del campo. Caracteres permitidos: A-Z, 0-9. |
...
| 11 | Fecha emisión billete. | DD es el número de día del mes. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 11 | Fecha emisión billete. | MM es el número del mes. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 11 | Fecha emisión billete. | AAAA es el año con cuatro dígitos. |
| 11 | Fecha emisión billete. | Caracteres permitidos: 0-9 y ’’/’’ (ASCII 47 decimal). |
| 11 | Fecha emisión billete. | Nota: No se aceptará el carácter «espacio» (ASCII 32 decimal). |
...
| 12 | Fecha utilización. | HH es la hora de comienzo del vuelo en formato 24h. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 12 | Fecha utilización. | MM es el minuto de comienzo del vuelo. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 12 | Fecha utilización. | El grupo fecha estará separado del grupo hora mediante un único espacio (ASCII 32 decimal). Caracteres permitidos: 0-9, "/’’ (ASCII 47 decimal) y ″/’’ (ASCII 58 decimal). |
...
| 16 | Tipo de acreditación de residencia. | 01 DNI. |
| 16 | Tipo de acreditación de residencia. | 02 Tarjeta de Residente. |
| 16 | Tipo de acreditación de residencia. | 03 Certificado de Residencia del Ayuntamiento. |
| 16 | Tipo de acreditación de residencia. | 04 Certificado de Residencia del Ayuntamiento para menores sin DNI. |
| 16 | Tipo de acreditación de residencia. | 05 Senador o Diputado. |
| 16 | Tipo de acreditación de residencia. | 06 Certificado de Acuartelamiento Militar. |
| 16 | Tipo de acreditación de residencia. | Caracteres permitidos: 0-6. No se aceptará el carácter ″espacio" (ASCII 32 decimal). |
...
| 18 | Código municipio. | Constará de seis caracteres numéricos, incluyendo los ceros no significativos. Caracteres permitidos: 0-9. No se aceptará el carácter «espacio» (ASCII 32 decimal). |
| 19 | Tipo moneda. | Moneda utilizada en los campos «Tarifa cobrada» e «Importe subvención». Los valores serán: |
| 19 | Tipo moneda. | Peseta: 1. |
| 19 | Tipo moneda. | Euro: 2. |
| 19 | Tipo moneda. | Caracteres permitidos: 1 ó 2. |
| 20 | Tipo emisión. | El tipo de emisión del cupón puede adoptar los valores: |
| 20 | Tipo emisión. | Manual: 0 (ASCII 48 decimal). |
| 20 | Tipo emisión. | Automático: Distinto de cero. |
| 20 | Tipo emisión. | Caracteres permitidos: 0-9, A-Z, a-z. |
...
| 21 | Código numérico IATA de agencia. | Este campo es optativo y cuando no se cumplimente deberán rellenarse las ocho posiciones con ceros. |
| 21 | Código numérico IATA de agencia. | Caracteres permitidos: 0-9. No se aceptará el carácter «espacio» (ASCII 32 decimal). |
...
| Número | Campo | Posición | Longitud | Caracteres permitidos | Caracteres permitidos | Caracteres permitidos | Caracteres permitidos | Justificado |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Número | Campo | Posición | Longitud | 0-9 | A-Z | Otros | Espacio | Justificado |
...
| 8 | Tipo moneda. | Peseta: 1. |
| 8 | Tipo moneda. | Euro: 2. |
| 8 | Tipo moneda. | Caracteres permitidos: 1 ó 2. |
| 9 | Fecha de efectividad desde: | Fecha en que se comienza la oferta de la tarifa en el formato DD/MM/AAAA, en la que: |
| 9 | Fecha de efectividad desde: | DD es el número de día del mes. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 9 | Fecha de efectividad desde: | MM es el número del mes. Si es inferior a 10, se añadirá un cero a la izquierda. |
| 9 | Fecha de efectividad desde: | AAAA es el año con cuatro dígitos. |
| 9 | Fecha de efectividad desde: | Caracteres permitidos: 0-9 y ’’/’’ (ASCII 47 decimal). Nota: No se aceptará el carácter «espacio» (ASCII 32 decimal). |
...
| 8 | Una «C» para los ficheros de cupones de vuelos. |
| 8 | Una «T» para los ficheros de tarifas básicas. |
...
> <small>Redactado conforme a la corrección de errores y erratas publicada en BOE núm. 28, de 1 de febrero de 2002. [Ref. BOE-A-2002-1994](https://www.boe.es/buscar/doc.php?id=BOE-A-2002-1994).</small>
