...
pdf_url: "https://www.boe.es/boe/dias/1987/09/08/pdfs/A27330-27337.pdf"
subjects: ["Análisis", "Pastas alimenticias", "Reglamentaciones técnico sanitarias"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/1987/06/19/1093"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-1987-21011"
url_pdf: "https://www.boe.es/boe/dias/1987/09/08/pdfs/A27330-27337.pdf"
page_start: "27330"
page_end: "27337"
image_marker: "A"
legislative_status: "L"
alerts: "Alimentación"
references_previous: "DEROGA BOE-A-1976-14453; DEROGA BOE-A-1975-19200"
references_subsequent: "SE MODIFICA BOE-A-1991-26242; CORRECCIÓN de errores BOE-A-1989-22117"
...
2.2.2 Pesasustancias metálico o de vidrio con tapadera y con una superficie útil que permita un reparto de la muestra de 0,3 g/cm<sup>2</sup> como máximo.
...
| H%= | (P<sub>1</sub> – P<sub>2</sub>) 100 |
| --- | --- |
| H%= | P |

Siendo:

P<sub>1</sub> = Peso, en g, del pesasustancias con la muestra.

P<sub>2</sub> = Peso, en g, del pesasustancias con la muestra desecada.
...
| % cenizas = | P<sub>1</sub> – P<sub>2</sub> | • 100 |
| --- | --- | --- |
| % cenizas = | P | • 100 |

Siendo:

P<sub>1</sub> = Peso, en gramos, del crisol con las cenizas.

P<sub>2</sub> = Peso, en gramos, del crisol vacío.
...
| % grasas = | P<sub>1</sub> – P<sub>2</sub> | • 100 |
| --- | --- | --- |
| % grasas = | P | • 100 |

Siendo:

P<sub>1</sub> = Peso, en gramos, del matraz con la grasa.

P<sub>2</sub> = Peso, en gramos, del matraz vacío.
...
| % proteínas = | 0,14 × 6,25 (V<sub>1</sub> - V<sub>0</sub>) |
| --- | --- |
| % proteínas = | P |

Siendo:

V<sub>1</sub> = Volumen, en mililitros, de ácido clorhídrico o sulfúrico utilizado en la determinación.

V<sub>0</sub> = Volumen, en mililitros, de ácido clorhídrico o sulfúrico utilizado en blanco.
...
6.3.3 Tetraborato de sodio decahidratado (B<sub>4</sub>0<sub>7</sub>Na<sub>2</sub>.10 H<sub>2</sub>0).
...
6.3.7 Fosfato disódico anhidro (PO<sub>4</sub>HNa<sub>2</sub>).

6.3.8 Fosfato monosódico anhidro (PO<sub>4</sub>H<sub>2</sub>Na).
...
| % fibra alimentaria insoluble = | P<sub>1</sub> – P<sub>2</sub> | × 100 |
| --- | --- | --- |
| % fibra alimentaria insoluble = | P<sub>0</sub> | × 100 |

Siendo:

P<sub>0</sub> = Peso en miligramos de la muestra.

P<sub>1</sub> = Peso en miligramos de crisol más residuo desecado a 110 grados centígrados.

P<sub>2</sub> = Peso en miligramos del crisol más residuo calcinado.
...
| Fibra bruta (%) = 100 | P<sub>1</sub> – P<sub>2</sub> |
| --- | --- |
| Fibra bruta (%) = 100 | P<sub>0</sub> |

Siendo:

P<sub>0</sub> = Peso inicial de la muestra.

P<sub>1</sub> = Peso del crisol conteniendo la muestra desecada.

P<sub>2</sub> = Peso del crisol conteniendo la muestra calcinada.
...
8.3.3 Solución de Carrez II. Disolver en agua 10,6 de ferrocianuro potásico K<sub>4</sub>(FeCN<sub>6</sub>) . 3H<sub>2</sub>O y añadir agua destilada hasta 100 mililitros.
...
8.3.8 Solución de sulfato de cobre. Disolver 25 gramos de sulfato de cobre (II) pentahidrato CuSO<sub>4</sub> . 5H<sub>2</sub>O, exento de hierro, en agua y enrasar a 100 mililitros.

8.3.9 Solución de ácido cítrico. Disolver 50 gramos de ácido cítrico monohidrato C<sub>6</sub>H<sub>8</sub>O<sub>7</sub> . H<sub>2</sub>O en 50 mililitros de agua.
...
8.3.17 Reactivo de Luff-Schoorl: Verter agitando cuidadosamente la solución de ácido cítrico (8.3.9) en la solución de carbonato de sodio (8.3.10). Agitar hasta la desaparición del desprendimiento gaseoso. A continuación añadir la solución de sulfato de cobre (II) (8.3.8) y completar hasta 1 litro con agua. Dejar reposar doce horas y filtrar. Verificar la normalidad del reactivo obtenido (Cu 0,1 N; Na<sub>2</sub>CO<sub>3</sub> 2N). El pH de la solución deber ser aproximadamente 9,4.
...
| N<sub>a2</sub>S<sub>2</sub> O3 0,1W | Glucosa, fructosa azúcares invertido C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> | Glucosa, fructosa azúcares invertido C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> | Lactosa C<sub>12</sub> H<sub>22</sub> O<sub>11</sub> | Lactosa C<sub>12</sub> H<sub>22</sub> O<sub>11</sub> | Maltosa C<sub>12</sub> H<sub>22</sub> O<sub>11</sub> | Maltosa C<sub>12</sub> H<sub>22</sub> O<sub>11</sub> |
| --- | --- | --- | --- | --- | --- | --- |
...
9.3.7 Solución de Carrez I: Disolver en agua 24 g de acetato de cinc Zn (CH<sub>3</sub> COO)<sub>2</sub> 2H<sub>2</sub>O y 3 g de ácido acético glacial. Completar hasta 1.000 ml con agua.

9.3.8 Solución de Carrez II: Disolver en agua 10,6 g de ferrocianuro de potasio K<sub>4</sub> [Fe(CN)<sub>6</sub>] • 3H<sub>2</sub>O. Completar a 100 ml con agua.
...
### p = 5,845 (V<sub>1</sub> – V<sub>2</sub>) mg

Siendo:

V<sub>1</sub>= Volumen, en ml, de solución de nitrato de plata añadida.

V<sub>2</sub> = Volumen, en ml, de solución de sulfocianuro amónico 0,1 utilizados en la valoración.

Efectuar un ensayo en blanco sin la muestra a analizar y si consumo solución de nitrato de plata, 0,1 N restar este valor el volumen (V<sub>1</sub> – V<sub>2</sub>).
...
![Imagen: /datos/imagenes/disp/1991/260/26242_001.png](https://www.boe.es/datos/imagenes/disp/1991/260/26242_001.png)
...
11.3.3 Solución patrón de 1.000 mg de Pb/L. Disolver 1,598 g de (NO<sub>3</sub>)<sub>2</sub> Pb enrasando a 1.000 mL con ácido nítrico al 1 por 100.
...
13.3.2 Solución patrón de 1.000 mg de Cu/L. Disolver 1.000 g de Cu puro en el mínimo volumen necesario de NO<sub>3</sub>H (1:1) y diluir a 1 litro con ácido nítrico del 1 por 100 (v/v).
...
> <small>Se modifica el punto 10 por el art. 2 del Real Decreto 1534/1991, de 18 de octubre. [Ref. BOE-A-1991-26242](https://www.boe.es/buscar/doc.php?id=BOE-A-1991-26242).</small>

> <small>Redactado conforme a la corrección de errores publicada en BOE núm. 219, de 13 de septiembre de 1989. [Ref. BOE-A-1989-22117](https://www.boe.es/buscar/doc.php?id=BOE-A-1989-22117).</small>
