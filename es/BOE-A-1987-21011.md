...
10.3.3 Solución de hidróxido de potasio 0,02 N libre de CO<sub>2</sub>.
...
| Valor acidez grasa = | (V – V<sub>1</sub> ) × 100 | × 100 |
| --- | --- | --- |
| Valor acidez grasa = | 100 – H | × 100 |

Siendo:

V = Volumen, en ml, de KOH 0,02 N utilizados para valorar la muestra extraída.

V<sub>1</sub> = Volumen, en ml, de KOH 0,02 N utilizados para la valoración en blanco.
