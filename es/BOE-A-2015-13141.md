---
title: "Orden ECC/2575/2015, de 30 de noviembre, por la que se determina el contenido, la estructura y los requisitos de publicación del informe anual de gobierno corporativo, y se establecen las obligaciones de contabilidad, de las fundaciones bancarias"
identifier: "BOE-A-2015-13141"
country: "es"
rank: "orden"
publication_date: "2015-12-04"
last_updated: "2015-12-04"
status: "in_force"
source: "https://www.boe.es/eli/es/o/2015/11/30/ecc2575"
department: "Ministerio de Economía y Competitividad"
pdf_url: "https://www.boe.es/boe/dias/2015/12/04/pdfs/BOE-A-2015-13141.pdf"
subjects: ["Banca", "Banco de España", "Contabilidad", "Formularios administrativos", "Fundaciones", "Información"]
department_code: "9221"
rank_code: "1350"
ambito_code: "1"
official_number: "ECC/2575/2015"
enactment_date: "2015-11-30"
official_journal: "Boletín Oficial del Estado"
journal_issue: "290"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2015/11/30/ecc2575"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2015-13141"
url_pdf: "https://www.boe.es/boe/dias/2015/12/04/pdfs/BOE-A-2015-13141.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2015-13141"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2015/12/04/pdfs/BOE-A-2015-13141-C.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2015/12/04/pdfs/BOE-A-2015-13141-G.pdf"
page_start: "114989"
page_end: "115027"
image_marker: "A"
legislative_status: "L"
alerts: "Derecho Mercantil; Sistema financiero"
references_previous: "MODIFICA BOE-A-2013-3212; DE CONFORMIDAD con BOE-A-2013-13723"
---
...
![1](https://www.boe.es/datos/imagenes/disp/2015/290/13141_10312.png)
...
| --- | --- |
| Competencia o función indelegable | Competencia o función indelegable |
|  |  |
|  |  |

| Órgano | Competencia o función delegable | Persona u órgano en que se delega |
| --- | --- | --- |
| Competencia o función delegable | Competencia o función delegable | Competencia o función delegable |
|  |  |  |
...
| --- | --- | --- | --- |
| Identidad de los patronos | Identidad de los patronos | Identidad de los patronos | Identidad de los patronos |
|  |  |  |  |

|  | Número de patronos | % sobre el total |
| --- | --- | --- |
|  | Composición del patronato en función del grupo al que pertenecen los patronos | Composición del patronato en función del grupo al que pertenecen los patronos |
| Fundadores. |  |  |
...
| --- | --- | --- |
| Justificación de la pertenencia | Justificación de la pertenencia | Justificación de la pertenencia |
|  |  |  |
...
| Patronos representantes de administraciones públicas y entidades y corporaciones de derecho público | Patronos representantes de administraciones públicas y entidades y corporaciones de derecho público |
| --- | --- |
| Número. |  |
| % sobre el total. |  |
...
|  | SÍ | NO | Nombre | NIF o CIF | Descripción de su experiencia profesional | Fechade aceptación del cargo |
| --- | --- | --- | --- | --- | --- | --- |
|  | Existencia: SÍ/NO (marque con x) | Existencia: SÍ/NO (marque con x) | Nombre | NIF o CIF | Descripción de su experiencia profesional | Fechade aceptación del cargo |
| Presidente. |  |  |  |  |  |  |
| Vicepresidente. |  |  |  |  |  |  |
| Director general. |  |  |  |  |  |  |
| Secretario. |  |  |  |  |  |  |
...
| Reglas relativas a la periodicidad y convocatoria de las reuniones | Reglas relativas a la periodicidad y convocatoria de las reuniones |
| --- | --- |
| Periodicidad. |  |
| Convocatoria. |  |
...
| Carácter de sus acuerdos | Carácter de sus acuerdos |
| --- | --- |
| Vinculantes |  |
| Consultivos |  |
...
| Nombre/período de devengo total en ejercicios | Ejercicio t | Ejercicio t-1 | Ejercicio t | Ejercicio t-1 |
| --- | --- | --- | --- | --- |
| Nombre/período de devengo total en ejercicios | Aportación del ejercicio por parte de la fundación bancaria (miles €) | Aportación del ejercicio por parte de la fundación bancaria (miles €) | Importe de los fondos acumulados (miles €) | Importe de los fondos acumulados (miles €) |
| Miembro del patronato 1 |  |  |  |  |
| … |  |  |  |  |
...
| Nombre | Tipo de interés de la operación | Tipo de interés de la operación | Características esenciales de la operación | Características esenciales de la operación | Importes eventualmente devueltos | Importes eventualmente devueltos |
| --- | --- | --- | --- | --- | --- | --- |
|  | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos |
| Miembro del patronato 1. |  |  |  |  |  |  |
| Miembro del patronato 2. |  |  |  |  |  |  |
...
| Nombre | Ejercicio t | Ejercicio t-1 | Ejercicio t | Ejercicio t-1 |
| --- | --- | --- | --- | --- |
| Nombre | Primas de seguros de vida | Primas de seguros de vida | Garantías constituidas por la fundación bancaria a favor de los miembros del patronato | Garantías constituidas por la fundación bancaria a favor de los miembros del patronato |
| Miembro del patronato 1. |  |  |  |  |
| Miembro del patronato 2. |  |  |  |  |
...
| Nombre/período de devengo total en ejercicios | Ejercicio t | Ejercicio t-1 | Ejercicio t | Ejercicio t-1 |
| --- | --- | --- | --- | --- |
| Nombre/período de devengo total en ejercicios | Aportación del ejercicio por parte de la sociedad (miles €) | Aportación del ejercicio por parte de la sociedad (miles €) | Importe de los fondos acumulados (miles €) | Importe de los fondos acumulados (miles €) |
| Miembro del patronato 1. |  |  |  |  |
| Miembro del patronato 2. |  |  |  |  |
...
| --- | --- | --- | --- |
| Nombre | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos | Retribución en forma de anticipos, créditos concedidos |
| Miembro del patronato 1. |  |  |  |
| Miembro del patronato 2. |  |  |  |
| Director General. |  |  |  |
| … |  |  |  |
...
| Aprobación de las operaciones con partes vinculadas que sean significativas | Aprobación de las operaciones con partes vinculadas que sean significativas |
| --- | --- |
| Órgano competente. |  |
| Procedimiento. |  |
...
| --- | --- |
| Explique las operaciones significativas realizadas con partes vinculadas o con entidades intragrupo (realizadas durante el ejercicio económico a que se refiere el informe) | Explique las operaciones significativas realizadas con partes vinculadas o con entidades intragrupo (realizadas durante el ejercicio económico a que se refiere el informe) |
| Tipo y naturaleza. |  |
...
| Nombre de la operación: | Nombre de la operación: |
| --- | --- |
| Explique las operaciones significativas realizadas con partes vinculadas o con entidades intragrupo (realizadas con anterioridad al ejercicio económico y aún no extinguidas) | Explique las operaciones significativas realizadas con partes vinculadas o con entidades intragrupo (realizadas con anterioridad al ejercicio económico y aún no extinguidas) |
| Tipo y naturaleza. |  |
| Partes intervinientes. |  |
| Cuantía. |  |
...
| Nombre de la operación: | Nombre de la operación: |
| --- | --- |
| Operaciones significativas con partes vinculadas o con entidades intragrupo realizadas con sociedades establecidas en paraísos fiscales | Operaciones significativas con partes vinculadas o con entidades intragrupo realizadas con sociedades establecidas en paraísos fiscales |
| Tipo y naturaleza. |  |
| Partes intervinientes. |  |
...
| Comisión relacionada con la obra social | Comisión relacionada con la obra social |
| --- | --- |
...
| Plan de actuación del ejercicio anterior al corriente | Plan de actuación del ejercicio anterior al corriente |
| --- | --- |
...
| Plan de actuación del ejercicio anterior al que se refiere el IAGC | Plan de actuación del ejercicio anterior al que se refiere el IAGC | Plan de actuación del ejercicio anterior al que se refiere el IAGC |
| --- | --- | --- |
| Presupuesto. | Asignado. |  |
| Presupuesto. | Liquidado. |  |
| Procedencia de los recursos asignados. | Procedencia de los recursos asignados. |  |
| Convenios con otras entidades. | Convenios con otras entidades. |  |
...
| Actividades económicas complementarias | Actividades económicas complementarias |
| --- | --- |
...
| Actividades económicas no complementarias | Actividades económicas no complementarias |
| --- | --- |
| Actividad A | Nombre de la actividad |
| Actividad A | Descripción |
