...
pdf_url: "https://www.boe.es/boe/dias/2011/07/30/pdfs/BOE-A-2011-13171.pdf"
subjects: ["Administración electrónica", "Administraciones Públicas", "Archivos", "Certificados telemáticos", "Firma electrónica", "Normas de calidad", "Redes de telecomunicación", "Reglamentaciones técnicas"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2011-13171"
...
references_subsequent: "SE DEROGA BOE-A-2016-10146"
...
Disposición derogada por el apartado 1 de la Resolución de 27 de octubre de 2016. [Ref. BOE-A-2016-10146#pr-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2016-10146).
...
| Información | Obligatoriedad | Campo – etiqueta – elemento<sup>1</sup> | Campo – etiqueta – elemento<sup>1</sup> | Campo – etiqueta – elemento<sup>1</sup> |
| --- | --- | --- | --- | --- |
| Información | Obligatoriedad | XAdES | CAdES | PAdES |
...
| Política de firma | Obligatorio | SignaturePolicyldentifier– SigPolicyldHash (SignedProperties) | SignaturePolicyldentifier– SigPolicyldHash (SignedData) | SignaturePolicyldentifier |
...
| Sello de tiempo | Opcional | IndividualDataObjectsTimeStamp | Content-time-stamp (SignedData) | Content-time-stamp |
...
| <sup>1</sup> Nótese que la tabla no constituye un listado completo de las etiquetas definidas por cada estándar sino una referencia a las etiquetas que reflejarán la información para la creación y validación de la firma. | <sup>1</sup> Nótese que la tabla no constituye un listado completo de las etiquetas definidas por cada estándar sino una referencia a las etiquetas que reflejarán la información para la creación y validación de la firma. | <sup>1</sup> Nótese que la tabla no constituye un listado completo de las etiquetas definidas por cada estándar sino una referencia a las etiquetas que reflejarán la información para la creación y validación de la firma. | <sup>1</sup> Nótese que la tabla no constituye un listado completo de las etiquetas definidas por cada estándar sino una referencia a las etiquetas que reflejarán la información para la creación y validación de la firma. | <sup>1</sup> Nótese que la tabla no constituye un listado completo de las etiquetas definidas por cada estándar sino una referencia a las etiquetas que reflejarán la información para la creación y validación de la firma. |
