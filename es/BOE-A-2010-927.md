...
De aquí resulta que la velocidad de la luz en el vacío es igual a 299 792 458 metros por segundo exactamente, c<sub>0</sub> = 299 792 458 m/s.
...
De aquí resulta que la constante magnética, µ<sub>0</sub>, también conocida como permeabilidad del vacío, es exactamente igual a 4π × 10<sup>−7</sup> henrios por metro, µ<sub>0</sub> = 4π × 10<sup>−7</sup> H/m.
...
De aquí resulta que la temperatura termodinámica del punto triple del agua es igual a 273,16 kelvin exactamente, T<sub>tpw</sub> = 273,16 K.
...
De aquí resulta que la masa molar del carbono 12 es igual a 12 g por mol, exactamente, M(<sup>12</sup>C) = 12 g/mol.

2.7 Unidad de intensidad luminosa (candela, cd): la candela es la intensidad luminosa, en una dirección dada, de una fuente que emite una radiación monocromática de frecuencia 540 × 10<sup>12</sup> hercios y cuya intensidad energética en dicha dirección es de 1/683 vatios por estereorradián.

De aquí resulta que la eficacia luminosa espectral de una radiación monocromática de frecuencia igual a 540 × 10<sup>12</sup> hercios es igual a 683 lúmenes por vatio, exactamente, K = 683 lm/W = 683 cd sr/W.
