...
| RESERVA Y PROVISIÓN | SALDO A 31-12 | % DE MATER. | IMPORTE | % DE MATER. | IMPORTE | % DE MATER. | IMPORTE | % DE MATER. | IMPORTE | % DE MATER. | IMPORTE | % DE MATER. | IMPORTE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| RESERVA Y PROVISIÓN | SALDO A 31-12 | EFECTIVO Y ACTIVOS LÍQUIDOS EQUIVALENTES E IMPOSICIONES A PLAZO FIJO | EFECTIVO Y ACTIVOS LÍQUIDOS EQUIVALENTES E IMPOSICIONES A PLAZO FIJO | EMISIONES PÚBLICAS CON VTO. NO SUPERIOR A UN AÑO | EMISIONES PÚBLICAS CON VTO. NO SUPERIOR A UN AÑO | EMISIONES PRIVADAS CON VTO. NO SUPERIOR A UN AÑO | EMISIONES PRIVADAS CON VTO. NO SUPERIOR A UN AÑO | EMISIONES PÚBLICAS CON VTO. SUPERIOR A UN AÑO | EMISIONES PÚBLICAS CON VTO. SUPERIOR A UN AÑO | EMISIONES PRIVADAS CON VTO. SUPERIOR A UN AÑO | EMISIONES PRIVADAS CON VTO. SUPERIOR A UN AÑO | INMOVILIZADO MATERIAL | INMOVILIZADO MATERIAL |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
> <sup>1</sup> Para determinar el «coste» tanto en este como en los posteriores indicadores se tendrá en cuenta lo establecido en el documento «Contabilidad Analítica en las Administraciones Públicas» (IGAE 2004).
