---
title: "Orden de 7 de julio de 1972 por la que se aprueban las normas de toma de muestras y análisis de los diferentes tipos de leche que figuran en el Reglamento de Centrales Lecheras y otras Industrias Lácteas"
identifier: "BOE-A-1972-1087"
country: "es"
rank: "orden"
publication_date: "1972-07-22"
last_updated: "1972-07-22"
status: "in_force"
source: "https://www.boe.es/eli/es/o/1972/07/07/(1)"
department: "Presidencia del Gobierno"
pdf_url: "https://www.boe.es/boe/dias/1972/07/22/pdfs/A13192-13205.pdf"
subjects: ["Análisis", "Leche"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/1972/07/07/(1)"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-1972-1087"
url_pdf: "https://www.boe.es/boe/dias/1972/07/22/pdfs/A13192-13205.pdf"
page_start: "13192"
page_end: "13205"
image_marker: "A"
legislative_status: "L"
references_previous: "DE CONFORMIDAD con BOE-A-1966-15960; CITA BOE-A-1972-390"
---
...
## ANEJO 1. Toma de muestras de la leche
...
## ANEJO 2. Métodos de análisis de la leche
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6075.png)

M<sub>1</sub> = masa, en gramos, del matraz M, que contiene la materia grasa después de desecar hasta masa constante.

M<sub>2</sub> = masa, en gramos, del matraz M sin materia grasa, o en el caso de presencia de materias insolubles, después de extraer completamente la materia grasa.

B<sub>1</sub> = masa, en gramos, del matraz B del ensayo en blanco, después de desecar hasta masa constante.

B<sub>2</sub> = masa, en gramos, del matraz B, o en el caso de presencia de materias insolubles, después de extraer completamente la materia grasa.
...
2.3.4. Solución de sosa cáustica: 500 gramos de hidróxido sódico (NaOH) y 12 gramos de sulfuro de sodio (SNa<sub>2</sub> . 9H<sub>2</sub>O) disueltos en 1.000 mililitros de agua destilada.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6244.png)

N = normalidad del ácido clorhídrico.

V<sub>1</sub> = volumen en mililitros de ácido clorhídrico utilizado en la determinación.

V<sub>0</sub> = volumen en mililitros de ácido clorhídrico utilizado en el ensayo en blanco.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6329.png)
...
4.3.1. Reactivo del ácido tungsténico: Disolver siete gramos de tungstanato de sodio (WO<sub>4</sub>Na<sub>2</sub> . 2H<sub>2</sub>O) en 870 mililitros de agua; añadir 0,1 mililitro de una solución de ácido ortofosfórico (88 por 100 en peso) y 70 mililitros de una solución de ácido sulfúrico 1 N.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6377.png)
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6459.png)

C’ = cantidad de conservante no volátil en la muestra analizada.

![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6503.png)
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6548.png)
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6597.png)
...
La determinación se realiza sobre las cenizas de la leche, por reducción de los cromatos mediante una solución de sulfato ferroamónico (sal de Mohr) (SO<sub>4</sub>) Fe (NE<sub>4</sub>)<sub>2</sub>. 6H<sub>2</sub>O, cuyo exceso se valora con permanganato potásico.
...
7.2.2. Solución valorada de permanganato potásico 0,02 N, en la cual un mililitro corresponda a 0,00098 gramos de Cr<sub>2</sub>O<sub>7</sub> K<sub>2</sub>.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6641.png)
...
9.3.1. Solución de acetato de cinc, 2,0 N: Disolver 21,9 gramos de acetato de cinc cristalizado (C<sub>2</sub>H<sub>3</sub>O<sub>2</sub>), Zn. 2H<sub>2</sub>O y 3 mililitros de ácido acético glacial en agua destilada y completar hasta 100 mililitros.

9.3.2. Solución de ferrocianuro potásico, 1,0 N: Disolver 10,6 gramos de ferrocianuro potásico cristalizado [Fe(CN)<sub>6</sub>]K<sub>4</sub> . 3H<sub>2</sub>O en agua destilada y completar hasta 100 mililitros.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6689.png)

![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6774.png)
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6819.png)

M<sub>1</sub> = la masa inicial, en gramos, de la cápsula y su tapa más la leche en polvo utilizada para el análisis.

M<sub>2</sub> = la masa final, en gramos, de la cápsula y su tapa más la leche en polvo.

M<sub>3</sub> = la masa, en gramos, de la leche en polvo utilizada para el análisis.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6861.png)

V = volumen en mililitros de MnO<sub>4</sub>K (0,02 N) gastados en la valoración de la muestra.

v = volumen en mililitros de MnO<sub>4</sub>K (0,02 N) gastados en el ensayo en blanco.
...
13.3.2. Ácido perclórico (ClO<sub>4</sub>H) al 65 por 100 (densidad, 1,61 gramos por mililitro a 20ºC).

13.3.3. Solución de amidol: Disolver en agua destilada un gramo o de amidol (diclorhidrato de 2,4 diaminofenol: (NH<sub>2</sub>)<sub>2</sub> C<sub>6</sub>H<sub>3</sub>OH. 2ClH) y 20 gramos de metabisulfito de sodio o pirosulfito de sodio (S<sub>2</sub>O<sub>5</sub>Na<sub>2</sub>). Completar hasta 100 mililitros en un matraz aforado con tapón esmerilado. Preparar cada día una solución nueva.

13.3.4. Solución de molibdato: Disolver en agua destilada 8,3 gramos de molibdato de amonio: Mo<sub>7</sub>O<sub>24</sub> (NH<sub>4</sub>)<sub>6</sub> . 4H<sub>2</sub>O. Completar hasta 100 mililitros.

13.3.5. Solución acuosa de fosfato monopotásico (a partir de PO<sub>4</sub>H<sub>2</sub>K, desecado durante dos horas a 105 ºC), que permite trazar una curva de referencia para la determinación del fósforo: Pesar 4,393 gramos de PO<sub>4</sub>H<sub>2</sub>K, disolver en agua destilada y completar hasta 1.000 mililitros (solución A). Diluir 10 mililitros de solución A hasta 1.000 mililitros (solución B). Un mililitro de solución B = 10 microgramos de P.
...
![1](https://www.boe.es/datos/imagenes/disp/1972/175/01087_6946.png)
