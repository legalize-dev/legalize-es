...
pdf_url: "https://www.boe.es/boe/dias/2010/05/07/pdfs/BOE-A-2010-7253.pdf"
subjects: ["Acceso a la universidad", "Certificaciones", "Enseñanza Universitaria", "Estudios extranjeros", "Extranjeros", "Formularios administrativos", "Universidad Nacional de Educación a Distancia", "Universidades"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2010/05/04/edu1161"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2010-7253"
url_pdf: "https://www.boe.es/boe/dias/2010/05/07/pdfs/BOE-A-2010-7253.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2010-7253"
page_start: "40429"
page_end: "40441"
image_marker: "A"
legislative_status: "L"
alerts: "Educación y enseñanza; Extranjería"
references_previous: "DE CONFORMIDAD con BOE-A-2008-18947; DE CONFORMIDAD con BOE-A-2006-7899"
references_subsequent: "SE DEROGA BOE-A-2018-984; SE MODIFICA BOE-A-2014-2522; SE MODIFICA BOE-A-2010-10955"
...
Norma derogada, con efectos de 27 de enero de 2018, por la disposición derogatoria única.b) de la Orden ECD/42/2018, de 25 de enero. [Ref. BOE-A-2018-984#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2018-984)
...
![](https://www.boe.es/datos/imagenes/disp/2010/111/07253_001.png)

## ANEXO III. Credencial Provisional

![](https://www.boe.es/datos/imagenes/disp/2010/111/07253_002.png)

## ANEXO IV. Equivalencia de calificaciones

| Sistema educativo de procedencia | Escala/s de calificaciones positivas (de mínimo a máximo aprobatorio) | Aplicable a | Obtención de la calificación de acceso a la universidad española | Obtención de la calificación de acceso a la universidad española |
| --- | --- | --- | --- | --- |
| Alemania. | 4 a 1 (descendente) | Calificación del título Allgemeine Hochschulreife (Abitur). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Andorra. | 5 a 10 | Calificación del título de Bachiller del sistema educativo andorrano. | Se aplica equivalencia directa con la escala española. | Se aplica equivalencia directa con la escala española. |
| Austria. | 4 a 1 (descendente) | Título Reifeprünfungszeugnis. Cálculo de la nota media de las calificaciones de los dos últimos cursos de secundaria. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Bachillerato Internacional. | 24 a 45 | Calificación del Diploma de Bachillerato Internacional (BI). | (se aplica la tabla de conversión especificada en el punto 1 que se indica a continuación de esta tabla). | (se aplica la tabla de conversión especificada en el punto 1 que se indica a continuación de esta tabla). |
...
| Bulgaria. | 3 a 6 | Diploma za Sredno Obrasovaine y Calificación de la Prueba específica de acceso a una universidad concreta. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Chequia. | Dostatecný (4) Dobrý (3) Chválitebný (2) Výborný (1) | Calificación de la Prueba de Maturita (Maturnitní skouska) que da lugar a la obtención del Título Vysvedcení o Maturnitni skousce. | Dostatecný = 5,5 Dobry = 7 Chválitebný = 8 Výborný = 9 | Dostatecný = 5,5 Dobry = 7 Chválitebný = 8 Výborný = 9 |
| China. | (45-60 %)-100 % (aplicable a la correspondiente escala utilizada en puntos) | Título acreditativo de la finalización de la enseñanza secundaria (Pu Tong Gao Zhong Bi Ye Zheng Shu) y acreditación de la superación del examen nacional (Gao Kao). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Chipre. | 10 a 20 | Calificación final del título de Bachiller (Apolytirio) Certificado de haber superado la prueba de acceso a la Universidad. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Escuelas Europeas. | 6 a 10 y 60 a 100 | Calificación del examen de Bachillerato Europeo. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Eslovaquia. | Dostatocný (4) Dobry (3) Chválitebný (2) Výborný (1) | Calificación del examen de Maturita para la obtención del título Vysvedcenie o maturitnej skuske». | Dostatocný = 5,5 Dobry = 7 Chválitebný = 8 Výborný = 9 | Dostatocný = 5,5 Dobry = 7 Chválitebný = 8 Výborný = 9 |
| Eslovenia. | Zadostno (2) Dobro (3) Prav dobro (4) Odlicno (5) | Calificaciones para la obtención del Título de Matura (Maturitetno spricevalo). | Zadostno = 5,5 Dobro = 7 Prav dobro = 8 Odlicno = 9 | Zadostno = 5,5 Dobro = 7 Prav dobro = 8 Odlicno = 9 |
| Estonia. | E a A 50 a 100 | Calificación del examen estatal o de la prueba de acceso (Riigieksamitunnistus) y certificado de educación secundaria (Gümnaasiumi Loputunnistus). | E = 5,5 D = 6,5 C = 7,5 B = 8,5 A = 9,5 50 – 100 (en este caso, se aplica fórmula de conversión*). | E = 5,5 D = 6,5 C = 7,5 B = 8,5 A = 9,5 50 – 100 (en este caso, se aplica fórmula de conversión*). |
| Finlandia. | 5 a 10 2 a 7 | Calificación del examen Yloippilastutkinto. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Francia. | 10 a 20 | Calificación del BAC (se deberá aportar el Relevé de Notes). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Grecia. | 10 a 20 3200 – 6400 320 – 640 | Calificación del Certificado de Acceso a Estudios Superiores (Veveosi- BEBAIΩΣΗ). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Hungría. | 72 a 120 Elégséges Közepes Jó Jéles | Calificación del examen érettségi vizsga. | 72 – 120 (en este caso, se aplica fórmula de conversión*) Elégséges = 5,5 Közepes = 7 Jó = 8 Jéles =9. | 72 – 120 (en este caso, se aplica fórmula de conversión*) Elégséges = 5,5 Közepes = 7 Jó = 8 Jéles =9. |
| Irlanda. | D3 a A1 (materias nivel superior). B2 a A1 (materias nivel ordinario) | Notas del Established Leaving Certificate (mínimo seis materias de las que dos habrán de ser de nivel superior con grados A, B, C o D; las cuatro restantes podrán ser de nivel ordinario con grados A1, A2, B1 ó B2). Se tomarán las seis mejores calificaciones. | D3 = 5 D2 = 5,47 D1=5,94 C3=6,41 C2=6,88 C1=7,35 B3=7,83 B2=8,30 B1=8,77 A2=9,24 A1=10 | B1=5,26 B2=5 A2=5,54 A1=6. |
| Islandia. | 5 a 10 | Calificación del Stúdentspróf. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Italia. | 60 a 100 36 a 60 | Calificación del Diploma del Examen de Estado o de Maturità. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Letonia. | 4 a 10 | Calificación de los dos últimos cursos de secundaria. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Liechtenstein. |  | Matura. |  |  |
| Lituania. | 5 a 10 | Calificación obtenida en el examen de acceso a la universidad (que puede estar expuesta en el propio Título Brandos Atestata). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Luxemburgo. | 30 a 60 | Calificación del Diploma de fin de estudios secundarios o del Diploma de fin de estudios secundarios técnicos. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Malta. | C, B, A | Calificaciones obtenidas en las materias de las que se examinó el alumno para la obtención del Matriculation Certificate. | C = 6 B = 7,5 A = 9 | C = 6 B = 7,5 A = 9 |
| Noruega. | 2 a 6 | Calificación del Vietnemål Fra Videregående Skole. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Países Bajos. | 5,5 a 10 | Calificación del examen final Centraal examen que otorga el Diploma Voorbereidend Wetenschappelijk Onderwijs (vWO). | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
| Polonia. | 30 % - 100 % Celujący (6) Bardzo dobry (5) Dobry (4) Dostateczny (3) Mierny (2) | Calificación obtenida en el examen nowa matura. Calificación obtenida en el examen matura (Swiadectwo Dojrzalosci). | (en este caso, se aplica fórmula de conversión*) Celujący = 9,5 Bardzo dobry = 8,5 Dobry = 7,5 Dostateczny = 6,5 Mierny = 5,5 | (en este caso, se aplica fórmula de conversión*) Celujący = 9,5 Bardzo dobry = 8,5 Dobry = 7,5 Dostateczny = 6,5 Mierny = 5,5 |
| Portugal. | 100 a 200 | Ficha ENES y nota definitiva de acceso a la Universidad portuguesa (certificada por la Direccao Geral do Ensino Superior) para enseñanzas o áreas concretas. | 100 – 200 (se aplica fórmula de conversión*). | 100 – 200 (se aplica fórmula de conversión*). |
| Reino Unido. | Mínimo de 140 puntos UCAS Tariff | Acreditación de al menos cinco materias del GCSE con calificación A, B o C, y de dos materias del AL del GCE con calificación A*,A, B, C, D o E, y un mínimo de 140 puntos de UCAS Tariff (o del equivalente del Scottish Certificate of Education, Advanced Higher). | (se aplica la conversión especificada en el punto 2 que se indica a continuación de esta tabla). | (se aplica la conversión especificada en el punto 2 que se indica a continuación de esta tabla). |
| Rumania. | 5 a 10 6 a 10 | Calificación del examen de Baccalaureat. | 5 – 10 6 - 10 (se aplica fórmula de conversión*). | 5 – 10 6 - 10 (se aplica fórmula de conversión*). |
| Suecia. | G, VG, MVG | Calificación del Diploma Slutbetyg. | G = 6 VG = 7,5 MVG = 9 | G = 6 VG = 7,5 MVG = 9 |
| Suiza. | 4 a 6 | Calificación del Diploma de Maturité. | (se aplica fórmula de conversión*). | (se aplica fórmula de conversión*). |
...
| Puntos BI | Nota española | Puntos BI | Nota española |
| --- | --- | --- | --- |
| 24 | 5 | 33 | 7,49 |
| 25 | 5,28 | 34 | 7,77 |
| 26 | 5,55 | 35 | 8,05 |
