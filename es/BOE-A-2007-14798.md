...
![](https://www.boe.es/datos/imagenes/disp/2007/185/14798_001.png)
...
![](https://www.boe.es/datos/imagenes/disp/2007/185/14798_002.png)
...
P<sub>máx. j</sub> = Potencia residual máxima demandable por el consumidor durante la posible interrupción en cada uno de los tipos i a los que esté acogido.

ΣKi (P<sub>m1</sub> – P<sub>máx. i</sub>) = suma de los productos Ki (P<sub>m1</sub> – P<sub>máx. i</sub>) para cada uno de los tipos i de reducción de potencia contratados. Si el valor de (P<sub>m1</sub> – P <sub>máx. 1</sub>) fuera negativo, se tomará igual a 0.
