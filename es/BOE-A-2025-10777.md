...
pdf_url: "https://www.boe.es/boe/dias/2025/05/31/pdfs/BOE-A-2025-10777.pdf"
subjects: ["Acceso a la universidad", "Alumnos", "Certificaciones", "Estudios extranjeros", "Títulos académicos y profesionales", "Universidad Nacional de Educación a Distancia"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2025-10777"
...
references_previous: "DE CONFORMIDAD con BOE-A-2024-11858; DE CONFORMIDAD con BOE-A-2006-7899"
---
...
| --- | --- |
| Alemania. | Allgemeine Hochschulreife |
...
| Bulgaria. | za Sredno Obrasovanie |
...
| Croacia. | State Matura Državna Matura |
...
| Eslovaquia. | Vysvedčenie o Maturitnej Skúške / Maturita |
| Eslovenia. | Maturitetno spričevalo |
...
| Finlandia. | Lukio Ylioppilastutkinto |
| Francia. | Baccalauréat Général, Technologique o Professionnel |
| Grecia. | Apolytirio Lykiou Veveosi |
| Hungría. | Érettségi bizonyitvány Érettségi vizsga |
| Irlanda. | Leaving Certificate Established |
...
| Lituania. | Brandos Atestatas |
| Luxemburgo. | Diplôme de fin d’études secondaires classiques ou générales |
| Malta. | Secondary Education Certificate English Language Mathematics Matriculation Certificate |
| Noruega. | Vitnemål for Videregående Opplæring |
| Países Bajos. | Voorbereidend Wetenschappelijk Onderwijs Centraal examen |
| Polonia. | Świadectwo dojrzałości maturalny |
| Portugal. | do Ensino Secundário Exames Nacionais do Ensino Secundário Direção-Geral do Ensino Superior |
| Reino Unido. | International General Certificate of Secondary Education International/ General Certificate of Education Tariff |
| República Checa. | Vysvědčení o maturitní zkoušce Maturita maturitní zkouška |
| Rumanía. | Bacalaureat |
| Suecia. | Högskoleförberedande gymnasieexamen |
| Suiza. | Maturité gymnasiale / Gymnasiale Maturität |
...
| --- | --- | --- |
| Allgemeine Hochschulreife | 4 a 1 (descendente) | Fórmula de conversión del anexo III.a). |
...
| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Standardisierte kompetenzorientierte Reifeprüfung Matura | 4 a 1 (descendente) | Fórmula de conversión del anexo III.a). |
| Standardisierte kompetenzorientierte Reife und Diplomprüfung Matura | 4 a 1 (descendente) | Fórmula de conversión del anexo III.a). |
| Berufsreifeprüfung | 4 a 1 (descendente) | Fórmula de conversión del anexo III.a). |
...
| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| za Sredno Obrasovanie | 3 a 6 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Gao Kao | Gao Kao | Fórmula de conversión del anexo III.a). |
| Gao Kao | 60 a 100 | Fórmula de conversión del anexo III.a). |
| Hong Kong Diploma of Secondary Education | 48-224 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Apolytirio | 10 a 20 | Fórmula de conversión del anexo III.a). |
...
| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Državna Matura | 2 a 5 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Calificación del certificado de Studentereksamen (stx). | 2 a 12 | Fórmula de conversión del anexo III.a). |
| Højere forgberedelsaseksamen | 2 a 12 | Fórmula de conversión del anexo III.a). |
...
| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Vysvedčenie o Maturitnej Skúške Maturita | Dostato*č*ný (4) Dobrý (3) Chválitebný (2) Výborný (1) (descendente) | Dostato*č*ný = 5,5. Dobrý = 6,83. Chválitebný = 8,17. Výborný = 9,5. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Maturitetno spričevalo | Zadostno (2) Dobro (3) Prav dobro (4) Odlično (5) | Zadostno = 5,5. Dobro = 6,83. Prav dobro = 8,17. Odlično = 9,5. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Riigieksamitunnistus Gümnaasiumi Lõputunnistus | E, D, C, B, A 50 a 100 | Para la escala de calificaciones literales: E = 5,5. D = 6,5. C = 7,5. B = 8,5. A = 9,5. Para la escala de calificaciones numéricas: Fórmula de conversión del anexo III.a). |
| Riigieksamitunnistus Lõputunnistus kutsekeskhariduse omandamise kohta | E, D, C, B, A 50 a 100 | Para la escala de calificaciones literales: E = 5,5. D = 6,5. C = 7,5. B = 8,5. A = 9,5. Para la escala de calificaciones numéricas: Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Ylioppilastutkinto | 2 a 7 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Relevé de Notes. | 10 a 20 | Fórmula de conversión del anexo III.c). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Apolytirio Lykiou | 10 a 20 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Érettségi bizonyítvány | Elégséges (2) Közepes (3) Jó (4) Jeles (5) | Elégséges = 5,5. Közepes = 6,83. Jó = 8,17. Jeles = 9,5. |
...
| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Stúdentspróf | 5 a 10 | Equivalencia directa con la escala española. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Maturità | 60 a 100 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Sekmju izraksts Atestāts par vispārējo vidējo izglītību Diploms par profesionālo vidējo izglītību | 4 a 10 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Matura | 4 a 6 | 4 (genügend) = 5,75. 5 (gut) = 7,5. 6 (sehr gut) = 9,25. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Brandos Atestatas | X* a 100 | Fórmula de conversión del anexo III.a). |
| * Dado que el mínimo aprobatorio se establece cada año, la escala aplicable se ajustará al mínimo establecido el año en el que se realizó el examen de acceso a la universidad. | * Dado que el mínimo aprobatorio se establece cada año, la escala aplicable se ajustará al mínimo establecido el año en el que se realizó el examen de acceso a la universidad. | * Dado que el mínimo aprobatorio se establece cada año, la escala aplicable se ajustará al mínimo establecido el año en el que se realizó el examen de acceso a la universidad. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Diplôme de fin d’études secondaires classiques ou générales | 30 a 60 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Matriculation Certificate | 44 a 100 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Vitnemål for Videregående Opplæring | 2 a 6 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Centraal examen cijferlijst VoorbereidendWetenschappelijk Onderwijs (VWO) | 5,5 a 10 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| maturalny | 30 a 100 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Direção-Geral do Ensino Superior | 100 a 200 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| A-Level Advanced Subsidiary | 48-224 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Maturita maturitní zkouška Vysvědčení o maturitní zkoušce | Dostatečný (4) Dobrý (3) Chválitebný (2) Výborný (1) | Dostatečný = 5,5. Dobrý = 6,83. Chválitebný = 8,17. Výborný = 9,5. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Situaţia la examenul de bacalaureat | 5 a 10 | Fórmula de conversión del anexo III.a). |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Högskoleförberedande gymnasieexamen | E, D, C, B, A | A = 10. B = 8,75. C = 7,5. D = 6,25. E = 5. |

| Calificación o calificaciones que permiten la determinación de la calificación de acceso a la universidad española | Escala de calificaciones positivas (de mínimo a máximo aprobatorio) | Procedimiento para la obtención de la calificación de acceso a la universidad española |
| --- | --- | --- |
| Maturité gymnasiale / Gymnasiale Maturität | 4 a 6 | Fórmula de conversión del anexo III.a). |
...
![](https://www.boe.es/datos/imagenes/disp/2025/131/10777_15733602_1.png)
...
| 350 - 399 |  |
| 400 - 500 |  |
| Según las fórmulas establecidas en el Acuerdo internacional administrativo entre el Ministerio de Educación y Formación Profesional y el Ministerio de Universidades del Reino de España y el Ministerio de Educación Nacional de la República de Colombia relativo al reconocimiento mutuo en materia de acceso a la universidad en el Reino de España y a las instituciones de educación superior en la República de Colombia, hecho en Madrid el 4 de mayo de 2023. | Según las fórmulas establecidas en el Acuerdo internacional administrativo entre el Ministerio de Educación y Formación Profesional y el Ministerio de Universidades del Reino de España y el Ministerio de Educación Nacional de la República de Colombia relativo al reconocimiento mutuo en materia de acceso a la universidad en el Reino de España y a las instituciones de educación superior en la República de Colombia, hecho en Madrid el 4 de mayo de 2023. |
