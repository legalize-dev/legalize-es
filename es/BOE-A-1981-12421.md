...
En el caso de haberse empleado disolventes no deberán aparecer residuos de los mismos en cantidad superior a 1 p. p. m. en el producto terminado.
...
| Índice de peróxidos (miliequivalentes de oxígeno activo por kg. de grasa) | < 3 |
...
| Índice de peróxidos (miliequivalentes de oxígeno activo/kg, de grasa) | < 3 | < 5 |
...
| Título (ºC) | 20-24 |
| Índice de saponificación (mg. de KOH/gramos) de grasa | 248-284 |
| Índice de yodo (Wijs) | 7-11 |
| Materia insaponificable | < 0,5 % |
| Índice de acidez (mg. de KOH/gr. de grasa) | < 0,3 |
| Índice de peróxidos (miliequivalentes de oxígeno activo/Kg. de grasa) | < 1,0 |
...
| --- | --- |
| Densidad a 40º C./agua a 15º C | 0,897-0,900 |
| Índice de refracción n<sub>D</sub> 40º C) | 1.454-1.458 |
| Título (ºC) | 38-46 |
| Índice de saponificación (mg. de KOH/gramos) de grasa | 195-206 |
| Índice de yodo (Wijs) | 45-48 |
| Materia insaponificable | 0,5-1,2 % |
| Índice de acidez (mg. de KOH/gr. de grasa) | 0,3 |
| Índice de peróxidos (miliequivalentes de oxígeno activo/Kg. de grasa) | < 2,0 |
...
7. Se podrán utilizar, para la extracción y otros tratamientos de grasas, los disolventes de características bien definidas, de origen natural o de síntesis, sin que exista la posibilidad de que contengan impurezas que tengan una clara acción nociva sobre el organismo. Deberán ser fácilmente separables, por destilación con o sin arrastre de vapor de una mezcla grasa-disolvente, pudiéndose eliminar hasta los últimos residuos, sin someter la grasa a calentamientos excesivos que puedan modificar sus características.

En principio se utilizarán los siguientes disolventes cuyas características de pureza figuran en el 14 informe del Comité conjunto FAO/OMS de expertos en aditivos, serie número 48 B 1970; publicado por la FAO/OMS en 1971:

| Para extracción | Para otros procesos, siempre que las grasas tratadas sean sometidas posteriormente a refinación completa |
| --- | --- |
| Hexano | Hexano |
| Heptano | Heptano |
| 1-1-2 tricoloroetileno | Etanol Acetona Isopropanol |
