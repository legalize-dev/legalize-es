...
pdf_url: "https://www.boe.es/boe/dias/2002/11/01/pdfs/A38617-38623.pdf"
subjects: ["Comisión Nacional de Energía", "Dirección General de Política Energética y Minas", "Distribución de energía", "Empresas", "Gas", "Información", "Precios", "Tarifas", "Transporte de energía"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2002/10/28/eco2692"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2002-21185"
url_pdf: "https://www.boe.es/boe/dias/2002/11/01/pdfs/A38617-38623.pdf"
page_start: "38617"
page_end: "38623"
image_marker: "A"
legislative_status: "L"
references_previous: "DE CONFORMIDAD con BOE-A-2001-17027"
references_subsequent: "SE DEROGA BOE-A-2021-15776; SE MODIFICA BOE-A-2018-17607; SE MODIFICA BOE-A-2015-2495; SE MODIFICA BOE-A-2007-22461; SE MODIFICA BOE-A-2006-22965; SE MODIFICA BOE-A-2005-19414; CORRECCIÓN de errores BOE-A-2002-22422; SE DICTA DE CONFORMIDAD BOE-A-2004-11361; SE DICTA DE CONFORMIDAD BOE-A-2002-23737"
...
> <small>Redactado conforme a la corrección de errores publicada en BOE núm. 277, de 19 de noviembre de 2002. [Ref. BOE-A-2002-22422](https://www.boe.es/buscar/doc.php?id=BOE-A-2002-22422).</small>
...
> <small>Se modifica por el art. 4 de la Orden ITC/3655/2005, de 23 de noviembre. [Ref. BOE-A-2005-19414](https://www.boe.es/buscar/doc.php?id=BOE-A-2005-19414).</small>
...
## ANEXO I. Empresas con activos en transporte sujetas al procedimiento de liquidación y sus costes fijos acreditados para el año 2002
...
## ANEXO II. Determinación de las liquidaciones

I.1 Ingresos liquidables IL<sub>it</sub>

Los ingresos liquidables de cada transportista o distribuidor i, en el período de liquidación t (IL<sub>it</sub>), sujeto al procedimiento de liquidaciones se obtendrá de acuerdo con las fórmulas siguientes:

### IL<sub>it</sub> = ILT<sub>it</sub> + ILP<sub>it</sub> + ILPC<sub>it</sub>

Siendo:

ILT<sub>it</sub> = Ingresos liquidables de cada distribuidor i, por la venta de gas natural y gas manufacturado por canalización suministrado a tarifa, correspondientes a los suministros efectuados en el período de liquidación t.
...
### ILT<sub>it</sub> = FT<sub>it</sub> - RS<sub>it</sub> - PC<sub>it</sub> * kWh<sub>it</sub>

FT<sub>it</sub>: Importe de la facturación bruta de gas natural y gas manufacturado por canalización suministrado a tarifa realizado por cada distribuidor i, correspondiente a los suministros efectuados en el período de liquidación t.

RS<sub>it</sub>: Importe de las cantidades a detraer por la retribución de la actividad de suministro a tarifa para cada distribuidor i, en el período de liquidación t.

PC<sub>it</sub>: Precio de cesión medio ponderado de cada distribuidor i, de sus adquisiciones de gas para la venta a tarifa correspondiente a los suministros efectuados en el período de liquidación t.

kWh<sub>it</sub>: kWh de gas suministrados y facturados en el mercado a tarifas por cada distribuidor i en el período de liquidación t.

ILP<sub>it</sub> = Ingresos liquidables de los transportistas y distribuidores i, correspondientes a los servicios efectuados en el período de liquidación t, por peajes y cánones de acceso a las instalaciones gasistas serán igual a la facturación bruta en concepto de peajes y cánones de acceso de terceros a las instalaciones gasistas al mercado liberalizado, en el período de liquidación t.

ILPC<sub>it</sub> = Ingresos liquidables por el transportista i, por la venta de gas a precio de cesión, correspondiente a los suministros efectuados en el período de liquidación t a distribuidores, con destino el mercado a tarifa. Son los que resultan de deducir a la facturación bruta por venta de gas natural a precio de cesión, los importes correspondientes al coste de la materia prima y la retribución de la actividad de gestión de compra-venta de gas destinado al mercado regulado, se calcularán de acuerdo con la fórmula siguiente:

### ILPC<sub>it</sub> = FPC<sub>it</sub> - Cmp<sub>t</sub> * kWh<sub>it</sub> - RGCV<sub>it</sub>

Siendo:

FPC<sub>it</sub>: Facturación bruta del transportista i por la venta de gas a precio de cesión, correspondiente a los suministros efectuados en el período de liquidación t a otros transportistas o a distribuidores, con destino al mercado a tarifa.

Cmp<sub>t</sub>: Coste unitario medio de la materia prima, obtenido al ponderar los costes unitarios de la materia prima vigentes por los suministros destinados al mercado a tarifa facturados por los transportistas a los distribuidores, en el período de liquidación.

kWh<sub>it</sub>: kWh suministrados y facturados por el transportista i con destino al mercado a tarifas en el período de liquidación t.

RGCV<sub>it</sub>: Importe por las cantidades a detraer por la retribución de la actividad de gestión de compra-venta de gas destinada al mercado a tarifas, de cada empresa transportista i, en el período de liquidación t.
...
A efectos de este procedimiento de liquidación, la cantidad a detraer de los ingresos por aplicación de las tarifas de gas natural y gases manufacturados por canalización, por la actividad de suministro a tarifa, para cada distribuidor i, en el período de liquidación t (RS<sub>it</sub>), se determinará de acuerdo con la siguiente fórmula:

### RS<sub>it</sub> = RAS<sub>it</sub> + RMD<sub>it</sub> + RCI<sub>it</sub>

Siendo:

RAS<sub>it</sub>: Coste específico del distribuidor i, durante el período de liquidación t, por la actividad de atención a los clientes a tarifa que se calculará de acuerdo con la siguiente fórmula:

### RAS<sub>it</sub> = (CS<sub>n-1<4</sub> × kWh<sub>cn<4it</sub> + CS<sub>n-1>4</sub> × kWh<sub>cn>4it</sub>)

Siendo:

CS<sub>n-1<4</sub> = Coeficiente de suministro a presión de diseño igual o inferior a 4 bar expresado en euros/kWh.

Para 2002 este coeficiente será igual a 0,001933 euros/kWh.

kWh<sub>cn<4it</sub> = kWh de gas suministrados y facturados a consumidores conectados a gasoductos cuya presión de diseño sea inferior o igual a 4 bar por cada distribuidor i, en el periodo de liquidación t.

CS<sub>n-1>4</sub> = Coeficiente de suministro a presión de diseño superior a 4 bar expresado en euros/kWh. Para 2002 este coeficiente será igual a 0,000274 euros/kWh.

kWh<sub>cn>4it</sub> = kWh de gas suministrados y facturados a consumidores conectados a gasoductos cuya presión de diseño sea superior a 4 bar por cada distribuidor i, en el periodo de liquidación t.

RMD<sub>it</sub>: Coste de las mermas en la red del distribuidor i correspondiente al mercado a tarifas en el período de liquidación t, que se calculará de acuerdo con la siguiente fórmula:

### RMD<sub>it</sub> = [C<sub>r<4</sub> × kWh<sub>cn<4it</sub> + C<sub>r>4</sub> × kWh<sub>cn>4it</sub>] × Cmp<sub>t</sub>

Siendo:

C<sub>r<4</sub>, C<sub>r>4</sub> = Porcentajes de mermas de distribución de gas en redes a presión inferior o igual y superior a 4 bar, respectivamente, que serán los fijados en las Normas de Gestión Técnica del Sistema. Para 2002 dichos porcentajes serán igual a 2 por 100 y 0,39 por 100, respectivamente.

kWh<sub>cn<4it</sub> = kWh de gas suministrados y facturados a consumidores conectados a gasoductos cuya presión de diseño sea inferior o igual a 4 bar por cada distribuidor i, en el período de liquidación t.

kWh<sub>cn>4it</sub> = kWh de gas suministrados y facturados a consumidores conectados a gasoductos cuya presión de diseño sea superior a 4 bar por cada distribuidor i, en el periodo de liquidación t.

Cmp<sub>t</sub> = Coste unitario medio de la materia prima, obtenido al ponderar los costes unitarios de la materia prima vigentes por los suministros destinados al mercado a tarifa facturados por los transportistas a los distribuidores, en el período de liquidación.

RCI<sub>it</sub>: Coste específico de cada distribuidor i por las necesidades financieras derivadas de la diferencia entre el pago de la materia prima y el cobro al cliente a tarifas durante el período de liquidación t, que se calculará de acuerdo con la siguiente fórmula:

### RCI<sub>it</sub> = C<sub>z</sub> × i × Cmp<sub>t</sub> × kWh<sub>cit</sub>

Siendo:

C<sub>z</sub> = Coeficiente que se fijará anualmente al efectuar la revisión anual de las tarifas de gas. Este coeficiente se establece para el año 2002 igual a 0,04.
...
kWh<sub>cit</sub> = kWh de gas suministrados y facturados en el mercado a tarifa de cada distribuidor i, en el período de liquidación t.
...
### RGCV<sub>it</sub> = RCV<sub>it</sub> + RMT<sub>it</sub> + RFE<sub>it</sub>

Siendo:

RCV<sub>it</sub>: Coste específico de cada transportista i por compra-venta de gas destinada al mercado a tarifas en el período de liquidación t, que se calculará de acuerdo con la siguiente fórmula:

### RCV<sub>it</sub> = C<sub>i</sub> × Cmp<sub>t</sub> × kWh<sub>ctit</sub>

Siendo:

C<sub>i</sub> = Coeficiente que se fijará anualmente al efectuar la revisión anual de las tarifas de gas. Este coeficiente se establece para el año 2002 igual a 0,005.

Cmp<sub>t</sub> = Coste unitario medio de la materia prima, obtenido al ponderar los costes unitarios de la materia prima vigentes por los suministros destinados al mercado a tarifa facturados por los transportistas a los distribuidores, en el período de liquidación.

kWh<sub>ctit</sub> = kWh de gas introducidos en el sistema de transporte y distribución, con destino el mercado a tarifa suministrados y facturados por el transportista i, en el período de liquidación t.

RMT<sub>it</sub>: Coste de las mermas de gas destinada al mercado a tarifas, de cada transportista i, en el período de liquidación t, que se calculará de acuerdo con la siguiente fórmula:

### RMT<sub>it</sub> = [(C<sub>r</sub> × kWh<sub>rit</sub>) + (C<sub>a</sub> × kWh<sub>ait</sub>) + (C<sub>t</sub> × kWh<sub>tit</sub>)] × Cmp<sub>t</sub>t

Siendo:

C<sub>r</sub>, C<sub>a</sub>, C<sub>t</sub> = Porcentajes de mermas de regasificación, almacenamiento y transporte de gas respectivamente que serán los fijados en las Normas de Gestión Técnica del Sistema. Para 2002 dichos porcentajes serán igual a 0,5 por 100, 2,11 por 100 y 0,43 por 100, respectivamente.

Cmp<sub>t</sub> = Coste unitario medio de la materia prima, obtenido al ponderar los costes unitarios de la materia prima vigentes por los suministros destinados al mercado a tarifa facturados por los transportistas a los distribuidores, en el período de liquidación.

kWhr<sub>it</sub> = kWh de gas (GNL) descargados por el transportista i en plantas de regasificación con destino al mercado a tarifas, en el período de liquidación t.

kWh<sub>ait</sub> = kWh de gas (GN) inyectados por el transportista i en los almacenamientos subterráneos con destino al mercado a tarifas en el período de liquidación t.

kWh<sub>tit</sub> = kWh de gas (GN) introducidos por cada transportista i en el sistema de transporte y distribución con destino al mercado a tarifas, en el período de liquidación t.

RFE<sub>it</sub>: Coste total específico de cada transportista i por financiación de existencias de gas destinada al mercado a tarifas durante el período de liquidación t, que se calculará de acuerdo con la siguiente fórmula:

### RFE<sub>it</sub> = C<sub>x</sub> × i × Cmp<sub>t</sub> × kWh<sub>ctit</sub>

Siendo:

C<sub>x</sub> = Coeficiente que se fijará anualmente al efectuar la revisión anual de las tarifas de gas. Este coeficiente se establece para el año 2002 igual a 0,218.
...
I.4 Ingresos netos liquidables. INL<sub>it</sub>
...
### INL<sub>it</sub> = IL<sub>it</sub> - CGTS<sub>it</sub> - CNE<sub>it</sub>

Siendo:

INL<sub>it</sub> = Ingresos liquidables definidos en el apartado I.2 del presente anexo.

CGTS<sub>it</sub> = Cantidades correspondientes a las liquidaciones de la cuota del Gestor Técnico del Sistema del transportista o distribuidor i, según el artículo 9 de esta Orden, para el período de liquidación t.

CNE<sub>it</sub> = Cantidades correspondientes a las liquidaciones de la tasa de la Comisión Nacional de Energía del transportista o distribuidor i, según el artículo 9 de esta Orden, para el período de liquidación t.

I.5 Importe a liquidar

El importe a liquidar (L<sub>it</sub>) por cada transportista o distribuidor i sujeto al procedimiento de liquidación, para el período de liquidación t, será el resultado de detraer sus ingresos netos liquidables a sus derechos de cobro sobre los ingresos netos liquidables totales. El importe a liquidar se calculará de acuerdo con la siguiente fórmula:

### L<sub>it</sub> = (k<sub>it</sub> * Ʃ INL<sub>it</sub>) - INL<sub>it</sub>

Siendo:

L<sub>it</sub> = Importe a liquidar por el transportista o distribuidor i, en el período de liquidación t.

k<sub>it</sub> = Tanto por uno de los costes acreditados para el transportista o distribuidor i, en el período de liquidación t, sobre el total de los ingresos netos liquidables para todos los transportista y distribuidores i, en el período de liquidación t, calculado de acuerdo con la siguiente fórmula:

### k<sub>it</sub> = (RF<sub>it</sub> + RV<sub>it</sub>) / Ʃ<sub>i</sub> (RF<sub>it</sub> + RV<sub>it</sub>)

Siendo:

RF<sub>it</sub>: Retribución fija acreditada en el año de liquidación considerado para el transportista o distribuidor i en el período de liquidación t, calculada como:

### RF<sub>it</sub> = RF<sub>i</sub> * N<sub>t</sub> / M

Donde:

RF<sub>i</sub> = Retribución fija acreditada total en el año de liquidación considerado, para el transportista o distribuidor i.

N<sub>t</sub> = Número de días naturales comprendidos en el período de liquidación t.

M = Número de días naturales del año de liquidación.

RV<sub>it</sub>: Retribución variable acreditada del transportista i, en el período de liquidación t, calculada como:

### RV<sub>it</sub> = RV * kWh<sub>it</sub>

Donde:

RV = Retribución variable acreditada a la actividad de regasificación en el año de liquidación.

kWh<sub>it</sub> = kWh regasificados o cargados en cisternas de GNL por el transportista i, en el período de liquidación t.

Ʃ<sub>i</sub> INL<sub>it</sub> = Suma de los ingresos netos liquidables de todos los transportista o distribuidores i, en el período de liquidación t.

INL<sub>it</sub> = Ingresos netos liquidables del transportista o distribuidor i, en el período de liquidación t.

> <small>Redactado el apartado I.4 conforme a la corrección de errores publicada en BOE núm. 277, de 19 de noviembre de 2002. [Ref. BOE-A-2002-22422](https://www.boe.es/buscar/doc.php?id=BOE-A-2002-22422).</small>
