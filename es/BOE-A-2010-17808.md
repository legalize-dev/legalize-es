...
pdf_url: "https://www.boe.es/boe/dias/2010/11/20/pdfs/BOE-A-2010-17808.pdf"
subjects: ["Accidentes", "Comités consultivos", "Comunidades Autónomas", "Consejo de Seguridad Nuclear", "Energía nuclear", "Instalaciones nucleares", "Protección Civil", "Protección radiológica", "Radiaciones ionizantes", "Reglamentaciones técnicas"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2010/11/19/1564"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2010-17808"
url_pdf: "https://www.boe.es/boe/dias/2010/11/20/pdfs/BOE-A-2010-17808.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2010-17808"
page_start: "96764"
page_end: "96789"
image_marker: "A"
...
references_subsequent: "SE DEROGA BOE-A-2023-14679; SE MODIFICA BOE-A-2020-46; SE MODIFICA BOE-A-2011-14812; SE DICTA EN RELACIÓN BOE-A-2015-12571"
...
Norma derogada, con efectos de 11 de julio de 2023, por la disposición derogatoria única.2.e) del Real Decreto 524/2023, de 20 de junio. [Ref. BOE-A-2023-14679#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2023-14679). No obstante, la Directriz básica continuará aplicándose hasta tanto sea aprobado el nuevo instrumento de planificación que la sustituya, según establece el apartado 3 de la citada disposición.
...
| E  = | ∑ | W<sub>TH</sub> = | ∑ | W<sub>T</sub> | ∑ | W<sub>R</sub>D<sub>T,R</sub> |
| --- | --- | --- | --- | --- | --- | --- |
| E  = | <sup>T</sup> | W<sub>TH</sub> = | <sup>T</sup> | W<sub>T</sub> | <sup>R</sup> | W<sub>R</sub>D<sub>T,R</sub> |

donde, D<sub>T,R</sub> es la dosis absorbida promediada sobre el tejido u órgano T procedente de la radiación R; W<sub>R</sub> es el factor de ponderación de la radiación, y W<sub>T</sub> es el factor de ponderación tisular del tejido u órgano T. Los valores adecuados para W<sub>T</sub> y W<sub>R</sub> se especifican en el anexo II del Reglamento sobre Protección Sanitaria contra Radiaciones Ionizantes.
...
### H<sub>TR</sub> = W<sub>R</sub> D<sub>T,R</sub>

siendo, D<sub>T,R</sub> la dosis absorbida promediada sobre el tejido u órgano T, procedente de la radiación R, y W<sub>R</sub> el factor de ponderación de la radiación. Cuando el campo de radiación se compone de tipos y energías con valores diferentes de W<sub>R</sub> la dosis equivalente total viene dada por la fórmula:

| H<sub>T</sub> = | ∑ | W<sub>R</sub> • D<sub>T,R</sub> |
| --- | --- | --- |
| H<sub>T</sub> = | <sup>R</sup> | W<sub>R</sub> • D<sub>T,R</sub> |

Los valores apropiados para W<sub>R</sub> se especifican en el anexo II del Reglamento sobre Protección Sanitaria contra Radiaciones Ionizantes. Su unidad de medida en el SI es el Sievert (Sv).
