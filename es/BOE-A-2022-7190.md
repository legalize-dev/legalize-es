...
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2022-7190"
page_start: "61688"
page_end: "61714"
image_marker: "A"
...
| 11 | Los siguientes subsectores dentro del sector de los plásticos (20.16): | Los siguientes subsectores dentro del sector de los plásticos (20.16): |
...
| 13 | Los siguientes subsectores dentro del sector de la fibra de vidrio (23.14): | Los siguientes subsectores dentro del sector de la fibra de vidrio (23.14): |
...
| 14 | Los siguientes subsectores dentro del sector de los gases industriales (20.11): | Los siguientes subsectores dentro del sector de los gases industriales (20.11): |
...
b) La intensidad de la ayuda podrá incrementarse hasta el límite máximo del valor añadido (*lim<sub>VAB</sub>*), para garantizar una protección adecuada contra el riesgo de fuga de carbono, cuyo valor será del 1,5 % según el apartado 31 de las nuevas Directrices, COM (2020) 6400.

2. El factor de emisión de CO<sub>2</sub> aplicable en el año t, descrito como *C*<sub>*t*</sub>, tendrá el valor de:

![](https://www.boe.es/datos/imagenes/disp/2022/106/7190_11542899_1.png)

De acuerdo al apartado 15.11, epígrafe 1.3 de las nuevas Directrices, el presente factor de emisión de CO<sub>2</sub>, podrá verse modificado a un factor de emisión de CO<sub>2</sub> basado en el mercado, previa notificación del régimen y autorización de la Comisión Europea.
...
*E = Valor de referencia Eficiente<sub>2021</sub> * (1 – Índice de reducción anual)<sup>i</sup>*
...
![](https://www.boe.es/datos/imagenes/disp/2022/106/7190_11542895_1.png)

Donde:

– *PM*: es el parámetro de referencia de emisión por tonelada fabricada de producto conforme a la sección 2 del anexo del Reglamento Delegado (UE) 2021/447 expresado en ![](https://www.boe.es/datos/imagenes/disp/2022/106/7190_11542896_1.png).
...
![](https://www.boe.es/datos/imagenes/disp/2022/106/7190_11542897_1.png)

– 0,376: es el medio europeo de intensidad de emisiones indicado en el artículo 22 del Reglamento Delegado (UE) 2019/331 19 de diciembre de 2018 y expresado en ![](https://www.boe.es/datos/imagenes/disp/2022/106/7190_11542898_1.png)
...
| 17.11 | Pasta mecánica de madera. | 17.11.14.00 | Pasta mecánica de madera; pasta semiquímica de madera; pastas de materias celulósicas distintas de la madera. | Pasta mecánica de madera. | Enfoque Alternativo. | Enfoque Alternativo. | Enfoque Alternativo. | 1,09 | Todo proceso directa o indirectamente vinculados a la producción mecánica de celulosa, incluido el tratamiento de la madera, refinado, lavado, blanqueo, recuperación de calor. |
...
| 20.13 | Ácido Sulfúrico. | 20.13.24.34 | Ácido sulfurico; oleum. | Ácido sulfurico; oleum. | prod | 0,056 | prod | 1,09 | Todos los procesos directa o indirectamente relacionados con la producción de ácido sulfúrico. |
...
| 24.10 | Acero obtenido por soplado con oxígeno. | 24.10.T1.22 | Acero bruto: acero sin alear fabricado por otros procedimientos distintos de los hornos eléctricos. | Acero bruto: acero sin alear fabricado por otros procedimientos distintos de los hornos eléctricos. | prod | 0,03385 | prod | 0,6 | Metalurgia secundaria, precalentamiento de refractarios, instalaciones auxiliares y de fundición hasta corte de productos de acero bruto. |
| 24.10 | Acero obtenido por soplado con oxígeno. | 24.10.T1.32 | Acero bruto: acero aleado, excepto inoxidable, fabricado por otros procedimientos distintos de los hornos eléctricos. | Acero bruto: acero aleado, excepto inoxidable, fabricado por otros procedimientos distintos de los hornos eléctricos. | prod | 0,03385 | prod | 0,6 | Metalurgia secundaria, precalentamiento de refractarios, instalaciones auxiliares y de fundición hasta corte de productos de acero bruto. |
| 24.10 | Acero obtenido por soplado con oxígeno. | 24.10.T1.42 | Acero bruto: acero inoxidable y termorresistente fabricado por otros procedimientos distintos de los hornos eléctricos. | Acero bruto: acero inoxidable y termorresistente fabricado por otros procesos distintos de los hornos eléctricos. | prod | 0,03385 | prod | 0,6 | Metalurgia secundaria, precalentamiento de refractarios, instalaciones auxiliares y de fundición hasta corte de productos de acero bruto. |
...
Factor de emisión de CO<sub>2</sub>, *(tCO<sub>2</sub>/MWh):* media ponderada de la intensidad de CO<sub>2</sub> de la electricidad producida a partir de combustibles fósiles en diferentes zonas geográficas. La ponderación refleja la mezcla de producción de los combustibles fósiles en la zona geográfica de que se trate, definido en el anexo II.

*AO<sub>t</sub>* Producción real (toneladas producidas por año): la producción real de la instalación en el año t, determinada ex post el año t+1.

*AEC<sub>t</sub>* Consumo eléctrico real (MWh): consumo de electricidad real de la instalación (incluido el consumo de electricidad necesario para la fabricación de productos externalizados subvencionables) en el año t, determinado ex post en el año t+1.
