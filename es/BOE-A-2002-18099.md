...
– tres ternas en un nivel: RST, TSR, RST
...
En la tabla 6 se indican los factores de corrección, F, de la intensidad admisible para temperaturas del terreno Θt, distintas de 25 ºC, en función de la temperatura máxima de servicio Θs, de la tabla 2.
...
En la tabla 13 se indican los factores de corrección F, de la intensidad admisible para temperaturas del aire ambiente, Θa, distintas de 40 ºC, en función de la temperatura máxima de servicio Θs en la tabla 2.
...
INSTALACIONES DE ENLACE. DISPOSITIVOS GENERALES E INDIVIDUALES DE MANDO Y PROTECCIÓN. INTERRUPTOR DE CONTROL DE POTENCIA
...
(1) Para canalizaciones precableadas ordinarias empotradas en obra de fábrica (paredes, techos y falsos techos) se acepta una temperatura máxima de instalación y servicio código 1; +60 ºC.
...
(10) La potencia prevista por toma, los tipos de bases de toma de corriente y la intensidad asignada del interruptor automático para el circuito C13 se especifican en la ITC-BT-52.
...
INSTALACIONES CON FINES ESPECIALES. REQUISITOS PARTICULARES PARA LA INSTALACIÓN ELÉCTRICA EN QUIRÓFANOS Y SALAS DE INTERVENCIÓN
...
La capacidad térmica de los materiales situados en la superficie del aislamiento térmico y la superficie emisora será inferior a 120 kJ/m2 K (29 kcal/m2 ºC).
...
La capacidad térmica de los materiales situados entre la superficie del aislamiento térmico y la superficie emisora será inferior a 180 kJ/m2 K (43 kcal/m2 ºC).
...
– 0,75 mm2 de cobre para instalación de alumbrado exclusivamente y con conductores flexibles si la longitud entre la conexión en la instalación fija del local o vivienda y el aparato más alejado contenido en el mueble no es superior a 10 m y si éste no lleva ninguna base de toma de corriente.

– 1,5 mm2 de cobre, flexible o rígido, en los demás casos si no hay bases de toma de corriente.

– 2,5 mm2 de cobre, flexible o rígido, en cualquier caso, si hay bases de toma de corriente
