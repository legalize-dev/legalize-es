...
| Servicio de Tránsito Aéreo (ATS) | Control de Tránsito Aéreo (ATC) | Servicio de Control de Aproximación |  |
| Servicio de Tránsito Aéreo (ATS) | Control de Tránsito Aéreo (ATC) | Servicio de Control de Aeródromo |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de Información de Vuelo (FIS) | Servicio de emisión de información de vuelo operacional HF (OFIS) |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de Información de Vuelo (FIS) | Servicio de emisión de información de vuelo operacional VHF (OFIS) |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de Información de Vuelo (FIS) | Servicio automático de emisión de información de área terminal por voz (voz-ATIS) |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de Información de Vuelo (FIS) | Servicio automático de emisión de información de área terminal por enlace de datos (D-ATIS) |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de alerta (AL) | Servicio AL completo |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de asesoramiento | Servicio Asesoramiento Completo |  |
| Servicio de Tránsito Aéreo (ATS) | Servicio de información de vuelo en aeródromo (AFIS) *(Combinación de FIS y AL en un aerórdromo sin servicios ATC)* | Servicio AFIS completo |  |
...
| Comunicaciones, Navegación y Vilagilancia (CNS) | Comunicaciones (C) | Servicio Aeronáutivo Móvil (comunicaciones aire-tierra) | Servicio para control de área |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Comunicaciones (C) | Servicio Aeronáutivo Móvil (comunicaciones aire-tierra) | Servicio para control de aeródromo |
| Comunicaciones, Navegación y Vilagilancia (CNS) |  | Servicio Aeronáutico Fijo (comunicaciones tierra-tierra) |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) |  | Servicio Aeronático Móvil por Satélite (AMSS) |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de señal en el espacio NDB |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de señal en el espacio VOR |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de señal en el espcaio DME |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de la señal en el espacio ILS | CAT I |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de la señal en el espacio ILS | CAT II |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de la señal en el espacio ILS | CAT III a |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de la señal en el espacio ILS | CAT III b |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de la señal en el espacio ILS | CAT III c |
...
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de señal en el espacio GNSS | Sistema de aumentación basado en satétiles (SBAS) |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Navegación (N) (definición SES: los servicios de navegación implican aquellas dependencias/instalaciones y servicio que proporcionan a la aeronaves posicionamiento e información temporal) *(Nota: el servicio incluye la generación de la señal aeronáutica de radio navegación en el espacio, así como su posterior dist**ribución y procesamiento hasta su entrega a la aeronave para su utilización)* | Provisión de señal en el espacio GNSS | Sistema de aumentación basado en tierra (GBAS) |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de radar de vigilancia primario (PSR) |  |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de radar de vigilancia secundario (SSR) | Modo A/C |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de radar de vigilancia secundario (SSR) | Modo S |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de Automatic Dependent Surveillance (ADS) | ADS-C |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de Automatic Dependent Surveillance (ADS) | ADS-B |
| Comunicaciones, Navegación y Vilagilancia (CNS) | Vigilancia (S) *(definición SES: los servicios de vigilanci*a implican aquellas dependencias/instalaciones y servicios usados para determinar las respectivas posiciones de las aeronaves con el fin de permitir una separación segura). *(Nota: el servicio incluye la generación de los datos de vigilancia mediante sensores, as**í como su posterior distribución y procesamiento hasta su entrega para el uso de operaciones ATM)* | Provisión de datos a partir de radar de superficie (SMR) |  |
