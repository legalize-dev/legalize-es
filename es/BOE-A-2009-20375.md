...
pdf_url: "https://www.boe.es/boe/dias/2009/12/19/pdfs/BOE-A-2009-20375.pdf"
subjects: ["Administración y Contabilidad de la Hacienda Pública", "Agencia Estatal de la Administración Tributaria", "Canarias", "Cesión de Tributos", "Comunidades Autónomas", "Consejos consultivos", "Delegación de atribuciones", "Financiación de las Comunidades Autónomas", "Fondos de dinero", "Gestión fiscal", "Impuesto sobre el Valor Añadido", "Impuesto sobre la Renta de las Personas Físicas", "Impuesto sobre Transmisiones Patrimoniales y Actos Jurídicos Documentados", "Impuestos Especiales", "Inspección fiscal", "Organización de la Administración del Estado", "Recaudación", "Reclamaciones Económico Administrativas", "Sistema tributario"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/l/2009/12/18/22"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2009-20375"
url_pdf: "https://www.boe.es/boe/dias/2009/12/19/pdfs/BOE-A-2009-20375.pdf"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2009/12/19/pdfs/BOE-A-2009-20375-C.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2009/12/19/pdfs/BOE-A-2009-20375-G.pdf"
url_pdf_valenciano: "https://www.boe.es/boe_valenciano/dias/2009/12/19/pdfs/BOE-A-2009-20375-V.pdf"
page_start: "107086"
page_end: "107155"
image_marker: "A"
...
references_previous: "DEROGA BOE-A-2005-15422; DEROGA BOE-A-2001-24962; MODIFICA BOE-A-2006-20764; MODIFICA BOE-A-2003-23186; MODIFICA BOE-A-1990-31180; DE CONFORMIDAD con BOE-A-1980-21166"
references_subsequent: "SE MODIFICA BOE-A-2022-12644; SE MODIFICA BOE-A-2017-7387; SE MODIFICA BOE-A-2014-13613; SE MODIFICA BOE-A-2014-9896; SE MODIFICA BOE-A-2014-2485; SE MODIFICA BOE-A-2012-8745"
...
### *IVA<sub>i</sub>(2007) = IVA<sub>E</sub>(2007) * 50% * ICV<sub>i</sub>(2007)*

El término *IVA<sub>E</sub>(2007)* representa la recaudación líquida por IVA obtenida por el Estado en 2007.

El término *ICV<sub>i</sub>(2007)* representa el índice de consumo de la Comunidad Autónoma i para 2007, certificado por el INE.
...
### *IEC<sub>i</sub>(2007) = IEC<sub>E</sub>(2007) * 58% * ICC<sub>i</sub>(2007)*

El término *IEC<sub>E</sub>(2007)* representa la recaudación líquida por el Impuesto sobre la Cerveza obtenida por el Estado en 2007.

El término *ICC<sub>i</sub>(2007)* representa el índice de consumo de la Comunidad Autónoma i para 2007, certificado por el INE.
...
### *IEA<sub>i</sub>(2007) = IEA<sub>E</sub>(2007) * 58% * ICA<sub>i</sub>(2007)*

El término *IEA<sub>E</sub>(2007)* representa la recaudación líquida por los Impuestos sobre Productos Intermedios y sobre Alcohol y Bebidas Derivadas obtenida por el Estado en 2007.

El término *ICA<sub>i</sub>(2007)* representa el índice de consumo de la Comunidad Autónoma i para 2007, certificado por el INE.
...
### *IEH<sub>i</sub>(2007) = IEH<sub>E</sub>(2007) * 58% * ICH<sub>i</sub>(2007)*

El término *IEH<sub>E</sub>(2007)* representa la recaudación líquida por el Impuesto sobre Hidrocarburos obtenida por el Estado en 2007.

El término *ICH<sub>i</sub>(2007)* representa el índice de entregas de gasolinas, gasóleos y fuelóleos, según datos del Ministerio de Industria, Turismo y Comercio ponderados por los correspondientes tipos impositivos, en la Comunidad Autónoma i en 2007.
...
### *IELT<sub>i</sub>(2007) = IELT<sub>E</sub>(2007) * 58% * ICT<sub>i</sub>(2007)*

El término *IELT<sub>E</sub>(2007)* representa la recaudación líquida por el Impuesto sobre las Labores del Tabaco obtenida por el Estado en 2007.

El término *ICT<sub>i</sub>(2007)* representa el índice de ventas a expendedurías de la Comunidad Autónoma i en 2007, certificadas por el Comisionado para el Mercado de Tabacos, ponderadas por los correspondientes tipos impositivos.
...
### *IEE<sub>i</sub>(2007) = IEE<sub>E</sub>(2007) * ICE<sub>i</sub>(2007)*

El término *IEE<sub>E</sub>(2007)* representa la recaudación líquida por el Impuesto sobre la Electricidad obtenida por el Estado en 2007.

El término *ICE<sub>i</sub>(2007)* representa el índice de consumo neto de energía eléctrica en la Comunidad Autónoma i en 2007, elaborado a partir de los datos del Ministerio de Industria, Turismo y Comercio.
...
### *TG<sub>i</sub>(2007) = PFG<sub>i</sub>(2007) - 75% RT<sub>i</sub>(2007)*
...
### *AC<sub>TIRi</sub>(x) = RPC<sub>PGE</sub>(x) * Ia<sub>TIRi</sub>(x/ua) * 0,98*

Siendo:

| *AC<sub>TIRi</sub>(x)* | el importe anual del anticipo que deberá abonar el Estado a la Comunidad Autónoma i en concepto de entrega a cuenta del rendimiento en el año (x) de la tarifa autonómica del IRPF. |
| --- | --- |
| *RPC<sub>PGE</sub>(x)* | el importe de la previsión presupuestaria de ingresos de IRPF para el año (x) por retenciones, pagos a cuenta y pagos fraccionados. |
| *Ia<sub>TIRi</sub>(x/ua)* | el índice de actualización o incremento previsto, para la tarifa autonómica del impuesto de la Comunidad Autónoma i, entre el último año (ua) con liquidación definitiva practicada y el año (x). |

El índice de actualización es el resultado de practicar la siguiente operación.

![](https://www.boe.es/datos/imagenes/disp/2009/305/20375_001.png)

En esta fórmula, las razones que figuran en el segundo miembro representan respectivamente:

| ![](https://www.boe.es/datos/imagenes/disp/2009/305/20375_002.png) | Relación de las cuotas líquidas por tarifa autonómica del IRPF más retenciones de no declarantes de la Comunidad Autónoma i, sobre la cuota líquida total del IRPF más las retenciones de no declarantes totales, en el último año con datos definitivos. |
| --- | --- |
| ![](https://www.boe.es/datos/imagenes/disp/2009/305/20375_003.png) | Relación entre la estimación de la cuota autonómica de la Comunidad Autónoma i resultante de aplicar modificaciones normativas aprobadas por ella para el año (x), respecto al último año conocido (ua), e igual estimación sin considerar dichas modificaciones. |
| ![](https://www.boe.es/datos/imagenes/disp/2009/305/20375_004.png) | Índice de discrepancia entre la cuota líquida total más las retenciones de no declarantes totales, ambos del último ejercicio conocido y los derechos reconocidos netos correspondientes a retenciones, pagos a cuenta y pagos fraccionados, por el IRPF, en ese mismo ejercicio. |
...
### *AC<sub>IVAi</sub>(x) = 50% * RP<sub>IVA</sub>(x) * ICVP<sub>i</sub>(x) * 0,98*

Siendo:

*AC<sub>IVAi</sub>(x)* es el importe anual del anticipo a la Comunidad Autónoma i, en concepto de entrega a cuenta de la recaudación de IVA obtenida en el año (x).

*RP<sub>IVA</sub>(x)* la recaudación líquida prevista de IVA en el año (x).

*ICVP<sub>i</sub>(x)* el índice provisional de consumo de la Comunidad Autónoma i para el año (x).
...
### *AC<sub>IECi</sub>(x) = 58% * RP<sub>IEC</sub>(x) * ICCP<sub>i</sub>(x) * 0,98*

Siendo:

*AC<sub>IECi</sub>(x)* es el importe anual del anticipo a la Comunidad Autónoma i, en concepto de entrega a cuenta de la recaudación del Impuesto sobre la Cerveza obtenida en el año (x).

*RP<sub>IEC</sub>(x)* la recaudación líquida prevista por el Impuesto sobre la Cerveza en el año (x).

*ICCP<sub>i</sub>(x)* el índice provisional de consumo de la Comunidad Autónoma i para el año (x).
...
### *AC<sub>IEAi</sub>(x) = 58% * RP<sub>IEA</sub>(x) * ICAP<sub>i</sub>(x) * 0,98*

Siendo:

*AC<sub>IEAi</sub>(x)* el importe anual del anticipo a la Comunidad Autónoma i, en concepto de entrega a cuenta de la recaudación de los Impuestos sobre Productos Intermedios y sobre Alcohol y Bebidas Derivadas obtenida en el año (x).

*RP<sub>IEA</sub>(x)* la recaudación líquida prevista por los Impuestos sobre Productos Intermedios y sobre Alcohol y Bebidas Derivadas en el año (x).

*ICAP<sub>i</sub>(x)* el índice provisional de consumo de la Comunidad Autónoma i para el año (x).
...
> <small>Se modifica, con efectos desde el 1 de enero de 2013, por la disposición final 12.1 de la Ley 2/2012, de 29 de junio. [Ref. BOE-A-2012-8745#duodecima-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2012-8745).</small>
...
### *P<sub>IELTi</sub>(x) = 58% * RP<sub>IELT</sub>(x) * ICTP<sub>i</sub>(x) * 0,98*

Siendo:

*P<sub>IELTi</sub>(x)* el importe anual del anticipo a la Comunidad Autónoma i, en concepto de entrega a cuenta de la recaudación del Impuesto sobre las Labores del Tabaco obtenida en el año (x).

*RP<sub>IELT</sub>(x)* la recaudación líquida prevista por el Impuesto sobre las Labores de Tabaco en el año (x).

*ICTP<sub>i</sub>(x)* el índice provisional de ventas a expendedurías, de la Comunidad Autónoma i para el año (x), ponderadas por los correspondientes tipos impositivos.
...
### *P<sub>IEEi</sub>(x) = RP<sub>IEE</sub>(x) * ICEP<sub>i</sub>(x) * 0,98*

Siendo:

*P<sub>IEEi</sub>(x)* el importe anual del anticipo a la Comunidad Autónoma i en concepto de entrega a cuenta de la recaudación del Impuesto sobre la Electricidad obtenida en el año (x).

*RP<sub>IEE</sub>(x)* la recaudación líquida prevista por el Impuesto sobre la Electricidad en el año (x).

*ICEP<sub>i</sub>(x)* el índice provisional de consumo neto de energía eléctrica en la Comunidad Autónoma i para el año (x).
...
### *ACTG<sub>i</sub>(x) = PPFG<sub>i</sub>(x) - 75% PRT<sub>i</sub>(x)*

Siendo:

*ACTG<sub>i</sub>(x)* el importe anual del anticipo con destino o procedente de la Comunidad Autónoma i en concepto de entrega a cuenta de la transferencia del Fondo de Garantía correspondiente al año (x).

*PPFG<sub>i</sub>(x)* la previsión de participación en el Fondo de Garantía, correspondiente a la Comunidad Autónoma i en el año (x).

*PRT<sub>i</sub>(x)* la previsión de recaudación de recursos tributarios correspondientes a la Comunidad Autónoma i en el año (x), en términos normativos.
...
> <small>Se modifica el apartado 4, con efectos desde el 1 de enero de 2013, por la disposición final 12.2 de la Ley 2/2012, de 29 de junio. [Ref. BOE-A-2012-8745#duodecima-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2012-8745).</small>
...
### *FS<sub>i</sub>(x) = FS<sub>i</sub>(2007) * [ ITE(x) / ITE(2007) ] * 0,98*

Siendo:

*FS<sub>i</sub>(x)* el importe anual de la entrega a cuenta para la Comunidad Autónoma o Ciudad con Estatuto de Autonomía i, en el año (x), de su Fondo de Suficiencia Global.

*FS<sub>i</sub>(2007)* el importe para la Comunidad Autónoma o Ciudad con Estatuto de Autonomía i, en el año base, de su Fondo de Suficiencia Global.
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.1 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.1 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.2 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.2 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> <small>Se modifica, con efectos desde el 1 de enero de 2013, por la disposición final 12.4 de la Ley 2/2012, de 29 de junio. [Ref. BOE-A-2012-8745#duodecima-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2012-8745).</small>
...
> <small>Se modifica, con efectos desde el 1 de enero de 2013, por la disposición final 12.5 de la Ley 2/2012, de 29 de junio. [Ref. BOE-A-2012-8745#duodecima-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2012-8745).</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.6 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.6 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización, por la disposición final 5.7 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, por la disposición final 5.7 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.9 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.9 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.10 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.10 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización, por la que se añade el apartado 6, por la disposición final 5.11 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.

> <small>Se añade el apartado 6, por la disposición final 5.11 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.12 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.12 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> Téngase en cuenta que esta última actualización del apartado 1, por la disposición final 5.13 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.
...
> <small>Se modifica, con efectos de 29 de agosto de 2022, el apartado 1, por la disposición final 5.13 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> <small>Se suprime el párrafo tercero, con efectos desde la liquidación de los recursos del Sistema de Financiación de 2015, por la disposición final 19 de la Ley 3/2017, de 27 de junio. [Ref. BOE-A-2017-7387#df-20](https://www.boe.es/buscar/doc.php?id=BOE-A-2017-7387)</small>

> <small>Esta modificación tiene la misma naturaleza que lo establecido por el art. 12.4 de la Ley Orgánica 2/2012, de 27 de abril, según determina la disposición adicional 155 de la Ley 6/2018, de 3 de julio [Ref. BOE-A-2018-9268#da-156](https://www.boe.es/buscar/doc.php?id=BOE-A-2018-9268)</small>
...
> Téngase en cuenta que esta última actualización por la que se añade este precepto, por la disposición final 5.14 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.

> <small>Se añade, con efectos de 29 de agosto de 2022, por la disposición final 5.14 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
...
> <small>Se suprime el apartado 6 por la disposición final 4 de la Ley 17/2014, de 30 de septiembre. [Ref. BOE-A-2014-9896](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-9896).</small>

> <small>Téngase en cuenta que este apartado ya fue derogado por el Real Decreto-ley 4/2014, de 7 de marzo.</small>

> <small>Se suprime el apartado 6 por la disposición final 4 del Real Decreto-ley 4/2014, de 7 de marzo. [Ref. BOE-A-2014-2485](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-2485).</small>
...
> <small>Se modifica el apartado 2 por la disposición final 3 del Real Decreto-ley 17/2014, de 26 de diciembre. [Ref. BOE-A-2014-13613](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13613).</small>

> <small>Se añade, con efectos desde el 1 de enero de 2013, por la disposición final 12.6 de la Ley 2/2012, de 29 de junio. [Ref. BOE-A-2012-8745#duodecima-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2012-8745).</small>
...
> Téngase en cuenta que esta última actualización por la que se añade este precepto, por la disposición final 5.15 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644), entrará en vigor el 29 de agosto de 2022, según establece su disposición final 11.

> <small>Se añade, con efectos de 29 de agosto de 2022, por la disposición final 5.15 de la Ley Orgánica 9/2022, de 28 de julio. [Ref. BOE-A-2022-12644#df-5](https://www.boe.es/buscar/doc.php?id=BOE-A-2022-12644)</small>
