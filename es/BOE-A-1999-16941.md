...
(1) Véase el Código sobre niveles sonoros a bordo de los buques, adoptado por la Asamblea de la OMI mediante la Resolución A.468 (XII).
...
.5 Los rellanos a nivel de cada cubierta tendrán una superficie no inferior a 2 m2, la cual se aumentará en 1 m2 por cada 10 personas previstas por encima de 20, aunque no es necesario que excedan de 16 m2 salvo los utilizados en los espacios públicos que tengan acceso directo al tronco de escalera.
...
.3 Los tramos cortos de conducto que en general no excedan de 0,02 m2 de sección y de 2 m de longitud, podrán no ser incombustibles, a condición de que cumplan con lo siguiente:
...
.5 Las chapas que recubran las superficies y los revestimientos comprendidos en lo prescrito en el punto 3 tendrán un valor caló rico que no exceda de 45 MJ/m2 de la superficie para el espesor utilizado.
