...
f) «Nave de pasaje de gran velocidad»: buque mercante de transporte de pasajeros capaz de desarrollar una velocidad máxima, en metros por segundo, igual o superior a: 3,7V<sup>0,1667</sup> (donde V representa, en metros cúbicos, el desplazamiento correspondiente a la flotación del proyecto).
