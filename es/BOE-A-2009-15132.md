...
pdf_url: "https://www.boe.es/boe/dias/2009/09/24/pdfs/BOE-A-2009-15132.pdf"
subjects: ["Administraciones Públicas", "Boletín Oficial del Estado", "Contabilidad", "Empresas públicas", "Información", "Intervención General de la Administración del Estado", "Publicaciones oficiales"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2009-15132"
...
references_previous: "DEROGA BOE-A-2006-332; DE CONFORMIDAD con BOE-A-2003-21614"
...
> <small>Se añade último párrafo por la disposición adicional.2 de la Resolución de 3 de junio de 2013. [Ref. BOE-A-2013-6043](https://www.boe.es/buscar/doc.php?id=BOE-A-2013-6043).</small>
...
| Categorías | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Clases | Total | Total |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Categorías |  | Ej x | Ej x-1 | Ej. x | Ej x-1 | Ej. x | Ej x-1 | Ej. x | Ej x-1 | Ej. x | Ej x-1 | Ej. x | Ej x-1 | Ej x |
...
1.<sub>1</sub>) Activos financieros.

| Activos financieros | Efectivo y otros líquidos equivalentes | Activos financieros mantenidos para negociar | Otros activos financieros a valor razonable con cambios en PyG | Otros activos financieros a valor razonable con cambios en PyG | Otros activos financieros a valor razonable con cambios en PyG | Activos financieros disponibles para la venta | Activos financieros disponibles para la venta | Préstamos y partidas a cobrar | Cartera de inversión a vencimiento | Derivados de cobertura | Participaciones en entidades del grupo y asociadas | TOTAL |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Activos financieros | Efectivo y otros líquidos equivalentes | Activos financieros mantenidos para negociar | Instrumentos financieros híbridos | Corrección de asimetrías contables | Instrumentos gestionados según estrategia del valor razonable | Valor razonable | Coste | Préstamos y partidas a cobrar | Cartera de inversión a vencimiento | Derivados de cobertura | Participaciones en entidades del grupo y asociadas | TOTAL |
| Instrumentos de patrimonio: |  |  |  |  |  |  |  |  |  |  |  |  |
...
1.<sub>2</sub>) Pasivos financieros.
...
| Ejercicio | Ingresos brutos computables (1) | Gastos necesarios computables (2) | Impuestos (3) | Diferencia (4)=(1)-(2)-(3) | Importe destinado a fines propios | Importe destinado a fines propios | Importe destinado a fines propios | Importe destinado a fines propios | Importe destinado a fines propios | Importe destinado a fines propios |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Ejercicio | Ingresos brutos computables (1) | Gastos necesarios computables (2) | Impuestos (3) | Diferencia (4)=(1)-(2)-(3) | Total (5) | Total (5) | Destinado en el ejercicio | Destinado en el ejercicio | Destinado en el ejercicio | Destinado en el ejercicio |
...
| Ejercicio | Gastos de administración | Importe destinado dotación fundacional | Importe destinado dotación fundacional | Importe destinado dotación fundacional | Importe destinado dotación fundacional | Importe destinado dotación fundacional |
| --- | --- | --- | --- | --- | --- | --- |
| Ejercicio | Gastos de administración | Total | Destinado en el ejercicio | Destinado en el ejercicio | Destinado en el ejercicio | Destinado en el ejercicio |
| Ejercicio | Importe | Importe | n-3 | n-2 | n-1 | n |
| n-3 |  |  |  |  |  |  |
| n-2 |  |  |  |  |  |  |
| n-1 |  |  |  |  |  |  |
| n |  |  |  |  |  |  |
