...
| Clasificación de la sustancia (gas) | Clasificación del preparado gaseoso | Clasificación del preparado gaseoso |
| --- | --- | --- |
| Clasificación de la sustancia (gas) | Categorías 1 y 2 | Categoría 3 |
...
| N, R50-53 | C<sub>n</sub> ≥ 25 por 100 | 2,5 por 100 ≤ C<sub>n</sub> < 25 por 100 | 0,25 por 100 ≤ C<sub>n</sub> < 2,5 por 100 |
| N, R51-53 |  | C<sub>n</sub> ≥ 25 por 100 | 2,5 por 100 ≤ C<sub>n</sub> < 25 por 100 |
...
1.2 Cuando dichos preparados estén clasificados como muy tóxicos (T<sup>+</sup>), tóxicos (T) o corrosivos (C) y sea materialmente imposible dar dicha información en el propio envase, éste deberá ir acompañado de instrucciones precisas y de fácil compresión en las que figure, si fuera necesario, la información relativa a la destrucción del envase una vez vacío.
