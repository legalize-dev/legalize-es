---
title: "Real Decreto 1085/2024, de 22 de octubre, por el que se aprueba el Reglamento de reutilización del agua y se modifican diversos reales decretos que regulan la gestión del agua"
identifier: "BOE-A-2024-21701"
country: "es"
rank: "real_decreto"
publication_date: "2024-10-23"
last_updated: "2024-10-23"
status: "in_force"
source: "https://www.boe.es/eli/es/rd/2024/10/22/1085"
department: "Ministerio de la Presidencia, Justicia y Relaciones con las Cortes"
pdf_url: "https://www.boe.es/boe/dias/2024/10/23/pdfs/BOE-A-2024-21701.pdf"
subjects: ["Aguas", "Aguas residuales", "Aprovechamiento de aguas", "Autorizaciones", "Bases de datos", "Concesiones administrativas", "Consumidores y usuarios", "Contaminación de las aguas", "Control de calidad", "Dirección General del Agua", "Distintivos", "Dominio Público Hidráulico", "Embarcaciones deportivas y de recreo", "Información", "Infracciones", "Ministerio para la Transición Ecológica y el Reto Demográfico", "Navegación fluvial", "Normas de calidad", "Procedimiento administrativo", "Registros telemáticos", "Riesgos"]
department_code: "9585"
rank_code: "1340"
ambito_code: "1"
official_number: "1085/2024"
enactment_date: "2024-10-22"
official_journal: "Boletín Oficial del Estado"
journal_issue: "256"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2024/10/22/1085"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2024-21701"
url_pdf: "https://www.boe.es/boe/dias/2024/10/23/pdfs/BOE-A-2024-21701.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2024-21701"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2024/10/23/pdfs/BOE-A-2024-21701-C.pdf"
page_start: "135409"
page_end: "135460"
image_marker: "A"
legislative_status: "L"
alerts: "Consumidores y usuarios; Derecho Administrativo; Medio ambiente; Organización de la Administración; Tecnología e investigación"
references_previous: "DEROGA BOE-A-2007-21092; MODIFICA BOE-A-1988-20883; MODIFICA BOE-A-1986-10638; DE CONFORMIDAD con BOE-A-2001-14276; CITA BOE-A-2023-11187"
---
...
| Mixto. | 1,5 |
| * Acumulación localizada y limitada de agua subterránea en materiales de relleno antrópico sin afección significativa al sustrato geológico infrayacente o circundante. | * Acumulación localizada y limitada de agua subterránea en materiales de relleno antrópico sin afección significativa al sustrato geológico infrayacente o circundante. |
...
| Receptores afectados/amenazados | RC |
| --- | --- |
...
| Migración exterior* | EXT |
| --- | --- |
| Si. | 1,5 |
| Desconocido. | 1,5 |
| No. | 1 |
| * Se verificará, si es posible, la potencial afección exterior al emplazamiento, mediante inspección y/o muestreo de los puntos de agua accesibles.» | * Se verificará, si es posible, la potencial afección exterior al emplazamiento, mediante inspección y/o muestreo de los puntos de agua accesibles.» |
...
| --- | --- | --- | --- | --- |
| PAH | (…) | (…) | (…) | (…) |
| PAH | 56-55-3 | Benzo(a)antraceno | 0,3 | 0,8 |
| PAH | (…) | (…) | (…) | (…) |
| PAH | 207-08-9 | Benzo(k)fluoranteno | 0,06 | 0,5 |
| PAH | (…) | (…) | (…) | (…) |

> <sup>(1)</sup> Compuestos incluidos en el parámetro Suma PCBs.
...
### CAPÍTULO II. Producción y suministro de aguas regeneradas
...
### CAPÍTULO III. Uso de las aguas regeneradas
...
### CAPÍTULO VI. Fomento de la reutilización
...
### CAPÍTULO VII. Informes y transparencia
...
| Calidad A. C. | Riego por goteo u otro método de riego que evite el contacto directo con la parte comestible del cultivo. | – Cultivos de alimentos que se consumen crudos cuando la parte comestible se produce por encima del nivel del suelo y no está en contacto directo con las aguas regeneradas. – Cultivos de alimentos transformados. – Cultivos no alimenticios, incluidos los cultivos utilizados para alimentar a animales productores de carne o leche. – Cultivos leñosos que impida el contacto del agua regenerada con los frutos consumidos en la alimentación humana. – Cultivos de flores ornamentales, viveros, invernaderos sin contacto directo del agua regenerada con las producciones. |
...
| Clase | *E. coli* (UFC/100 mL) | Turbidez (UNT) | SS (mg/L) | DBO<sub>5</sub> (mg/L) | Nematodos intestinales (huevo/L) | *Legionella spp.* (UFC/L) | *T. saginata y T. solium* (huevo/L) | Contaminantes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- |
| Calidad Ia. A+. Aguas de limpieza de materias primas y de superficies, materiales y objetos destinados al contacto con los alimentos. | La calidad Ia. A+ en la empresa alimentaria deberá cumplir con lo establecido en el artículo 65 del Real Decreto 3/2023. | La calidad Ia. A+ en la empresa alimentaria deberá cumplir con lo establecido en el artículo 65 del Real Decreto 3/2023. | La calidad Ia. A+ en la empresa alimentaria deberá cumplir con lo establecido en el artículo 65 del Real Decreto 3/2023. | La calidad Ia. A+ en la empresa alimentaria deberá cumplir con lo establecido en el artículo 65 del Real Decreto 3/2023. | La calidad Ia. A+ en la empresa alimentaria deberá cumplir con lo establecido en el artículo 65 del Real Decreto 3/2023. |
...
| Calidad por definir. – Aporte de recursos hídricos a humedales y otros ecosistemas acuáticos. | Se estudiará caso por caso | Se estudiará caso por caso | Se estudiará caso por caso | Se estudiará caso por caso | Se estudiará caso por caso | Se estudiará caso por caso |
...
La validación de la estación regeneradora de aguas (ERA) tiene por objeto evaluar la eficacia del tratamiento de la ERA. La valoración se realiza cuantitativamente a través la determinación de la reducción logarítmica (log<sub>10</sub>) de los indicadores de patógenos de 3 grupos representativos: bacterias, virus y protozoos.

Los objetivos de rendimiento, expresados como reducción logarítmica (log<sub>10</sub>), se recogen en la tabla II-1.
...
| Grupos de patógenos | 1 | Objetivos de rendimiento de la cadena de tratamiento (reducción de log<sub>10</sub>) |
| --- | --- | --- |
| Bacterias. | E. coli. | ≥ 5,0 |
| Virus. | *Colífagos totales*<sup>2</sup>. *Colífagos F-específicos.* *Colífagos somáticos.* | ≥ 6,0 |
| Protozoos. | Clostridium perfringens 3 | ≥ 4,0 |
| Protozoos. | Bacterias formadoras de esporas reductoras de sulfato. | ≥ 5,0 |
| <sup>1</sup>Los patógenos de referencia *Campylobacter*, rotavirus y *Cryptosporidium* también podrán emplearse para el control de validación, en lugar de los microorganismos indicadores propuestos. En ese caso, se aplicarán los siguientes objetivos de rendimiento (reducción de log<sub>10</sub>): *Campylobacter* (≥ 5,0), rotavirus (≥ 6,0) y *Cryptosporidium* (≥ 5,0). <sup>2</sup>Se ha seleccionado *colífagos totales* como el indicador viral más adecuado. No obstante, si no es posible el análisis de los *colífagos totales*, se analizará al menos uno de ellos (*colífagos F-específicos*o*somáticos*). <sup>3</sup>Se han seleccionado las esporas de *Clostridium perfringens* como el indicador de protozoos más adecuado. No obstante, las bacterias formadoras de esporas reductoras de sulfato son una alternativa si la concentración de esporas de *Clostridium perfringens* no permite validar la reducción de log<sub>10</sub>solicitada. | <sup>1</sup>Los patógenos de referencia *Campylobacter*, rotavirus y *Cryptosporidium* también podrán emplearse para el control de validación, en lugar de los microorganismos indicadores propuestos. En ese caso, se aplicarán los siguientes objetivos de rendimiento (reducción de log<sub>10</sub>): *Campylobacter* (≥ 5,0), rotavirus (≥ 6,0) y *Cryptosporidium* (≥ 5,0). <sup>2</sup>Se ha seleccionado *colífagos totales* como el indicador viral más adecuado. No obstante, si no es posible el análisis de los *colífagos totales*, se analizará al menos uno de ellos (*colífagos F-específicos*o*somáticos*). <sup>3</sup>Se han seleccionado las esporas de *Clostridium perfringens* como el indicador de protozoos más adecuado. No obstante, las bacterias formadoras de esporas reductoras de sulfato son una alternativa si la concentración de esporas de *Clostridium perfringens* no permite validar la reducción de log<sub>10</sub>solicitada. | <sup>1</sup>Los patógenos de referencia *Campylobacter*, rotavirus y *Cryptosporidium* también podrán emplearse para el control de validación, en lugar de los microorganismos indicadores propuestos. En ese caso, se aplicarán los siguientes objetivos de rendimiento (reducción de log<sub>10</sub>): *Campylobacter* (≥ 5,0), rotavirus (≥ 6,0) y *Cryptosporidium* (≥ 5,0). <sup>2</sup>Se ha seleccionado *colífagos totales* como el indicador viral más adecuado. No obstante, si no es posible el análisis de los *colífagos totales*, se analizará al menos uno de ellos (*colífagos F-específicos*o*somáticos*). <sup>3</sup>Se han seleccionado las esporas de *Clostridium perfringens* como el indicador de protozoos más adecuado. No obstante, las bacterias formadoras de esporas reductoras de sulfato son una alternativa si la concentración de esporas de *Clostridium perfringens* no permite validar la reducción de log<sub>10</sub>solicitada. |
...
(ii) Si en las aguas residuales no se registra un indicador biológico en cantidad suficiente para conseguir la reducción de log<sub>10</sub>, la ausencia de dicho indicador biológico en las aguas regeneradas implicará que se cumplen los requisitos de validación.
...
| Destino ambiental. | A+, A, B, C, D | Continuo. | Continuo. | Conforme al Real Decreto 487/2022, de 21 de junio. |
...
| Uso/destino | Calidad | E. coli | SS | Nematodos intestinales | Bacteriófagos | 5 |
| --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- |
| Bacteriófagos | colífagos somáticos. |
...
| 5 | UNE 77003:1989. Calidad del agua. determinación de la demanda bioquímica de oxígeno (DBO). Método de dilución y siembra. |
...
| 5. | 100 % del VMA. |
| * Desviación máxima: diferencia entre el valor medido y el VMA. | * Desviación máxima: diferencia entre el valor medido y el VMA. |
...
| Riego por goteo. | Riego por goteo de cultivos altos como los que crecen a 50 cm o más por encima del nivel del suelo. | 4 | 2 |
| Riego por goteo. | Riego por goteo subsuperficial en el que el agua no asciende por acción capilar a la superficie del suelo. | 6 | 3 |
...
| Riego por aspersión y microaspersión. | Riego por aspersores y microaspersores en árboles frutales como a 50 cm o más del chorro de agua. | 4 | 2 |
...
| Desinfección adicional sobre el terreno. | Desinfección de nivel alto (≥ 1 mg/L de cloro total, después de 30 minutos de cloración). | 4 | 2 |
...
| Control de acceso. | Restricción de la entrada en el campo de regadío cinco días o más después del riego. | Entre 2 y 4 | 2 |
...
| Clase de calidad requerida | Sin acceso restringido | Con acceso restringido |
| --- | --- | --- |
| Clase de calidad requerida | Riego de zonas verdes urbanas, jardines privados, campos del golf y otros campos deportivos | Riego de zonas verdes urbanas, jardines privados, campos del golf y otros campos deportivos |
| A+ | 0 | 0 |
| A | 1 | 0 |
| B | 1 | 0 |
| C | prohibido | 1 |
