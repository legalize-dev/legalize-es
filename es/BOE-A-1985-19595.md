---
title: "Orden de 13 de septiembre de 1985 por la que se aprueban determinadas Instrucciones Técnicas Complementarias de los capítulos III y IV del Reglamento General de Normas Básicas de Seguridad Minera"
identifier: "BOE-A-1985-19595"
country: "es"
rank: "orden"
publication_date: "1985-09-18"
last_updated: "1985-09-18"
status: "in_force"
source: "https://www.boe.es/eli/es/o/1985/09/13/(2)"
department: "Ministerio de Industria y Energía"
pdf_url: "https://www.boe.es/boe/dias/1985/09/18/pdfs/A29397-29409.pdf"
subjects: ["Abastecimiento de aguas", "Aguas", "Carbón", "Energía eléctrica", "Explosivos", "Minas", "Salinas", "Salvamento", "Seguridad e higiene en el trabajo"]
department_code: "5260"
rank_code: "1350"
ambito_code: "1"
enactment_date: "1985-09-13"
official_journal: "Boletín Oficial del Estado"
journal_issue: "224"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/1985/09/13/(2)"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-1985-19595"
url_pdf: "https://www.boe.es/boe/dias/1985/09/18/pdfs/A29397-29409.pdf"
page_start: "29397"
page_end: "29409"
image_marker: "A"
legislative_status: "L"
references_previous: "DE CONFORMIDAD con BOE-A-1985-10836"
references_subsequent: "SE DEROGA BOE-A-2021-11458; SE DEROGA BOE-A-2018-14894; SE MODIFICA BOE-A-1998-3416; SE MODIFICA BOE-A-1996-5281; SE MODIFICA BOE-A-1987-10977; CORRECCIÓN de errores BOE-A-1985-24366"
...
La presente Instrucción tiene por objeto establecer los requisitos mínimos que por motivos de seguridad han de cumplir los cables utilizados para transporte en pozos y planos inclinados.
...
| Tipo de instalación de extracción | C | C |
| --- | --- | --- |
| Tipo de instalación de extracción | Cable nuevo | Cable en servicio |
...
Antes de la instalación de un nuevo cable, la Dirección de la mina remitirá a la autoridad minera el certificado de la carga de rotura del fabricante y el certificado de los ensayos de resistencia (métodos I y II según ISO 3.154) realizados en un laboratorio oficial acreditado, y reconocido por la Dirección General de Minas, para lo cual enviará un testigo de 4 metros de longitud del citado cable y de cuyo resultado se dará cuenta a la autoridad minera, la cual autorizará o denegará su instalación a la vista de los resultados.

Si transcurriese más de un año entre la fecha del ensayo y la de su colocación, habrá de repetirse aquél.

###### 3. Revisiones.

En todo cable utilizado para transporte de personal se procederá una vez durante el primer año y una vez cada seis meses los años siguientes, al corte de su parte inferior en una longitud de, al menos, 2 metros. Este trozo se someterá a los ensayos establecidos en el apartado anterior (método II, según ISO 3.154), destrenzándose, además, un trozo del testigo cortado para una cuidadosa observación del interior del cable.

El resultado de los ensayos se remitirá a la autoridad minera. Están exceptuados de esta obligación los cables en poleas Koepe.
...
En la cabeza de las cintas transportadoras y en un tramo de 10 metros antes y 10 metros después, el revestimiento de las galerías será no combustible.

En la proximidad de las instalaciones de cintas transportadoras se dispondrán equipos de detección capaces de producir una alarma en el caso de que el calentamiento de la banda produzca CO. En función del riesgo e importancia de la instalación, la autoridad minera competente aprobará la ubicación de los captadores, la posibilidad de vigilar varias bandas desde un mismo captador, la necesidad de automatización y los emplazamientos en los que se debe dar la alarma.

Los captadores utilizados serán de un tipo aprobado por la Dirección General de Minas.
...
### VENTILACION Y DESAGÜE. Circulación de la corriente de aire
...
5.000 p.p.m. de dióxido de carbono (CO<sub>2</sub>).

10 p.p.m. de óxidos de nitrógeno (NO + NO<sub>2</sub>).

10 p.p.m. de sulfuro de hidrógeno (SH<sub>2</sub>).

5 p.p.m. de dióxido de azufre (SO<sub>2</sub>).

1.000 p.p.m. de hidrógeno (H<sub>2</sub>).
...
12.500 p.p.m. de dióxido de carbono (CO<sub>2</sub>).

25 p.p.m. de óxidos de nitrógeno (NO + NO<sub>2</sub>).

50 p.p.m. de sulfuro de hidrógeno(SH<sub>2</sub>).

10 p.p.m. de dióxido de azufre (SO<sub>2</sub>).

10.000 p.p.m. de hidrógeno (H<sub>2</sub>).
...
### t<sub>e</sub> = 0,9 t<sub>h</sub> + 0,1 t<sub>s</sub>

donde:

t<sub>e</sub> = temperatura equivalente en °C.

t<sub>h</sub> = temperatura húmeda en °C.

t<sub>s</sub> = temperatura seca en °C.
...
La determinación de la peligrosidad de una labor se establece tal como se señala en el Reglamento General de Normas Básicas de Seguridad Minera, en función del peso del polvo respirable en mg/m<sup>3</sup> y del porcentaje de sílice libre, según los criterios admitidos internacionalmente.

Teniendo en cuenta los parámetros anteriores las labores se clasificarán de acuerdo con el cuadro siguiente:

| Labores | Grupo | Grupo | Grupo |
| --- | --- | --- | --- |
| Labores | A – 10 % SiO<sub>2</sub> | B – 10-30 % SiO<sub>2</sub> | C – 30 % SiO<sub>2</sub> |
| Clase I | < 6 mg/m<sup>3</sup> | < 3 mg/m<sup>3</sup> | < 2 mg/m<sup>3</sup> |
| Clase II | 6-10 mg/m<sup>3</sup> | 3-6 mg/m<sup>3</sup> | 2-3 mg/m<sup>3</sup> |
| Clase III | > 10 mg/m<sup>3</sup> | > 6 mg/m<sup>3</sup> | > 3 mg/m<sup>3</sup> |

2.2 Tipo de aparato.

El tipo de aparato que ha servido de base para el establecimiento de los mg/m<sup>3</sup> en cada clase de labor ha sido un aspirador de polvo de 2,5 l/min con separador de partículas mediante placas horizontales, que efectúan la selección de polvo respirable de acuerdo con el criterio establecido en la Conferencia Internacional de Johannesburgo, recogiendo el polvo respirable mediante filtración sobre membrana.
...
Muestra de SiO<sub>2</sub>.–Se tomará cuatrimestralmente en todas las labores, salvo que se sospechen cambios sustanciales en las condiciones de la labor, que puedan influir en su contenido en SiO<sub>2</sub> y, por tanto, en su clasificación.
...
> <small>Redactado conforme a la corrección de errores publicada en BOE núm. 281, de 23 de noviembre de 1985. [Ref. BOE-A-1985-24366](https://www.boe.es/buscar/doc.php?id=BOE-A-1985-24366)</small>
