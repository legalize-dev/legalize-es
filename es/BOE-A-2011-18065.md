...
### Mi = M × (V<sub>i</sub> × E<sub>i</sub>) / ∑<sub>i</sub> (V<sub>i</sub> × E<sub>i</sub>)

Donde:

– M: mermas totales retenidas en el sistema de transporte (kWh).

– M<sub>i</sub>: mermas retenidas asignadas al transportista i (kWh).

– V<sub>i</sub>: volumen geométrico total de las redes del transportista i (m<sup>3</sup>).

– E<sub>i</sub>: entradas totales de gas en las redes del transportista i durante el año anterior (kWh).
...
El valor D<sub>m</sub> a aplicar será equivalente al cociente entre la retribución al transporte y la suma de la retribución al transporte y a la distribución. Para el año 2011, el término D<sub>m</sub> es el 33,21%.
...
### C = (1–D<sub>m</sub>) × (Peaje medio/Término de conducción medio)
