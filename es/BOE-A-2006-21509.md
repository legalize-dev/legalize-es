...
pdf_url: "https://www.boe.es/boe/dias/2006/12/09/pdfs/A43289-43296.pdf"
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2006/11/22/itc3750"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2006-21509"
url_pdf: "https://www.boe.es/boe/dias/2006/12/09/pdfs/A43289-43296.pdf"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2006/12/16/pdfs/A03503-03507.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2006/12/16/pdfs/A02539-02546.pdf"
page_start: "43289"
page_end: "43296"
image_marker: "A"
legislative_status: "L"
alerts: "Industria; Tecnología e investigación; Transportes y tráfico"
references_previous: "DE CONFORMIDAD con BOE-A-2006-14017"
references_subsequent: "SE DEROGA BOE-A-2020-2573; SE MODIFICA BOE-A-2009-14962"
...
Norma derogada, con efectos de 24 de octubre de 2020, por la disposición derogatoria única.h) de la Orden ICT/155/2020, de 7 de febrero. [Ref. BOE-A-2020-2573#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2020-2573).
...
Esta orden se dicta al amparo de lo dispuesto en el artículo 149.1.12.<sup>a</sup> de la Constitución, que atribuye al Estado, como competencia exclusiva, la legislación de pesas y medidas.
...
Las vasijas patrón tendrán las siguientes características metrológicas comunes: estarán graduadas con trazo múltiple; su capacidad nominal será del tipo 1x10<sup>n</sup> L, 2x10<sup>n</sup> L o 5x10<sup>n</sup> L, siendo «n» cero o un número entero y positivo; serán calibradas, al menos cada tres años con trazabilidad a patrones nacionales o internacionales y precinta-das por un organismo autorizado; su error máximo permitido relativo será igual o inferior a 1x10<sup>-3</sup> en su capacidad nominal y en los puntos de escala de ± 0,5 % y de ± 1 %. El Certificado de calibración de las vasijas deberá reflejar la temperatura de referencia y el coeficiente de dilatación cúbica de las mismas que permita calcular su volumen corregido en función de la temperatura.
...
![](https://www.boe.es/datos/imagenes/disp/2006/294/21509_001.png)
...
Vasijas patrón de capacidad nominal 1 x 10<sup>n</sup> L, 2 x 10<sup>n</sup> L ó 5 x 10<sup>n</sup> L, siendo «n» cero o un número entero y positivo, capaz de contener, como mínimo, el volumen vertido por el sistema de medida ensayado en un minuto de funcionamiento a caudal de ensayo y calibradas, al menos, cada tres años para el método de utilización, con trazabilidad a patrones nacionales o internacionales y precintadas por un organismo autorizado, con un error máximo permitido igual o inferior a 5 x 10<sup>–4</sup> en su capacidad nominal y en los puntos de escala de ± 0,5 % y de ±1 %. (El certificado de calibración de dichas vasijas deberá reflejar la temperatura de referencia y el coeficiente de dilatación cúbica de las mismas que permita calcular su volumen corregido en función de la temperatura).
...
2.3.3.1 Ajustar el caudal para que su valor sea lo más cercano posible, sin ser nunca inferior, al valor de Q<sub>min</sub> señalado en la placa de características.
...
2.3.3.4 Leer V<sub>ind</sub>: Volumen indicado por el sistema de medida.
...
### V<sub>pc</sub> = V<sub>p</sub> ∙ [1 + β ∙ (T – T<sub>r</sub>)]

donde:

V<sub>pc</sub>: Volumen de la vasija patrón, corregido debido a la desviación de la temperatura de referencia.

β: Coeficiente de dilatación cúbica del patrón debido a la temperatura (°C<sup>-1</sup>)

T<sub>r</sub>: Temperatura de referencia de la vasija patrón.

2.3.3.6 Calcular

![](https://www.boe.es/datos/imagenes/disp/2006/294/21509_002.png)

2.3.3.7 Repetir los pasos 2.3.3.2 a 2.3.3.6 otras dos veces, calculando un total de tres errores relativos: e<sub>rt</sub> e<sub>r2</sub>e<sub>re</sub>.
...
2.3.4.1 Ajustar el caudal para que su valor sea lo más cercano posible, sin ser nunca superior, al valor de Q<sub>máx</sub> señalado en la placa de características.
...
V<sub>pc</sub>: Volumen indicado por el sistema de medida.

V<sub>p</sub>: Volumen indicado por el patrón.
...
2.3.4.7 Repetir los pasos 2.3.4.2 a 2.3.4.6 otras dos veces, calculando un total de tres errores relativos: e<sub>r1</sub> e<sub>r2</sub>, e<sub>r3</sub>.
...
Si las mangueras están enrolladas, el incremento de volumen interno, resultante del cambio de posición de la manguera enrollada no sometida a la presión a posición de manguera desenrollada sometida a la presión de la bomba sin paso de líquido, no deberá superar el doble del error máximo tolerado para el suministro mínimo (V<sub>ind</sub>≤ 0,02 x S<sub>min</sub>; donde S<sub>min</sub> es el suministro mínimo).

Si el sistema carece de enrollador, el aumento del volumen interno no deberá superar el error máximo tolerado para el suministro mínimo (V<sub>ind</sub>≤ 0,01 x S<sub>min</sub>).
...
1. Ajustar el caudal para que su valor sea lo más cercano posible, sin ser nunca inferior, al valor de Q<sub>mín</sub> señalado en la placa de características.
...
### *V<sub>pc</sub>= K.V<sub>p</sub>*

V<sub>pc</sub>: Volumen medido por el contador patrón, corregido debido a la desviación del caudal y la temperatura del producto.

K: Factor de corrección del contador patrón en función del caudal y el tipo de producto.

6. Calcular.

| e<sub>r</sub>= | V<sub>ind</sub> – V<sub>pc</sub> | . 100 |
| --- | --- | --- |
| e<sub>r</sub>= | V<sub>pc</sub> | . 100 |

7. Repetir los pasos 2 a 6 otras dos veces, calculando un total de tres errores relativos: e<sub>r1</sub>, e<sub>r2</sub>, e<sub>r3</sub>.
...
1. Ajustar el caudal para que su valor sea lo más cercano posible, sin ser nunca superior, al valor de Q<sub>máx</sub> señalado en la placa de características.
...
Si las mangueras están enrolladas, el incremento de volumen interno, resultante del cambio de posición de la manguera enrollada no sometida a la presión a posición de manguera desenrollada sometida a la presión de la bomba sin paso de líquido, no deberá superar el doble del error máximo tolerado para el suministro mínimo (V<sub>ind</sub>≤ 0,02 x S<sub>mín</sub>; donde S<sub>mín</sub> es el suministro mínimo).

Si el sistema carece de enrollador, el aumento del volumen interno no deberá superar el error máximo tolerado para el suministro mínimo (V<sub>ind</sub> ≤ 0,01 x S<sub>mín</sub>).
...
> <small>Se modifica por el art. único de la Resolución de 15 de julio de 2009. [Ref. BOE-A-2009-14962](https://www.boe.es/buscar/doc.php?id=BOE-A-2009-14962).</small>
