...
### RF<sub>PV</sub> = RR<sub>PV</sub> + a* RR<sub>AD</sub> + (a – b)* H

Siendo:

| H = | RR<sub>PV</sub> | si | RR<sub>PV</sub> | ≤ | b |
| --- | --- | --- | --- | --- | --- |
| H = | b | si | RR<sub>TC</sub> | ≤ | 1 – b |

| H = | RR<sub>TC</sub> | si | RR<sub>PV</sub> | ≥ | b |
| --- | --- | --- | --- | --- | --- |
| H = | 1 – b | si | RR<sub>TC</sub> | ≥ | 1 – b |

RF<sub>PV</sub> = Recaudación final anual para el País Vasco.

RR<sub>PV</sub> = Recaudación real anual del País Vasco.

RR<sub>TC</sub> = Recaudación real anual del territorio común.

RR<sub>AD</sub> = Recaudación real anual por importaciones.

| a = | Consumo Residentes País Vasco |
| --- | --- |
| a = | Consumo Residentes Estado |
