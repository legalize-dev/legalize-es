...
> Téngase en cuenta que esta última actualización del párrafo segundo del apartado 3 establecida por la norma 3.1.b) de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
| **E DATOS SOBRE TIPOS DE INTERÉS** | **E DATOS SOBRE TIPOS DE INTERÉS** |
| --- | --- |
...
| **PARTE 1 DATOS PARA LOS PRÉSTAMOS** | **PARTE 1 DATOS PARA LOS PRÉSTAMOS** |
...
| **PARTE 2 DATOS ADICIONALES PARA LOS PRÉSTAMOS CON TIPO DE INTERÉS VARIABLE** | **PARTE 2 DATOS ADICIONALES PARA LOS PRÉSTAMOS CON TIPO DE INTERÉS VARIABLE** |
...
| **H.1 DATOS BÁSICOS SOBRE CALIFICACIÓN CREDITICIA DE LOS RIESGOS** | **H.1 DATOS BÁSICOS SOBRE CALIFICACIÓN CREDITICIA DE LOS RIESGOS** |
| --- | --- |
...
| **H.2 DATOS BÁSICOS COMPLEMENTARIOS DE LOS PRÉSTAMOS** | **H.2 DATOS BÁSICOS COMPLEMENTARIOS DE LOS PRÉSTAMOS** |
| --- | --- |
...
| **H.3 DATOS DINÁMICOS COMPLEMENTARIOS DE LOS PRÉSTAMOS** | **H.3 DATOS DINÁMICOS COMPLEMENTARIOS DE LOS PRÉSTAMOS** |
| --- | --- |
| **Código de la operación** | Código con el que se identifican los préstamos en el módulo B.2, Datos básicos de las operaciones, o, en su caso, en el módulo G.1, Datos básicos que vinculan códigos, cuando el modulo B.2 lo haya declarado otra entidad. |
...
| **H.4 DATOS DINÁMICOS COMPLEMENTARIOS DE LAS GARANTÍAS FINANCIERAS Y OTROS COMPROMISOS** | **H.4 DATOS DINÁMICOS COMPLEMENTARIOS DE LAS GARANTÍAS FINANCIERAS Y OTROS COMPROMISOS** |
| --- | --- |
...
| **H.5 DATOS DINÁMICOS DE RIESGOS IMPUTADOS A CONTRAPARTES FINALES DISTINTAS DE LAS DIRECTAS** | **H.5 DATOS DINÁMICOS DE RIESGOS IMPUTADOS A CONTRAPARTES FINALES DISTINTAS DE LAS DIRECTAS** |
| --- | --- |
...
| **H.6 DATOS DINÁMICOS RELATIVOS A REQUERIMIENTOS DE RECURSOS PROPIOS** | **H.6 DATOS DINÁMICOS RELATIVOS A REQUERIMIENTOS DE RECURSOS PROPIOS** |
| --- | --- |
| **Código de la operación** | Código con el que se identifica la operación en el módulo B.2, Datos básicos de las operaciones. |
...
| **PARTE 1 DATOS PARA TODAS LAS OPERACIONES** | **PARTE 1 DATOS PARA TODAS LAS OPERACIONES** |
...
| **PARTE 2 DATOS ADICIONALES PARA OPERACIONES A LAS QUE SE APLICA EL MÉTODO ESTÁNDAR (SA)** | **PARTE 2 DATOS ADICIONALES PARA OPERACIONES A LAS QUE SE APLICA EL MÉTODO ESTÁNDAR (SA)** |
...
| **PARTE 3 DATOS ADICIONALES PARA OPERACIONES A LAS QUE SE APLICA EL MÉTODO IRB** | **PARTE 3 DATOS ADICIONALES PARA OPERACIONES A LAS QUE SE APLICA EL MÉTODO IRB** |
...
# **I.1 DATOS DINÁMICOS DE LOS RIESGOS INFERIORES A 6.000 EUROS**
                    ...
                    Para los préstamos, misma definición que en el campo de igual nombre del módulo H.3, Datos dinámicos complementarios de los préstamos.
                      ...
                      **valor razonable debidos al riesgo de crédito. Importe negativo**
