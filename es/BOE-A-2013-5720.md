...
> Téngase en cuenta que esta última actualización del apartado 1.a).iv) establecida por la norma 3.1.a) de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que la modificación de la letra d) del apartado 3 entra en vigor el 1 de octubre de 2016, según establece la disposición final única de la Circular 4/2016, de 27 de abril. [Ref. BOE-A-2016-4356](https://www.boe.es/buscar/doc.php?id=BOE-A-2016-4356).
...
> Téngase en cuenta que el apartado 6 añadido por la norma 3.1.c) de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que esta última actualización del párrafo primero del apartado 2 establecida por la norma 3.2.a) de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que esta última actualización de la letra d) del apartado 4 establecida por la norma 3.2.b) de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que esta última actualización del apartado 6 establecida por la norma 3.3 de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que esta última actualización del apartado 4 establecida por la norma 3.4 de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que esta última actualización de la letra e) del apartado 2 establecida por la norma 3.5 de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entra en vigor el 1 de abril de 2015, según establece la disposición final única.c) de la citada Circular.
...
> Téngase en cuenta que las modificaciones de los anejos 1, 2 y 3 introducidas por la norma 3 de la Circular 5/2014, de 28 de noviembre. [Ref. BOE-A-2014-13365](https://www.boe.es/buscar/doc.php?id=BOE-A-2014-13365). entran en vigor el 1 de abril de 2015, salvo las letras a) y e) del apartado 9 de la citada circular, que entran en vigor el 31 de diciembre de 2014, según establece su disposición final única.c).
...
| **A.1 DATOS QUE IDENTIFICAN A LAS PERSONAS** | **A.1 DATOS QUE IDENTIFICAN A LAS PERSONAS** |
| --- | --- |
| **PARTE 1 DATOS DE LA PERSONA** | **PARTE 1 DATOS DE LA PERSONA** |
...
| **DATOS ADICIONALES PARA LAS PERSONAS FÍSICAS** | **DATOS ADICIONALES PARA LAS PERSONAS FÍSICAS** |
...
| **DATOS ADICIONALES PARA LAS EMPRESAS** | **DATOS ADICIONALES PARA LAS EMPRESAS** |
...
| **DATOS ADICIONALES PARA LAS SUCURSALES** | **DATOS ADICIONALES PARA LAS SUCURSALES** |
...
| **DATOS ADICIONALES PARA LOS TITULARES QUE SEAN SOCIEDADES NO FINANCIERAS** | **DATOS ADICIONALES PARA LOS TITULARES QUE SEAN SOCIEDADES NO FINANCIERAS** |
...
| **DATOS ADICIONALES PARA LAS PERSONAS CON VARIOS CÓDIGOS** | **DATOS ADICIONALES PARA LAS PERSONAS CON VARIOS CÓDIGOS** |
...
| **PARTE 2 DATOS DE LOS TITULARES COLECTIVOS** | **PARTE 2 DATOS DE LOS TITULARES COLECTIVOS** |
...
| **PARTE 3 DATOS QUE RELACIONAN A LOS TITULARES CON LAS ENTIDADES QUE INTEGRAN EL SECTOR PÚBLICO ESPAÑOL** | **PARTE 3 DATOS QUE RELACIONAN A LOS TITULARES CON LAS ENTIDADES QUE INTEGRAN EL SECTOR PÚBLICO ESPAÑOL** |
...
| **PARTE 4 DATOS QUE VINCULAN A LOS TITULARES CON LOS GRUPOS DE CLIENTES RELACIONADOS** | **PARTE 4 DATOS QUE VINCULAN A LOS TITULARES CON LOS GRUPOS DE CLIENTES RELACIONADOS** |
...
| **A.2 SOLICITUD DE CÓDIGO DE IDENTIFICACIÓN DE PERSONAS NO RESIDENTES EN ESPAÑA** | **A.2 SOLICITUD DE CÓDIGO DE IDENTIFICACIÓN DE PERSONAS NO RESIDENTES EN ESPAÑA** |
| --- | --- |
...
| **DATOS ADICIONALES PARA LAS PERSONAS JURÍDICAS** | **DATOS ADICIONALES PARA LAS PERSONAS JURÍDICAS** |
...
| **B.1 DATOS BÁSICOS QUE RELACIONAN A LAS PERSONAS CON LAS OPERACIONES** | **B.1 DATOS BÁSICOS QUE RELACIONAN A LAS PERSONAS CON LAS OPERACIONES** |
| --- | --- |
...
| **B.2 DATOS BÁSICOS DE LAS OPERACIONES** | **B.2 DATOS BÁSICOS DE LAS OPERACIONES** |
| --- | --- |
...
| **PARTE 2 DATOS ADICIONALES QUE DEBEN DECLARAR LAS ENTIDADES DE CRÉDITO** | **PARTE 2 DATOS ADICIONALES QUE DEBEN DECLARAR LAS ENTIDADES DE CRÉDITO** |
...
| **C.1 DATOS DINÁMICOS DE LOS RIESGOS DIRECTOS** | **C.1 DATOS DINÁMICOS DE LOS RIESGOS DIRECTOS** |
| --- | --- |
| **Código de la operación** | Código con el que se identifica la operación en el módulo B.2, Datos básicos de las operaciones. |
| **PARTE 1 DATOS DE TODOS LOS RIESGOS DIRECTOS** | **PARTE 1 DATOS DE TODOS LOS RIESGOS DIRECTOS** |
...
| **PARTE 2 DATOS DE LOS RIESGOS DIRECTOS ASUMIDOS POR LA ENTIDAD DECLARANTE** | **PARTE 2 DATOS DE LOS RIESGOS DIRECTOS ASUMIDOS POR LA ENTIDAD DECLARANTE** |
...
| **PARTE 3 DATOS QUE DEBEN DECLARAR LAS ENTIDADES DE CRÉDITO PARA LOS PRÉSTAMOS** | **PARTE 3 DATOS QUE DEBEN DECLARAR LAS ENTIDADES DE CRÉDITO PARA LOS PRÉSTAMOS** |
...
| **PARTE 4 DATOS DE LOS RIESGOS DIRECTOS ASUMIDOS POR LOS CESIONARIOS** | **PARTE 4 DATOS DE LOS RIESGOS DIRECTOS ASUMIDOS POR LOS CESIONARIOS** |
...
| **C.2 DATOS DINÁMICOS DE LOS RIESGOS INDIRECTOS** | **C.2 DATOS DINÁMICOS DE LOS RIESGOS INDIRECTOS** |
| --- | --- |
...
| **PARTE 1 DATOS DE LOS RIESGOS INDIRECTOS ASUMIDOS POR LA ENTIDAD DECLARANTE** | **PARTE 1 DATOS DE LOS RIESGOS INDIRECTOS ASUMIDOS POR LA ENTIDAD DECLARANTE** |
...
| **PARTE 2 DATOS DE LOS RIESGOS INDIRECTOS ASUMIDOS POR LOS CESIONARIOS** | **PARTE 2 DATOS DE LOS RIESGOS INDIRECTOS ASUMIDOS POR LOS CESIONARIOS** |
...
| **D.1 DATOS BÁSICOS QUE RELACIONAN LAS OPERACIONES CON LOS ACTIVOS RECIBIDOS EN GARANTÍA** | **D.1 DATOS BÁSICOS QUE RELACIONAN LAS OPERACIONES CON LOS ACTIVOS RECIBIDOS EN GARANTÍA** |
| --- | --- |
...
| **PARTE 1 DATOS PARA LOS INMUEBLES** | **PARTE 1 DATOS PARA LOS INMUEBLES** |
...
| **PARTE 2 DATOS ADICIONALES PARA LOS EDIFICIOS Y ELEMENTOS DE EDIFICIOS** | **PARTE 2 DATOS ADICIONALES PARA LOS EDIFICIOS Y ELEMENTOS DE EDIFICIOS** |
...
| **PARTE 3 DATOS ADICIONALES PARA EL SUELO URBANO Y URBANIZABLE** | **PARTE 3 DATOS ADICIONALES PARA EL SUELO URBANO Y URBANIZABLE** |
...
| **Superficie del terreno (m<sup>2</sup>)** | Número de metros cuadrados que tiene el suelo en garantía. |
| **Aprovechamiento (m<sup>2</sup>)** | Aprovechamiento sobre rasante en metros cuadrados útiles del ámbito, parcela o sector en que se ubica el terreno valorado, independientemente de la superficie de este. Se sumarán todos los usos lucrativos, independientemente de la tipología. |
...
| **D.4 DATOS DINÁMICOS QUE RELACIONAN LAS OPERACIONES CON LOS ACTIVOS RECIBIDOS EN GARANTÍA** | **D.4 DATOS DINÁMICOS QUE RELACIONAN LAS OPERACIONES CON LOS ACTIVOS RECIBIDOS EN GARANTÍA** |
| --- | --- |
...
| **D.5 DATOS DINÁMICOS DE LOS EDIFICIOS EN CONSTRUCCIÓN Y DE LAS PROMOCIONES INMOBILIARIAS RECIBIDOS EN GARANTÍA** | **D.5 DATOS DINÁMICOS DE LOS EDIFICIOS EN CONSTRUCCIÓN Y DE LAS PROMOCIONES INMOBILIARIAS RECIBIDOS EN GARANTÍA** |
| --- | --- |
...
| **F DATOS DE TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS DE ACTIVOS FINANCIEROS** | **F DATOS DE TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS DE ACTIVOS FINANCIEROS** |
| --- | --- |
| **PARTE 1 DATOS QUE IDENTIFICAN A LAS TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS** | **PARTE 1 DATOS QUE IDENTIFICAN A LAS TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS** |
...
| **PARTE 2 DATOS QUE VINCULAN LAS TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS CON LAS OPERACIONES** | **PARTE 2 DATOS QUE VINCULAN LAS TRANSFERENCIAS Y TITULIZACIONES SINTÉTICAS CON LAS OPERACIONES** |
...
| **G.1 DATOS BÁSICOS QUE VINCULAN CÓDIGOS** | **G.1 DATOS BÁSICOS QUE VINCULAN CÓDIGOS** |
| --- | --- |
...
| **G.2 DATOS BÁSICOS DE LAS OPERACIONES QUE SE HAN DE COMUNICAR A OTRAS ENTIDADES** | **G.2 DATOS BÁSICOS DE LAS OPERACIONES QUE SE HAN DE COMUNICAR A OTRAS ENTIDADES** |
| --- | --- |
...
| **G.3 DATOS DINÁMICOS DE LAS OPERACIONES QUE SE HAN DE COMUNICAR A OTRAS ENTIDADES** | **G.3 DATOS DINÁMICOS DE LAS OPERACIONES QUE SE HAN DE COMUNICAR A OTRAS ENTIDADES** |
| --- | --- |
