...
4. La retribución financiera de la inversión, expresada en euros, se calculará cada año «n» aplicando la tasa de retribución (Tr) a la inversión neta (VNI<sub>n</sub>), conforme a la siguiente fórmula:

### RF<sub>n</sub> = VNI<sub>n</sub> * Tr

donde:

VNI<sub>n</sub>: Valor neto de la inversión en el año «n», expresado en euros:
...
Aa<sub>n−1</sub>: Amortización acumulada hasta el año «(n–1)», expresada en euros, que se calcula conforme a la siguiente fórmula:

### Aa<sub>n−1</sub> = (n − 1) * VI / VU
