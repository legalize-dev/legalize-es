---
title: "Real Decreto 286/2006, de 10 de marzo, sobre la protección de la salud y la seguridad de los trabajadores contra los riesgos relacionados con la exposición al ruido"
identifier: "BOE-A-2006-4414"
country: "es"
rank: "real_decreto"
publication_date: "2006-03-11"
last_updated: "2006-03-11"
status: "in_force"
source: "https://www.boe.es/eli/es/rd/2006/03/10/286"
department: "Ministerio de la Presidencia"
pdf_url: "https://www.boe.es/boe/dias/2006/03/11/pdfs/A09842-09848.pdf"
subjects: ["Equipos de protección individual", "Ruidos", "Seguridad e higiene en el trabajo", "Trabajadores"]
department_code: "7710"
rank_code: "1340"
ambito_code: "1"
official_number: "286/2006"
enactment_date: "2006-03-10"
official_journal: "Boletín Oficial del Estado"
journal_issue: "60"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2006/03/10/286"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2006-4414"
url_pdf: "https://www.boe.es/boe/dias/2006/03/11/pdfs/A09842-09848.pdf"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2006/03/16/pdfs/A00818-00824.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2006/04/01/pdfs/A00639-00644.pdf"
page_start: "9842"
page_end: "9848"
image_marker: "A"
legislative_status: "L"
alerts: "Trabajo y empleo"
references_previous: "DEROGA BOE-A-1989-25805; DE CONFORMIDAD con BOE-A-1995-24292"
references_subsequent: "CORRECCIÓN de errores BOE-A-2006-5286; CORRECCIÓN de erratas BOE-A-2006-4588"
...
> <small>Redactado el párrafo sexto conforme a la corrección de errores publicada en BOE núm. 71, de 24 de marzo de 2006. [Ref. BOE-A-2006-5286](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-5286)</small>
...
> <small>Redactado el apartado 2 conforme a la corrección de errores publicada en BOE núm. 71, de 24 de marzo de 2006. [Ref. BOE-A-2006-5286](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-5286)</small>
...
a) Valores límite de exposición: L<sub>Aeq,d</sub> = 87 dB(A) y L<sub>pico</sub>= 140 dB (C), respectivamente;

b) Valores superiores de exposición que dan lugar a una acción: L<sub>Aeq,d</sub> = 85 dB(A) y L<sub>pico</sub> = 137 dB (C), respectivamente;

c) Valores inferiores de exposición que dan lugar a una acción: L<sub>Aeq,d</sub> = 80 dB(A) y L<sub>pico</sub> = 135 dB (C), respectivamente.
...
1. Nivel de presión acústica, L<sub>p</sub>: El nivel, en decibelios, dado por la siguiente expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_001.png)

donde P<sub>o</sub> es la presión de referencia (2·10<sup>-5</sup> pascales) y P es el valor eficaz de la presión acústica, en pascales, a la que está expuesto un trabajador (que puede o no desplazarse de un lugar a otro del centro de trabajo).

2. Nivel de presión acústica ponderado A, L<sub>pA</sub>: Valor del nivel de presión acústica, en decibelios, determinado con el filtro de ponderación frecuencial A, dado por la siguiente expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_002.png)

donde P<sub>A</sub> es el valor eficaz de la presión acústica ponderada A, en pascales.

3. Nivel de presión acústica continuo equivalente ponderado A, L<sub>Aeq T</sub>: El nivel, en decibelios A, dado por la expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_003.png)

donde T = t<sub>2</sub> - t<sub>1</sub> es el tiempo de exposición del trabajador al ruido.

4. Nivel de exposición diario equivalente, L<sub>Aeq,d</sub>: El nivel, en decibelios A, dado por la expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_004.png)
...
![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_005.png)

donde L<sub>Aeq,Ti</sub> es el nivel de presión acústica continuo equivalente ponderado A correspondiente al tipo de ruido «i» al que el trabajador está expuesto Ti horas por día, y (L<sub>Aeq,d</sub>)<sub>i</sub> es el nivel diario equivalente que resultaría si solo existiese dicho tipo de ruido.

5. Nivel de exposición semanal equivalente, L<sub>Aeq,s</sub>: El nivel, en decibelios A, dado por la expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_006.png)

donde «m» es el número de días a la semana en que el trabajador está expuesto al ruido y L<sub>Aeq,di</sub> es el nivel de exposición diario equivalente correspondiente al día «i».

6. Nivel de pico, L<sub>pico</sub>: Es el nivel, en decibelios, dado por la expresión:

![](https://www.boe.es/datos/imagenes/disp/2006/60/04414_007.png)

donde P<sub>pico</sub> es el valor máximo de la presión acústica instantánea (en pascales) a que está expuesto el trabajador, determinado con el filtro de ponderación fiecuencial C y P<sub>o</sub> es la presión de referencia (2·10<sup>-5</sup> pascales).

7. Ruido estable: Aquel cuyo nivel de presión acústica ponderado A permanece esencialmente constante. Se considerará que se cumple tal condición cuando la diferencia entre los valores máximos y mínimo de L<sub>pA</sub>, medido utilizando las características «SLOW» de acuerdo a la norma UNE-EN 60651:1996, es inferior a 5 dB.
...
### 1. *Medición del Nivel de exposición diario equivalente (L<sub>Aeq,d</sub>)*

Sonómetros: Los sonómetros (no integradores-promediadores) podrán emplearse únicamente para la medición de Nivel de presión acústica ponderado A (L<sub>pA</sub>) del ruido estable. La lectura promedio se considerará igual al Nivel de presión acústica contínuo equivalente ponderado A (L<sub>Aeq,T</sub>) de dicho ruido. El Nivel de exposición diario equivalente (L<sub>Aeq,d</sub>) se calculará con las expresiones dadas en el punto 4 del anexo 1.
...
Sonómetros integradores-promediadores: Los sonómetros integradores-promediadores podrán emplearse para la medición del Nivel de presión acústica continuo equivalente ponderado A (L<sub>Aeq,T</sub>) de cualquier tipo de ruido. El Nivel de exposición diario equivalente (L<sub>Aeq,d</sub>) se calculará mediante las expresiones dadas en el punto 4 del anexo 1.
...
Dosímetros: Los medidores personales de exposición al ruido (dosímetros) podrán ser utilizados para la medición del Nivel de exposición diario equivalente (L<sub>Aeq,d</sub>) de cualquier tipo de ruido.
...
### 2. *Medición del Nivel de pico (L<sub>pico</sub>)*
...
> <small>Redactado el apartado 2 conforme a la corrección de erratas publicada en BOE núm. 62, de 14 de marzo de 2006. [Ref. BOE-A-2006-4588](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-4588)</small>
