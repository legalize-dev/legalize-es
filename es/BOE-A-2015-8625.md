...
Es decir, un coste es Recurrente cuando se repite cada n unidades de tiempo (Nt0siendo este valor mensual, bimestral, anual, etc.) o se repite cada n usos (Nx0 cada n cargas en un cargadero de cisternas…).
