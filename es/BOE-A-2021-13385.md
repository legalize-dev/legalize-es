---
title: "Circular 7/2021, de 28 de julio, de la Comisión Nacional de los Mercados y la Competencia, por la que se establece la metodología para el cálculo, supervisión, valoración y liquidación de mermas en el sistema gasista"
identifier: "BOE-A-2021-13385"
country: "es"
rank: "circular"
publication_date: "2021-08-05"
last_updated: "2021-08-05"
status: "in_force"
source: "https://www.boe.es/eli/es/cir/2021/07/28/7"
department: "Comisión Nacional de los Mercados y la Competencia"
pdf_url: "https://www.boe.es/boe/dias/2021/08/05/pdfs/BOE-A-2021-13385.pdf"
subjects: ["Almacenes", "Carburantes y combustibles", "Comercialización", "Comisión Nacional de los Mercados y la Competencia", "Distribución de energía", "Gas", "Gasoductos", "Reglamentaciones técnicas", "Transporte de energía"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/cir/2021/07/28/7"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2021-13385"
url_pdf: "https://www.boe.es/boe/dias/2021/08/05/pdfs/BOE-A-2021-13385.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2021-13385"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2021/08/05/pdfs/BOE-A-2021-13385-G.pdf"
page_start: "95934"
page_end: "95946"
image_marker: "A"
legislative_status: "L"
alerts: "Comercio; Energía"
references_previous: "DE CONFORMIDAD con BOE-A-2020-7509; DE CONFORMIDAD con BOE-A-2013-5940; DE CONFORMIDAD con BOE-A-1998-23284"
---
...
### Mermas reales <sub>i,m</sub> = Existencias iniciales <sub>i,m</sub> + Entradas <sub>i,m</sub> – Salidas <sub>i,m</sub> – Existencias finales<sub>i,m</sub> – Autoconsumos <sub>i,m</sub>

Debiendo estarse, en lo referido al titular «i» y el mes «m», a la definición de las existencias iniciales<sub>i,m</sub>, las entradas<sub>i,m</sub>, las salidas<sub>i,m</sub>, las existencias finales<sub>i,m</sub>, y los autoconsumos<sub>i,m</sub> prevista en la normativa de gestión técnica del sistema gasista sobre programaciones, nominaciones, repartos, balances, la gestión y uso de las conexiones internacionales y los autoconsumos.
...
### Mermas Reales <sub>i,m,PCTD/PCDD</sub> = Entradas a la red de distribución <sub>i,m,PCTD/PCDD</sub> – Salidas de la red de distribución<sub>i,m,PCTD/PCDD</sub>

Debiendo estarse, en lo referido al titular «i», el mes «m» y el punto de conexión transporte-distribución (PCTD) o punto de conexión distribución-distribución (PCDD), a la definición de entradas<sub>i,m,PCTD/PCDD</sub> y salidas<sub>i,m,PCTD/PCDD</sub> prevista en la normativa de gestión técnica del sistema gasista sobre programaciones, nominaciones, repartos, balances, la gestión y uso de las conexiones internacionales y los autoconsumos.
...
### Saldo mensual de mermas <sub>m</sub> = mermas reales <sub>m</sub> – mermas retenidas <sub>m</sub>
...
5. Los ingresos o costes de los titulares de redes de distribución que resulten de la compensación del saldo de mermas en las mismas, se corresponderán con el concepto retributivo ![](https://www.boe.es/datos/imagenes/disp/2021/186/13385_10138567_1.png) del titular de la red de distribución del artículo 5 de la Circular 4/2020, de la Comisión Nacional de los Mercados y la Competencia, por la que se establece la metodología de retribución de la distribución de gas natural. El importe de este concepto retributivo no se saldará a través del sistema de liquidaciones del sistema gasista, sino mediante cobros y pagos entre los titulares de redes de distribución y sus usuarios.
...
a) Mr<sub>i</sub> son las mermas retenidas asignadas al titular de la red de transporte «i» (kWh) en el mes «m».
...
### Mr<sub>i</sub> = MRT x [0,7 x (Entradas<sub>i</sub> / ∑ Entradas<sub>i</sub>) + 0,3 x (ERM<sub>i</sub> / ∑ ERM<sub>i</sub>)]
