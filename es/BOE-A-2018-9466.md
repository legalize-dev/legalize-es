...
| --- | --- | --- | --- |
| Emisiones totales por malla y por categoría de fuente (13). | ‒ SO<sub>2</sub>, NO<sub>X</sub>, COVNM, CO, NH<sub>3</sub>, PM<sub>10</sub>, PM<sub>2,5</sub> ‒ Metales pesados (Cd, Hg, Pb). ‒ COP (total de HAP, HCB, PCB, dioxinas/furanos). ‒ CN (carbono negro). | Cada cuatro años para el año de información menos dos (X-2) a partir de 2021 (14). | 1 de mayo (15). |
| Emisiones de las Grandes Fuentes Puntuales (GFP) por categoría de fuente (13). | ‒ SO<sub>2</sub>, NO<sub>X</sub>, COVNM, CO, NH<sub>3</sub>, PM<sub>10</sub>, PM<sub>2,5</sub> ‒ Metales pesados (Cd, Hg, Pb). ‒ COP (total de HAP, HCB, PCB, dioxinas/furanos). ‒ CN (carbono negro). | Cada cuatro años para el año de información menos dos (X-2) a partir de 2021 (14). | 1 de mayo (15). |
| Emisiones proyectadas, agregadas por NFR. | ‒ SO<sub>2</sub>, NO<sub>X</sub>, NH<sub>3</sub>, COVNM, PM<sub>2,5</sub> y CN (carbono negro). | Bienal, incluyéndose los años de proyección 2020, 2025, 2030 y, si se dispone de la información, 2040 y 2050 a partir de 2019 (14). | 15 de marzo. |
