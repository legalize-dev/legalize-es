...
## TÍTULO II. De la investigación técnica de accidentes e incidentes de aviación civil
...
4.ª Abstenerse de ejercer dichas funciones y de realizar tales actividades en caso de disminución de la capacidad física o psíquica requerida.
...
| Grupo I. | Barcelona | 6,65 | 3,14 |
| Grupo II | Grupo II | 6,31 | 3,09 |
| Grupo III | Grupo III | 5,29 | 2,83 |
| Grupo IV | Grupo IV | 3,88 | 2,22 |
| Grupo V | Grupo V | 2,56 | 1,88 |
...
| Grupo I | Barcelona | 133,00 | 69,80 |
| Grupo II | Grupo II | 94,65 | 50,00 |
| Grupo III | Grupo III | 52,90 | 30,00 |
| Grupo IV | Grupo IV | 19,40 | 15,00 |
| Grupo V | Grupo V | 10,24 | 7,00 |
...
| Grupo I | Barcelona | 5,13 | 3,49 |
| Grupo II | Grupo II | 4,60 | 3,43 |
| Grupo III | Grupo III | 4,60 | 3,14 |
| Grupo IV | Grupo IV | 4,11 | 2,47 |
| Grupo V | Grupo V | 3,63 | 2,09 |
...
|  |  | Cuantía Pasajero – Euros | Cuantía Pasajero – Euros | Cuantía de Seguridad Aeroportuaria – Euros | Cuantía PMR – Euros |
| --- | --- | --- | --- | --- | --- |
|  |  | EEE | Internacional | Cuantía de Seguridad Aeroportuaria – Euros | Cuantía PMR – Euros |
| Grupo I | Madrid Barajas | 6,95 | 10,43 | 2,08 | 0,55 |
| Grupo I | Barcelona | 6,12 | 9,18 | 2,08 | 0,55 |
| Grupo II | Grupo II | 5,70 | 8,60 | 2,08 | 0,55 |
| Grupo III | Grupo III | 4,87 | 7,30 | 2,08 | 0,55 |
| Grupo IV | Grupo IV | 3,57 | 5,36 | 2,08 | 0,55 |
| Grupo V | Grupo V | 2,34 | 3,51 | 2,08 | 0,55 |
...
F<sub>t</sub>: tiempo de estancia de la aeronave en posición de estacionamiento expresado en períodos de 15 minutos o fracción.
...
| Grupo I | Barcelona | 0,1097 |
| Grupo II | Grupo II | 0,1087 |
| Grupo III | Grupo III | 0,0604 |
...
| 1,400514 | 6,994093 | 0,808525 |
| Importe en € por día o fracción | Importe en € por día o fracción | Euros por Tm por día o fracción |
...
|  |  | p<sub>1</sub> – Euros | p<sub>2</sub> – Euros |
| --- | --- | --- | --- |
| Grupo I | Madrid/Barajas | 29,9100 | 0,00 |
| Grupo I | Barcelona | 27,1175 | 0,00 |
| Grupo II | Grupo II | 23,8483 | 0,00 |
| Grupo III | Grupo III | 22,9311 | 0,00 |
| Grupo IV | Grupo IV | 22,9311 | 0,00 |
| Grupo V | Grupo V | 22,9311 | 0,00 |
...
| --- | --- | --- | --- | --- |
| Incremento máximo = | ( | Ingresos regulados previstos por pasajero año n–1 | –1) | × 100 |
...
b) Coste de capital: Corresponde a la cantidad resultante de aplicar el coste medio ponderado del capital antes de impuestos (CMPC<sub>AI</sub>, en adelante), al valor medio de los Activos Netos durante el año n, calculado como la semisuma de los valores de los Activos netos al final de los años n-1 y n que figuren en el PAP.

Los dos componentes esenciales CMPC<sub>AI</sub> y Activos Netos se describen a continuación:

1.º CMPC<sub>AI</sub>(en %): Resultado de utilizar la siguiente fórmula:

| CMPC<sub>AI</sub>= | CMPC<sub>DI</sub> |
| --- | --- |
| CMPC<sub>AI</sub>= | (1 – T) |

donde CMPC<sub>DI</sub> es el coste medio ponderado del capital nominal después de impuestos:

| CMPC<sub>DI</sub> = | EK<sub>e</sub> + DK<sub>d</sub> (1 – T) |
| --- | --- |
| CMPC<sub>DI</sub> = | E + D |
...
K<sub>d</sub> = Coste de la Deuda antes de impuestos, calculado como los Gastos Financieros divididos entre el importe D anterior.
...
K<sub>e</sub> = Coste de los Recursos Propios, calculado de acuerdo a la siguiente fórmula:

        K<sub>e</sub> = R<sub>F</sub>+β<sub>L</sub> PM

Donde:

i) R<sub>F</sub>: Tasa Libre de Riesgo. Se tomará la media de la tasa interna de rendimiento del Bono del Estado español a 10 años de los últimos 12 meses disponibles en el momento de elaboración de la propuesta.

ii) P<sub>M</sub>: Prima de riesgo del Mercado (en %). Es la rentabilidad incremental que un inversor exige a las acciones por encima de la renta fija sin riesgo. Se tomará el valor fijo del 4,21%.

iii) β<sub>L</sub>: Beta Recursos Propios o Beta apalancada. Se calcula, a partir de la Beta de los activos y del nivel de endeudamiento, mediante la fórmula:

| β<sub>L</sub> = β<sub>u</sub> + | D (1 – T) | (β<sub>u</sub>) |
| --- | --- | --- |
| β<sub>L</sub> = β<sub>u</sub> + | E | (β<sub>u</sub>) |

Donde β<sub>u</sub>: Beta de los Activos. Refleja el riesgo del negocio, sin tener en cuenta el riesgo financiero derivado de un mayor endeudamiento. Para el negocio aeroportuario, se ha tomado para este parámetro el valor de 0,7, media de las estimaciones efectuadas para el negocio aeroportuario por un panel de consultores, banca de Inversión y Fondos de Inversión en Infraestructuras.
