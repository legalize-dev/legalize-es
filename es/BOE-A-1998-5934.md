...
| Sustancias | Umbral (toneladas) | Umbral (toneladas) |
| --- | --- | --- |
| Sustancias | I | II |
| 1. Nitrato amónico<sup>(1)</sup> | 350 | 2.500 |
| 2. Explosivos<sup>(2)</sup> | 50 | 200 |
| 3. Explosivos iniciadores<sup>(3)</sup> | 10 | 50 |
...
| q<sub>1</sub> | + | q<sub>2</sub> | + | q<sub>3</sub> | ≥1 |
| --- | --- | --- | --- | --- | --- |
| Q<sub>1</sub> | + | Q<sub>2</sub> | + | Q<sub>3</sub> | ≥1 |

siendo

q<sub>x</sub>: cantidad presente de la sustancia x.

Q<sub>x</sub>: umbral I o II de la sustancia x.
