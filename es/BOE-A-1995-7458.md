...
### ∑<sub>n=1..n</sub>D<sub>n</sub> (1 + i<sub>k</sub>)<sup>–t<sub>n</sub></sup> = ∑<sub>m=1..m</sub>R<sub>m</sub> (1 + i<sub>k</sub>)<sup>–t<sub>m</sub></sup>
...
t<sub>n</sub> = Tiempos transcurridos desde la fecha de equivalencia hasta la disposición n.

t<sub>m</sub> = Tiempo transcurrido desde la fecha de equivalencia hasta la de pago m.
...
D<sub>n</sub> = 150.000 pesetas en el momento 0 (momento de la equivalencia).

t<sub>n</sub> = 0

R<sub>m</sub> = 180.000 pesetas.

t<sub>m</sub> = 18 meses = 18/12 = 1,5 años.

k = 12 meses.

Por tanto:

### 150.000 × (1 + i<sub>k</sub>)<sup>0</sup> = 180.000 × (1 + 1<sub>k</sub>)<sup>–18</sup>

i<sub>12</sub> = 0,010180447.

TAE = (1 + 0,010180447)<sup>12</sup> – 1.
...
### 147.500 = 180.000 (1 + i<sub>k</sub>)<sup>–548</sup>

i<sub>365</sub> = 0,000363440.

TAE = (1 + 0,000363440)<sup>365</sup> – 1.
...
### 150.000 = (90.000) (1 + i<sub>k</sub>)<sup>–1</sup> + (90.000) (1 + i<sub>k</sub>)<sup>–2</sup>

i<sub>1</sub> = 13,0662386.

TAE = (1 +i<sub>1</sub>)<sup>1</sup> – 1.
...
### 150.000 – 30.000 (1 + i<sub>k</sub>)<sup>–1</sup> + 30.000 (1 + i<sub>k</sub>)<sup>–2</sup> + 20.000 (1 + i<sub>k</sub>)<sup>–3</sup> + 50.000 (1 + i<sub>k</sub>)<sup>–4</sup> + 25.000 (1 + i<sub>k</sub>)<sup>–5</sup>

i<sub>12</sub> = 0,010794.

TAE = (1 +i<sub>12</sub>)<sup>12</sup> – 1.

TAE = 13,7502 por 100.

> <small>Redactado conforme a la corrección de errores publicada en BOE núm. 113, de 12 de mayo de 1995. [Ref. BOE-A-1995-11341](https://www.boe.es/buscar/doc.php?id=BOE-A-1995-11341)</small>
