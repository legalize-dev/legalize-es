...
pdf_url: "https://www.boe.es/boe/dias/2013/04/20/pdfs/BOE-A-2013-4209.pdf"
subjects: ["Aguas", "Confederaciones Hidrográficas", "Consejos consultivos", "Costas marítimas", "Demarcación hidrográfica", "Dominio Público Hidráulico", "Galicia", "Obras hidráulicas", "Organización de la Administración del Estado", "Planificación hidrológica", "Políticas de medio ambiente"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2013/04/19/285"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2013-4209"
url_pdf: "https://www.boe.es/boe/dias/2013/04/20/pdfs/BOE-A-2013-4209.pdf"
page_start: "30622"
page_end: "30769"
image_marker: "A"
...
Norma derogada, con efectos de 20 de enero de 2016, por la disposición derogatoria única.a) del Real Decreto 1/2016, de 8 de enero. [Ref. BOE-A-2016-439#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2016-439).
...
| Código del tipo | Tipología | N.º masas de agua |
| --- | --- | --- |
| *Embalses y lagos artificiales* | *Embalses y lagos artificiales* | *Embalses y lagos artificiales* |
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_001.png)
...
| Abastecimiento de población. | Otros abastecimientos de la población. |
...
| Otros aprovechamientos. | Otros usos no ambientales. |
...
| --- | --- | --- |
| Unidad de demanda | Asignación (hm<sup>3</sup>/año) | Procedencia |
...
| Totales Demarcación (hm<sup>3</sup>) | Totales Demarcación (hm<sup>3</sup>) |
| --- | --- |
| Total UDUS | 111,23 |
| Total UDAS | 230,77 |
| Total UDIS | 394,16 |
...
3. La Administración Hidráulica, en aquellas concesiones cuyo volumen anual iguale o supere los 20.000 m<sup>3</sup>/año, podrá exigir al concesionario, a su costa, la integración de los sistemas para realizar el control efectivo de los volúmenes de agua utilizados por los aprovechamientos de agua del dominio público hidráulico en las redes de control que establezca el Organismo de cuenca, sin perjuicio de lo previsto en el artículo 44.
...
| Tipo de central | Rango de dotación anual en hm<sup>3</sup> por cada 100 MW potencia eléctrica instalada | Rango de dotación anual en hm<sup>3</sup> por cada 100 MW potencia eléctrica instalada |
| --- | --- | --- |
...
6. Para riego de campos de golf se asigna una dotación de 1.800 m<sup>3</sup>/ha/año.
...
A efectos de aplicación del artículo 126.2 del Reglamento del Dominio Público Hidráulico, respecto al trámite de información pública, se considerarán cauces de pequeña entidad, aquellos cuya cuenca de aportación sea inferior a 5 km<sup>2</sup>y siempre que, como consecuencia de la destrucción de la obra por la fuerza de las avenidas, no se puedan derivar daños significativos a personas o bienes.

3. En las obras de drenaje transversal de vías de comunicación, no se podrán añadir a una vaguada áreas vertientes superiores en más de un 10% a la superficie de la cuenca propia, asimismo, si la cuenca drenada es superior a 0,50 Km<sup>2</sup>, la sección será visitable, con una altura libre de al menos 2 m., y una anchura libre no inferior a 2,50 m. Asimismo, no podrán cortar el remonte de la fauna piscícola, en su caso. En casos debidamente justificados, se podrán reducir las citadas dimensiones, siempre y cuando el diseño propuesto permita el desagüe del caudal de avenida de 100 años de período de retorno.

4. Con carácter general, se evitarán las cubriciones y embovedados de cauces máxime cuando se prevean arrastres de sólidos y flotantes, salvo casos muy justificados. En el supuesto de que sea inevitable la cobertura de un cauce, si la cuenca drenada es superior a 0,50 Km<sup>2</sup>, la sección será visitable, con una altura libre de al menos 2 m., y una anchura libre no inferior a 2,50 m. Se procurará que exista un pequeño cauce que garantice un calado mínimo en aguas bajas para el desplazamiento de la fauna piscícola y la capacidad de arrastre suficiente para la no deposición de arrastres. En casos debidamente justificados, se podrán reducir las citadas dimensiones, siempre y cuando el diseño propuesto permita el desagüe del caudal de avenida de 100 años de período de retorno.
...
| --- | --- |
| 011.001 | Cuenca Alta del Miño |
| 011.002 | Cuenca Baja del Miño |
| 011.003 | Cuenca del Sil |
| 011.004 | Cubeta del Bierzo |
| 011.005 | Aluvial del Bajo Miño |
| 011.006 | Xinzo de Limia |
...
| Flora acuática: Organismos fitobentónicos | Multimétrico de diatomeas (MDIAT) |
| Fauna bentónica de invertebrados | lberian Biomonitoring Working Party (IBMWP) |
| Fauna bentónica de invertebrados | Multimétrico específico del tipo |
...
| Condiciones generales: Condiciones de oxigenación | DB05 |
| Condiciones generales: Salinidad | Conductividad eléctrica a 20°C media |
| Condiciones generales: Salinidad | Opcional: dureza total, cloruros y sulfatos |
...
| Elemento de calidad | CAS (3) | Sustancia contaminante | Sustancia contaminante | Umbral (pg/I) (1) | Umbral (pg/I) (1) |
| --- | --- | --- | --- | --- | --- |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 108907 | Compuestos orgánicos | Clorobenceno | 20 | 20 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 25321226 | Compuestos orgánicos | Diclorobenceno (isómeros orto, o meta y para) | 20 | 20 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 100414 | Compuestos orgánicos | Etilbenceno | 30 | 30 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 51218452 | Compuestos orgánicos | Metolacloro | 1 | 1 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 5915413 | Compuestos orgánicos | Terbutilazina | 1 | 1 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 108883 | Compuestos orgánicos | Tolueno | 50 | 50 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 71556 | Compuestos orgánicos | 1,1,1‑Tricloroetano | 100 | 100 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 1330207 | Compuestos orgánicos | Xileno (isómeros orto, meta, para) | 30 | 30 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 74908 | Compuestos inorgánicos | Cianuros totales | 40 | 40 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 16984488 | Compuestos inorgánicos | Fluoruros | 1700 | 1700 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440382 | Metales y metaloides | Arsénico total | 50 | 50 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Arsénico total | 50 | 50 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Cobre total disuelto | (2) Dureza del agua (mg/LCaCO<sub>3</sub>) | VMA (4) |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Cobre total disuelto | CaCO<sub>3</sub> <= 10 | 5 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Cobre total disuelto | 10 < CaCO<sub>3</sub> <=50 | 22 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Cobre total disuelto | 50 < CaCO<sub>3</sub> <= 100 | 40 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440508 | Metales y metaloides | Cobre total disuelto | CaCO<sub>3</sub> > 100 | 120 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7440473 | Metales y metaloides | Cromo total disuelto | 50 | 50 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 7782492 | Metales y metaloides | Selenio disuelto | 1 | 1 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 440666 | Metales y metaloides | Zinc total | (2) Dureza del agua (mg/LCaCO<sub>3</sub>) | VMA |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 440666 | Metales y metaloides | Zinc total | CaCO<sub>3</sub> <= 10 | 30 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 440666 | Metales y metaloides | Zinc total | 10 < CaCO<sub>3</sub> <=50 | 200 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 440666 | Metales y metaloides | Zinc total | 50< CaCO<sub>3</sub><= 100 | 300 |
| Sustancias preferentes del Anexo II del Real Decreto 60/2011, de 21 de enero, correspondientes con la Lista II preferente del anexo IV del Reglamento de la Planificación Hidrográfica | 440666 | Metales y metaloides | Zinc total | CaCO<sub>3</sub> > 100 | 500 |
...
| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | VALORES LÍMITES (EQR) | VALORES LÍMITES (EQR) | VALORES LÍMITES (EQR) | VALORES LÍMITES (EQR) |
| --- | --- | --- | --- | --- | --- | --- |
| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | LÍMITE MUY BUENO/BUENO | LÍMITE BUENO/MODERADO | LÍMITE MODERADO/DEFICIENTE | LÍMITE DEFICIENTE/MALO |
| Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos | Tipo 21: Ríos cántabro-atlánticos silíceos |
...
| Físico-químicos Físico-químicos | Conductividad μS/cm) | 40 | 10-100 | < 300 |  |  |
| Físico-químicos Físico-químicos | pH | 7 | 6,3-7,7 | 6 - 8,4 |  |  |
| Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea |
| Diatomeas | MDIAT | 8,008 | 7,04 (0,88) | 5,20 (0,65) | 3,60 (0,45) | 1,60 (0,2) |
| Macroinvertebrados | Multimétrico de tipo específico | 6,026 | 5,30 (0,88) | 3,91 (0,65) | 2,71 (0,45) | 1,20 (0,2) |
| Físico-químicos | Oxígeno (mg/L) | 9,2 | 7,8 | 6,9 |  |  |
| Físico-químicos | Conductividad (μS/cm) | 30 | <150 | < 350 |  |  |
| Físico-químicos | pH | 6,5 | 6-7,2 | 6-9 |  |  |
| Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña | Tipo 27: Ríos de alta montaña |
| Físico-químicos | Oxígeno (mg/L) | 9,4 |  | 7 - 7,9 |  |  |
| Físico-químicos | Conductividad (μS/cm) | 60 |  | 200 - 300 |  |  |
| Físico-químicos | pH | 7,5 |  | 6,0 - 9,0 |  |  |
| Hidromorfológicos | QBR | 94 | 88,36 (0,94) |  |  |  |
| Hidromorfológicos | IHF | 72 | 68,4 (0,95) |  |  |  |
| Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos | Tipo 28: Ejes fluviales principales cántabro-atlánticos silíceos |
| Macroinvertebrados | Multimétrico de tipo específico | 6,182 | 5,44 (0,88) | 4,01 (0,65) |  |  |
| Físico-químicos | Oxígeno (mg/L) | 10,1 | 8,5 | 7,5 |  |  |
| Físico-químicos | Conductividad (μS/cm) | 130 | <200 | <300 |  |  |
| Físico-químicos | pH | 7,9 | 7,1-8,7 | 6,3 - 9 |  |  |
| Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos | Tipo 30: Ríos costeros cántabro-atlánticos |
| Diatomeas | MDIAT | 8,008 | 7,04 (0,88) | 5,20 (0,65) | 3,60 (0,45) | 1,60 (0,2) |
...
| Físico-químicos | Conductividad (μS/cm) | 80 | 40-120 | 20 - 400 |  |  |
| Físico-químicos | pH | 7 | 6,3-7,7 | 6 - 8,4 |  |  |
| Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos | Tipo 31: Pequeños ejes cántabro-atlánticos silíceos |
| Diatomeas | MDIAT | 8,008 | 7,04 (0,88) | 5,20 (0,65) | 3,60 (0,45) | 1,60 (0,2) |
...
| Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea | Tipo 25: Ríos de montaña húmeda silícea |
| Macroinvertebrados | Multimétrico de tipo específico | 6,026 | 5,3 | 3,61 (0,6) |  |  |
| Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos | Tipo 28: Ejes fluviales principales cántabros silíceos |
| Macroinvertebrados | Multimétrico de tipo específico | 6,182 | 5,44 | 3,71 (0,6) |  |  |
| Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos | Tipo 31: Pequeños ejes cántabros-atlánticos silíceos |
| Macroinvertebrados | Multimétrico de tipo específico | 5,98 | 5,26 | 3,59 (0,6) |  |  |

| INDICADORES FÍSICO-QUÍMICOS GENERALES NO VARIABLES POR TIPOLOGÍA (1) | VALORES LÍMITES (2) | VALORES LÍMITES (2) |
| --- | --- | --- |
| INDICADORES FÍSICO-QUÍMICOS GENERALES NO VARIABLES POR TIPOLOGÍA (1) | LÍMITE MUY BUENO/BUENO | LÍMITE BUENO/MODERADO |
| Temperatura (°C) | 22,8 | 24 |
| Saturación de oxígeno (%) | 68 | 60 |
| Nitrato (mg NO<sub>3</sub>11) | 18,4 | 20 |
| Amonio (mg NH<sub>4</sub>/1) | 0,46 | 0,5 |
| DBO<sub>5</sub> | 4,6 | 5 |
| Fósforo Total (mg/1) | 0,36 | 0,4 |
| Ortofosfatos (mg PO<sub>4</sub>/1) | 0,64 | 0,7 |

> (1) En el caso de los siguientes indicadores fisicoquímicos generales : temperatura, saturación de oxígeno, nitrato, amonio, DBO<sub>5</sub>, fósforo total y ortofosfatos, no se dispone de condiciones de referencia ni de una variación de los rangos correspondientes al buen estado por tipología.
...
| Flora acuática: Macrófitos | Porcentaje de cobertura de vegetación típica |
| Fauna bentónica de invertebrados | Índice de Shannon |
| Fauna bentónica de invertebrados | Riqueza taxonómica |
| Fauna ictiológica | Proporción de individuos de especies autóctonas |
...
| Fitoplancton | Clorofila a |
| Fitoplancton | Biovolumen |
| Fitoplancton | Índice de Grupos Algales (IGA, Índice de Catalán) |
| Fitoplancton | Porcentaje cianobacterias |
...
| Régimen hidrológico | Salidas del embalses |
| Régimen hidrológico | Variación de volumen interanual |
| Régimen hidrológico | Nivel de agua medio |
| Régimen hidrológico | Tiempo de permanencia |
| Condiciones morfológicas | Variación media de la profundidad |
...
| Condiciones generales: Nutrientes | Nitratos |
| Condiciones generales: Nutrientes | Fosfatos |
| Condiciones generales: Nutrientes | Opcional: Nitrógeno total, Nitrógeno Kjeldahl y Fósforo total |
| Contaminantes específicos no sintéticos vertidos en cantidades significativas | Contaminantes no sintéticos del Anexo II del Real Decreto 60/2011, de 21 de enero. |
| Contaminantes específicos sintéticos vertidos en cantidades significativas | Contaminantes sintéticos del Anexo II del Real Decreto 60/2011, de 21 de enero. |
...
| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | VALORES LÍMITES (EQR) | VALORES LÍMITES (EQR) | VALORES LÍMITES (EQR) |
| --- | --- | --- | --- | --- | --- |
| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | LÍMITE MUY BUENO/BUENO | LÍMITE BUENO MODERADO/LÍMITE MODERADO/DEFICIENTE | LÍMITE DEFICIENTE/MALO |
| Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos | Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos | Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos | Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos | Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos | Tipo 1: Monomíctico, silíceo de zonas húmedas, con T.ª media anual < 15°C, pertenecientes a ríos de cabecera y tramos altos |
| Fitoplancton | Clorofila a (μg/L) | 2 | 9,5 (0,21) |  |  |
| Fitoplancton | Biovolumen (mm<sup>3</sup>/L) | 0,36 | 1,9 (0,19) |  |  |
| Fitoplancton | % Cianobacterias | 0 | 9,2 (0,91) |  |  |
| Fitoplancton | Índice de Catalán (IGA) | 0,1 | 10,6 (0,97) |  |  |
| Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal | Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal | Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal | Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal | Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal | Tipo 3: Monomícticos, silíceos de zonas húmedas pertenecientes a ríos de la red principal |
| Fitoplancton | Clorofila a (μg/L) | 2 | 9,5 (0,21) |  |  |
| Fitoplancton | Biovolumen (mm<sup>3</sup>/L) | 0,36 | 1,9 (0,19) |  |  |
| Fitoplancton | % Cianobacterias | 0 | 9,2 (0,91) |  |  |
| Fitoplancton | Índice de Catalán (IGA) | 0,1 | 10,6 (0,97) |  |  |
| Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos | Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos | Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos | Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos | Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos | Tipo 7: Monomíctico, calcáreo de zonas húmedas con T.ª media anual menor de 15°C pertenecientes a ríos de cabeceras y tramos altos |
| Fitoplancton | Clorofila a (μg/L) | 2,6 | 6 (0,21) |  |  |
| Fitoplancton | Biovolumen (mm<sup>3</sup>/L) | 0,76 | 2,1 (0,19) |  |  |
...
| Condiciones morfológicas | Porcentaje de la superficie con sustrato blando |
| Condiciones morfológicas | Superficie de la zona intermareal |
...
| Contaminantes específicos no sintéticos | Contaminantes sintéticos y no sintéticos del anexo II del Real Decreto 60/2011, de 21 de enero. |

### *Anexo 3.16*

### Límites de cambio de clase para los indicadores de estado ecológico en masa de agua de transición

| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | VALORES LÍMITES /EGR) | VALORES LÍMITES /EGR) | VALORES LÍMITES /EGR) | VALORES LÍMITES /EGR) |
| --- | --- | --- | --- | --- | --- | --- |
| ELEMENTO DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | LÍMITE MUY BUENO/BUENO | LÍMITE BUENO/ MODERADO | LÍMITE MODERADO/DEFICIENTE | LÍMITE DEFICIENTE/MALO |
...
| Fauna bentónica de Invertebrados | Índice QSB | * | (0,77) | (0,53) | (0,38) | (0,2) |
| Físico-químicos | Sólidos en suspensión (1) | 12 | 15 (0,8) | 18,5 (0,65) |  |  |
| Físico-químicos | Turbidez (NTU) (1) | 8 | 10 (0,8) | 12,3 (0,65) |  |  |
| Físico-químicos | Saturación de Oxígeno (%) | 81 | 67,23 (0,83) | 54,27 (0,67) |  |  |
...
| --- | --- | --- | --- | --- | --- |
| *CONDICIÓN DE REFERENCIA (M-AMBI) | 12 | 2,8 | 2,8 | 1096 |  |
| *CONDICIÓN DE REFERENCIA (CISB) | S | H | AMBI | Abundancia |  |
| *CONDICIÓN DE REFERENCIA (CISB) |  |  |  | 72 (defecto) |  |
| *CONDICIÓN DE REFERENCIA (CISB) | 14 | 3,28 | 3,01 | 1584 (exceso) |  |
...
| Condiciones morfológicas | Anchura de la zona intermareal ente la pleamar viva equinoccial (PMVE)y la bajamar viva equinoccial (BMVE). |
| Régimen de mareas | Grado de exposición al oleaje |
| Régimen de mareas | Velocidad de las corrientes dominantes |
| Régimen de mareas | Dirección de las corrientes dominantes |

### *Anexo 3.19*

### Indicadores para la evaluación de los elementos de calidad físico-químicos de las aguas costeras

| Elemento de calidad | Elemento de calidad | Indicador |
| --- | --- | --- |
| CONDICIONES GENERALES | TRANSPARENCIA | Sólidos en suspensión |
| CONDICIONES GENERALES | TRANSPARENCIA | Turbidez |
| CONDICIONES GENERALES | TRANSPARENCIA | Profundidad disco de Secchi |
| CONDICIONES GENERALES | CONDICIONES TÉRMICAS | Temperatura del agua |
| CONDICIONES GENERALES | CONDICIONES DE OXIGENACIÓN | Oxígeno disuelto |
| CONDICIONES GENERALES | CONDICIONES DE OXIGENACIÓN | Tasa de saturación del Oxígeno |
...
| CONDICIONES GENERALES | NUTRIENTES | Nitratos + Nitritos |
| CONDICIONES GENERALES | NUTRIENTES | Fósforo total |
| CONDICIONES GENERALES | NUTRIENTES | Fósforo reactivo |
...
| CONTAMINANTES ESPECÍFICOS | SINTÉTICOS VERTIDOS EN CANTIDADES SIGNIFICATIVAS | Contaminantes sintéticos del Anexo II del Real Decreto 60/2011, de 21 de enero 2011. |
...
| Físico-químicos | Turbidez (NTU) (1) | 2 | 2,5 (0,8) | 3,1 (0,65) |  |  |
| Físico-químicos | Saturación de Oxígeno (%) | 81 | 67,23 (0,83) | (0,83) | 54,27 (0,67) |  |
| Físico-químicos | Nitratos | 8,17 | 9,84 | 12.19 |  |  |
| Físico-químicos | Nitritos | 0.70 | 0.84 | 1.04 |  |  |
| Físico-químicos | Amonio | 2,19 | 2.64 | 3.27 |  |  |
| Físico-químicos | DIN | 10.39 | 12.52 | 15.51 |  |  |
| Físico-químicos | Fosfatos | 0.65 | 0.78 | 0.97 |  |  |

> (1) El incremento del 50% sobre el valor de la CR se considera el límite entre las clases Bueno/Moderado

| *CONDICIÓN DE REFERENCIA (M-AMBI) | S | H’ | AMBI |  |  |
| --- | --- | --- | --- | --- | --- |
| *CONDICIÓN DE REFERENCIA (M-AMBI) | 80 | 5 | 1 |  |  |
...
| --- | --- | --- |
| 011.001 | Cuenca Alta del Miño. | Buen estado cuantitativo y químico en 2015. |
| 011.002 | Cuenca Baja del Miño. | Buen estado cuantitativo y químico en 2015. |
| 011.003 | Cuenca del Sil. | Buen estado cuantitativo y químico en 2015. |
| 011.004 | Cubeta del Bierzo. | Buen estado cuantitativo y químico en 2015. |
| 011.005 | Aluvial del Bajo Miño. | Buen estado cuantitativo en 2015 y químico en 2021. |
| 011.006 | Xinzo de Limia. | Buen estado cuantitativo y químico en 2015. |
...
| NOMBRE | CÓDIGO | COORD FIN DE MASA | COORD FIN DE MASA | OCTUBRE-DICIEMBRE | ENERO-MARZO | ABRIL-JUNIO | JULIO-SEPTIEMBRE |
| --- | --- | --- | --- | --- | --- | --- | --- |
| NOMBRE | CÓDIGO | XUTM (29) | YUTM (29) | Qmin. (m<sup>3</sup>/s) | Qmin. (m<sup>3</sup>/s) | Qmin. (m<sup>3</sup>/s) | Qmin. (m<sup>3</sup>/s) |
| Río Miño I | ES372MAR000010 | 631.060 | 4.791.372 | 0,337 | 0,802 | 0,715 | 0,179 |
...
| Río Tamoga I | ES381MAR000070 | 616.070 | 4.792.083 | 0,243 | 0,440 | 0,522 | 0,143 |
...
| Río Narla | ES389MAR000180 | 611.830 | 4.767.250 | 0,509 | 1,208 | 0,860 | 0,230 |
| Río Fervedoira | ES390MAR000190 | 619.310 | 4.760.358 | 0,089 | 0,163 | 0,176 | 0,050 |
...
| Río Do Ferreiros | ES398MAR000290 | 632.640 | 4.742.430 | 0,109 | 0,188 | 0,149 | 0,042 |
| Río Tordea II | ES400MAR000300 | 625.460 | 4.748.087 | 0,517 | 1,100 | 0,874 | 0,217 |
...
| Río Ferreira I | ES403MAR000340 | 604.620 | 4.750.019 | 0,267 | 0,916 | 0,506 | 0,146 |
...
| Río Loio | ES404MAR000400 | 614.330 | 4.738.118 | 0,246 | 0,456 | 0,407 | 0,113 |
...
| Arroyo de Noceda | ES419MAR000700 | 709.720 | 4.721.883 | 0,172 | 0,473 | 0,386 | 0,206 |
...
| Río Ancares I | ES424MAR000830 | 688.140 | 4.741.219 | 0,421 | 0,645 | 0,376 | 0,421 |
| Arroyo del Regato | ES424MAR000840 | 687.173 | 4.732.670 | 0,095 | 0,213 | 0,111 | 0,063 |
| Arroyo del Regueiro | ES424MAR000850 | 686.330 | 4.726.549 | 0,049 | 0,130 | 0,089 | 0,048 |
...
| Río Valcarcel | ES427MAR000900 | 669.860 | 4.725.777 | 0,433 | 0,828 | 0,471 | 0,308 |
...
| Arroyo de la Sierra | ES433MAR001030 | 695.780 | 4.692.950 | 0,100 | 0,107 | 0,114 | 0,075 |
...
| Arroyo de San Xil | ES435MAR001100 | 680.060 | 4.687.756 | 0,192 | 0,226 | 0,237 | 0,133 |
...
| Rego Marinan | ES436MAR001150 | 664.790 | 4.697.593 | 0,085 | 0,105 | 0,079 | 0,055 |
| Rego de San Xulian | ES436MAR001160 | 662.398 | 4.697.224 | 0,100 | 0,131 | 0,090 | 0,066 |
| Embalse de Santiago | ES436MAR001170 | 658.120 | 4.696.404 | 19,417 | 29,711 | 21,540 | 15,686 |
...
| Río Camba I | ES438MAR001280 | 654.600 | 4.666.481 | 1,417 | 1,709 | 1,249 | 0,947 |
| Rego da Ribeira Grande | ES438MAR001290 | 641.140 | 4.664.497 | 0,240 | 0,281 | 0,214 | 0,161 |
...
| Embalse de Cenza | ES440MAR001330 | 644.750 | 4.673.015 | 0,133 | 0,138 | 0,123 | 0,088 |
...
| Río Cabalar | ES451MAR001460 | 646.400 | 4.689.546 | 0,092 | 0,118 | 0,088 | 0,064 |
...
| Embalse de Sequeiros | ES454MAR001550 | 643.810 | 4.701.319 | 32,281 | 44,598 | 31,161 | 22,407 |
...
| Río Mao II | ES464MAR001670 | 624.650 | 4.720.418 | 0,674 | 0,891 | 0,673 | 0,484 |
...
| Embalse de Albarellos | ES475MAR001890 | 566.630 | 4.694.481 | 0,663 | 1,023 | 0,913 | 0,564 |
...
| Río Avía II | ES479MAR001980 | 570.480 | 4.694.103 | 1,052 | 1,670 | 1,558 | 0,964 |
| Río Arenteiro II | ES479MAR001990 | 570.480 | 4.694.103 | 0,259 | 0,769 | 0,726 | 0,298 |
...
| Río Maceda | ES482MAR002030 | 609.900 | 4.677.452 | 0,105 | 0,251 | 0,259 | 0,121 |
...
| Río Gorgua | ES490MAR002111 | 572.480 | 4.668.009 | 0,065 | 0,111 | 0,112 | 0,064 |
...
| Río Ribadill | ES493MAR002130 | 562.730 | 4.665.533 | 0,066 | 0,149 | 0,149 | 0,068 |
...
| Río da Furnia | ES503MAR002300 | 525.730 | 4.648.864 | 0,056 | 0,148 | 0,110 | 0,062 |
...
| MASA DE AGUA | MASA DE AGUA | CAUDAL GENERADOR (m<sup>3</sup>/s) | PERIODO RETORNO (AÑOS) | MES DE MÁXIMA FRECUENCIA |
| --- | --- | --- | --- | --- |
| CÓDIGO | DENOMINACIÓN | CAUDAL GENERADOR (m<sup>3</sup>/s) | PERIODO RETORNO (AÑOS) | MES DE MÁXIMA FRECUENCIA |
...
| MASA DE AGUA | MASA DE AGUA | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MASA DE AGUA | MASA DE AGUA | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO ASCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | TASA DE CAMBIO DESCENDENTE (m<sup>3/</sup>día) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | Volumen (hm<sup>3</sup>) | Volumen (hm<sup>3</sup>) | Volumen (hm<sup>3</sup>) | Volumen (% s/apor. natural) | Volumen (% s/apor. natural) | Volumen (% s/apor. natural) |
...
| CÓDIGO DE LA ZONA PROTEGIDA | NOMBRE DE LA CASCADA O FERVENZA | MUNICIPIO | PROVINCIA | NOMBRE MASA DE AGUA ASOCIADA | CÓDIGO MASA DE AGUA ASOCIADA | COORDENADAS UTM ETRS89 (HUSO 29 | COORDENADAS UTM ETRS89 (HUSO 29 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| CÓDIGO DE LA ZONA PROTEGIDA | NOMBRE DE LA CASCADA O FERVENZA | MUNICIPIO | PROVINCIA | NOMBRE MASA DE AGUA ASOCIADA | CÓDIGO MASA DE AGUA ASOCIADA | COORD. X | COORD. Y |
...
| 1110100254 | Pozo de los Fumos | Murias de Paredes | León | Río Bayo | ES412MAR000530 | 728.680 | 4.753.292 |
...
| Información por Uso del agua | Información por Uso del agua | Información por Uso del agua |
| --- | --- | --- |
| Titular del Uso |  |  |
| Datos del titular |  |  |
| Número de usuarios | Número de usuarios |  |
| Período de Facturación | Período de Facturación |  |
| Servicios Prestados |  |  |
| Volumen captado, por período de facturación | Volumen captado, por período de facturación | m<sup>3</sup> |
| Localización de la captación (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | Localización de la captación (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | X: Y: |
| Volumen registrado, por período de facturación | Volumen registrado, por período de facturación | m<sup>3</sup> |
| Volumen facturado, por período de facturación | Volumen facturado, por período de facturación | m<sup>3</sup> |
| Ingresos, por período de facturación y servicio prestado | Ingresos, por período de facturación y servicio prestado | € |
| Canon a favor de la administración, por período de facturación, en caso de existir | Canon a favor de la administración, por período de facturación, en caso de existir | € |
| Subvención a favor del usuario, por período de facturación, en caso de existir | Subvención a favor del usuario, por período de facturación, en caso de existir | € |
| Tarifas en vigor (adjuntar publicación de las mismas en un medio oficial) | Tarifas en vigor (adjuntar publicación de las mismas en un medio oficial) | Tarifas en vigor (adjuntar publicación de las mismas en un medio oficial) |
| Punto de vertido de aguas residuales (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | Punto de vertido de aguas residuales (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | X: Y: |
| Denominación de las Inversiones realizadas para el presente uso del agua, por período de facturación (adjuntar relación) | Denominación de las Inversiones realizadas para el presente uso del agua, por período de facturación (adjuntar relación) | Denominación de las Inversiones realizadas para el presente uso del agua, por período de facturación (adjuntar relación) |
...
| SISTEMA DE EXPLOTACIÓN | RESERVA AMBIENTAL (hm<sup>3</sup>/año) | RESERVA ABASTECIMIENTO (hm<sup>3</sup>/año) |
| --- | --- | --- |
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_002.png)
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_003.png)
...
| ASCENSO | Características y geometría del obstáculo | Facilidad de acceso a pie de presa |  | si/no |
| ASCENSO | Características y geometría del obstáculo | Llamada |  | si/no |
| ASCENSO | Características y geometría del obstáculo | Presencia de cambios de pendiente |  | si/no |
| ASCENSO | Condiciones hidrodinámicas | Profundidad de la poza de remonte |  | m |
| ASCENSO | Condiciones hidrodinámicas | Condiciones de turbulencia |  | si/no |
...
| ASCENSO | Otros medios | Escalas, cauces artificiales, aliviaderos... |  | si/no |
...
| --- | --- | --- | --- | --- |
| DESCENSO | Facilidad de identificación de salida |  |  | si/no |
| DESCENSO | Tomas de agua | Rejilla |  | si/no |
| DESCENSO | Tomas de agua | Turbinas |  | si/no |
| DESCENSO | Características aliviaderos y altura caída |  |  |  |
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_004.png)
...
### ki = N × (M<sub>ov</sub> + V<sub>n</sub>)<sup>2</sup>
...
M<sub>ov</sub> = Movilidad, capacidad de realizar migraciones.
...
V<sub>n</sub> = Vulnerabilidad, En función de las categorías establecidas en la lista roja de la UICN.
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_005.png)

Donde:

L<sub>t</sub>  = Longitud total del río.

L<sub>arriba</sub> = Longitud de las aguas libres por encima del azud.

L<sub>abajo</sub> = Longitud de las aguas libres por debajo del azud.
...
![](https://www.boe.es/datos/imagenes/disp/2013/95/04209_006.png)

Donde:

Sk<sub>i</sub>= Suma de los coeficientes de prioridad de las especies (k<sub>i</sub>) presentes en el tramo del azud en cuestión.

Sk<sub>T</sub> = Suma de los coeficientes de prioridad de las especies (k<sub>i</sub>) presentes en el río, tramo, masa de agua o cuenca donde se encuentra el azud.
...
### P = F<sub>Reserva Fluvial</sub>+ F<sub>LIC</sub> + F<sub>ESPACIOS PROTEGIDOS</sub>

Donde:

F<sub>Reserva Fluvial</sub>:	50 si el tramo en que está el azud es reserva fluvial.

0 si el tramo en que está el azud no es reserva fluvial.

F<sub>LIC</sub>: 25 si el tramo en que está el azud es LIC de ribera.

0 si el tramo en que está el azud no es LIC de ribera.

F<sub>ESPACIOS PROTEGIDOS</sub>: 25 si el tramo en que está el azud está en un espacio protegido (Parque Nacional, Regional, etc.).
