...
□ es una persona que no forma parte de una unidad familiar<sup>2,</sup>con nombre y NIF o NIE siguiente:

| Nombre | Apellidos | NIF/NIE |
| --- | --- | --- |
|  |  |  |

□ forma parte de la unidad familiar<sup>2</sup> integrada por los siguientes miembros (nombre y NIF o NIE de cada uno de los miembros para los que dicho documento sea obligatorio y, en su caso, del NIF o NIE de los menores de 14 años de edad de la unidad familiar que dispongan de él).
