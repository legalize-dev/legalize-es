...
pdf_url: "https://www.boe.es/boe/dias/2006/03/31/pdfs/A12557-12585.pdf"
subjects: ["Baleares", "Canarias", "Ceuta", "Energía eléctrica", "Garantías", "Melilla", "Precios", "Producción de energía"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2006/03/30/itc914"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2006-5808"
url_pdf: "https://www.boe.es/boe/dias/2006/03/31/pdfs/A12557-12585.pdf"
page_start: "12557"
page_end: "12585"
image_marker: "A"
...
references_subsequent: "SE DEROGA BOE-A-2015-8646; SE DEROGA BOE-A-2010-15437; CORRECCIÓN de errores BOE-A-2006-9085; SE DICTA DE CONFORMIDAD BOE-A-2009-14367; SE DICTA DE CONFORMIDAD BOE-A-2009-9167"
...
Norma derogada por la disposición derogatoria única.c) del Real Decreto 738/2015, de 31 de julio. [Ref. BOE-A-2015-8646](https://www.boe.es/buscar/doc.php?id=BOE-A-2015-8646).
...
> Téngase en cuenta que se dejan sin efecto los apartados 3, 4 y 6, en lo referente a los factores de estacionalidad, los periodos y las horas anuales de funcionamiento estándar, por el punto 5 de la Resolución de 28 de septiembre de 2010. [Ref. BOE-A-2010-15437](https://www.boe.es/buscar/doc.php?id=BOE-A-2010-15437).
...
![](https://www.boe.es/datos/imagenes/disp/2006/77/05808_001.png)

Siendo:

| RGpot<sub>n</sub> (i): | Retribución por garantía de potencia para el grupo i en el año n, expresada en euros. |
| --- | --- |
...
| Gpot<sub>n</sub> (i,h): | Garantía de potencia en el año n del grupo i en la hora h, expresada en euros/MW. |
...
![](https://www.boe.es/datos/imagenes/disp/2006/77/05808_002.png)

Donde:

| Gpot<sub>n</sub> (i,h): | Garantía de potencia horaria en el año n del grupo i en la hora h, expresada en euros/MW, |
| --- | --- |
| Gpot<sub>n</sub> (i): | Garantía de potencia anual del grupo i, en el año n expresada en euros/MW. |
| f est <sub>h</sub>: | Factor de estacionalidad horario para cada uno de los sistemas insulares y extrapeninsulares y para cada periodo horario, punta, llano y valle. |
...
3. Los factores de estacionalidad, para cada sistema, f est <sub>h</sub>, de punta, valle y llano que se aplicarán son los siguientes

| PERIODO | Factores de estacionalidad | Factores de estacionalidad | Factores de estacionalidad | Factores de estacionalidad |
| --- | --- | --- | --- | --- |
| PERIODO | Baleares | Canarias | Ceuta | Melilla |
...
5. La Dirección General de Política Energética y Minas, a propuesta del Operador del Sistema podrá revisar los periodos de punta, valle y llano, así como los valores del factor de estacionalidad f est<sub>h</sub> para cada uno de los bloques definidos en función de la evolución de las curvas de carga de cada sistema y de sus niveles de reserva de capacidad.
...
> <small>Se dejan sin efecto los apartados 3, 4 y 6, en lo referente a los factores de estacionalidad, los periodos y las horas anuales de funcionamiento estándar, por el punto 5 de la Resolución de 28 de septiembre de 2010. [Ref. BOE-A-2010-15437](https://www.boe.es/buscar/doc.php?id=BOE-A-2010-15437).</small>

###### Artículo 4. Valor unitario de la garantía de potencia anual para las instalaciones de generación en régimen ordinario.

1. El valor unitario de la garantía de potencia anual (Gpot <sub>n</sub> (i)) de un grupo i en el año n se obtendrá mediante la siguiente fórmula:

### Gpot<sub>n</sub> (i) = CIT<sub>in</sub> + COMT<sub>in</sub>

Donde:

| CIT<sub>in</sub>: | Anualidad (en el año n) del coste de inversión del grupo i, expresada en euros/MW |
| --- | --- |
| COMT<sub>in</sub>: | Anualidad (en el año n) de los costes de operación y mantenimiento fijos del grupo i, expresada en euros/MW. |
...
### CIT<sub>in</sub> = A<sub>i</sub> + R<sub>in</sub>

Donde:

| CIT<sub>in</sub>: | Anualidad (en el año n) por inversión de un grupo i de una central con una tecnología concreta, expresada en euros/MW. |
| --- | --- |
| A<sub>i</sub>: | Retribución por amortización anual de la inversión del grupo i, expresada en euros/MW. |
| R<sub>in</sub>: | Retribución financiera en el año n de la inversión del grupo i, expresada en euros/MW. |

3. La Dirección General de Política Energética y Minas establecerá el valor unitario de la garantía de potencia anual (Gpot<sub>n</sub> (i)) reconocida a cada una de las instalaciones del régimen ordinario que, de acuerdo con el artículo 6.3 del Real Decreto 1747/2003, de 19 de diciembre, hayan sido adjudicadas mediante concurso promovido por las Comunidades Autónomas o las Ciudades afectadas, siempre que las bases del concurso relativas a la retribución máxima por garantía de potencia hayan sido previamente acordadas entre la Administración que las promueva y el Ministerio de Industria, Turismo y Comercio. En estos casos la retribución anual por garantía de potencia reconocida se fijará en los términos en que hayan sido adjudicadas mediante el concurso.
...
– VU<sub>i</sub>: Vida útil del grupo i, expresada en años. Se considerará de 25 años para las instalaciones térmicas y de 65 años para las instalaciones hidráulicas.

2. La retribución financiera de la inversión de cada grupo i (R<sub>in</sub>), expresada en euros/MW, se calculará cada año n aplicando la tasa de retribución (Tr<sub>n</sub>) a la inversión neta (VNI<sub>in</sub>), conforme a la siguiente formula:

### R<sub>in</sub> = VNI<sub>in</sub> * Tr<sub>n</sub>

Donde:

– VNI<sub>in</sub> : Valor neto de la inversión del grupo i en el año n, expresada en euros/MW.

### VNI<sub>in</sub> : VI<sub>i</sub> – Aai<sub>n-1</sub>

Donde:

– VI<sub>i</sub> : Valor de la inversión del grupo i, expresada en euros/MW, con el mismo significado que el del apartado anterior.

– Aai<sub>n-1</sub> : Amortización acumulada hasta el año n-1 del grupo i, expresada en euros/MW.
...
> <small>Redactado el apartado 3 conforme a la corrección de errores publicada en BOE núm.124, de 25 de mayo de 2006. [Ref. BOE-A-2006-9085](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-9085).</small>

###### Artículo 6. Revisión de la retribución por garantía de potencia.

1. Por resolución de la Dirección General de Política Energética y Minas se publicará, antes del 1 de enero de cada año (n), el valor unitario de la garantía de potencia anual (Gpot<sub>n</sub> (i)) correspondiente a cada una de las instalaciones del régimen ordinario que participen en el despacho económico de los sistemas eléctricos insulares y extrapeninsulares para dicho año.
...
> <small>Redactados los apartados 2 y 4 conforme a la corrección de errores publicada en BOE núm.124, de 25 de mayo de 2006. [Ref. BOE-A-2006-9085](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-9085).</small>
...
| Tecnología | Potencia (Mw) | Valores unitarios de inversión (Euros/Mw) | Valores unitarios de inversión (Euros/Mw) | Valores unitarios de inversión (Euros/Mw) |
| --- | --- | --- | --- | --- |
| Tecnología | Potencia (Mw) | Baleares | Canarias | Ceuta y Melilla |
...
| Tecnología | Potencia (Mw) | Valores unitarios de operación y mantenimiento de naturaleza fija (Euros/MW) | Valores unitarios de operación y mantenimiento de naturaleza fija (Euros/MW) | Valores unitarios de operación y mantenimiento de naturaleza fija (Euros/MW) |
| --- | --- | --- | --- | --- |
| Tecnología | Potencia (Mw) | Baleares | Canarias | Ceuta y Melilla |
| Grupos Diesel - 4T | < 5 | N/A | 145.681 | 145.681 |
| Grupos Diesel - 4T | ≥ 5 y < 14 | N/A | 119.570 | 119.570 |
| Grupos Diesel - 4T | ≥ 14 y < 24 | 71.976 | 78.640 | 78.640 |
| Grupos Diesel - 2T | ≥ 24 | 55.691 | 65.120 | N/A |
| Turbinas de gas aeroderivadas | < 50 | 21.694 | 25.367 | 25.367 |
| Turbinas de gas heavy duty | ≥ 20 y ≤ 50 | 19.208 | 22.461 | N/A |
| Turbinas de gas heavy duty | > 50 | 13.110 | 15.330 | N/A |
...
| Grupos Diesel - 2T | ≥ 14 y < 24 | 46.890 | 54.829 | N/A |
...
| Vapor Fuel | > 60 y ≤ 80 | N/A | 22.540 | N/A |
...
| Grupo | Denominación Registro | Tipo | Potencia nominal | Potencia NETA | Fecha entrada | MILLONES DE EUROS | MILLONES DE EUROS |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| TOTAL 2002 | TOTAL 2002 |  |  |  |  | 323,9 | 289,5 | 310,5 | 266,3 |
...
| TOTAL 2003 | TOTAL 2003 |  |  |  |  | 449,3 | 396,7 | 429,5 | 387,5 |
...
| TOTAL 2004 | TOTAL 2004 |  |  |  |  | 240,9 | 218,1 | 231,9 | 219,0 |
...
| TOTAL 2005 | TOTAL 2005 |  |  |  |  | 194,3 | 173,3 | 134,9 | 131,7 |
...
> <small>Redactado conforme a la corrección de errores publicada en BOE núm.124, de 25 de mayo de 2006. [Ref. BOE-A-2006-9085](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-9085).</small>
...
La retribución total por inversión de estos grupos para el año 2001 se ha calculado conforme lo establecido en la disposición transitoria primera del Real Decreto 1747/2003, de 19 de diciembre, aplicando la tasa de retribución (Tr<sub>n</sub>) a la inversión bruta auditada a 31 de diciembre de 2001, de acuerdo con la siguiente formula:

### CIT<sub>in</sub> = VBA<sub>i</sub> * Tr<sub>n</sub> + A<sub>i</sub>

Donde:

– VBA: Valor bruto auditado de la inversión del grupo i a 31 de diciembre de 2001

– (Tr<sub>n</sub>): Tasa financiera de retribución a aplicar en el año n. Se corresponde con el valor de los Bonos del Estado a diez años más 150 puntos básicos.
...
| Grupo | Denominación Registro | Tipo | MILLONES DE EUROS | MILLONES DE EUROS | MILLONES DE EUROS | MILLONES DE EUROS | MILLONES DE EUROS |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Grupo | Denominación Registro | Tipo | RCIT<sub>i</sub> | RCIT<sub>i</sub> | RCIT<sub>i</sub> | RCIT<sub>i</sub> | RCIT<sub>i</sub> |
| Grupo | Denominación Registro | Tipo | 2001 | 2002 | 2003 | 2004 | 2005 |
...
|  |  |  |  | Retribución Inversión RCITi (Millones de euros) | Retribución Inversión RCITi (Millones de euros) | Retribución Inversión RCITi (Millones de euros) | Retribución Inversión RCITi (Millones de euros) |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Grupo | Denominación oficinal | Tipo | Costes Operación y mantenimiento (euros) | Costes Operación y mantenimiento (euros) | Costes Operación y mantenimiento (euros) | Costes Operación y mantenimiento (euros) |
| --- | --- | --- | --- | --- | --- | --- |
| Grupo | Denominación oficinal | Tipo | 2001 | 2002 | 2003 | 2004 |
...
| IBIZA 3 | SULZER 1 | D | 95.099 | 129.790 | 104.748 | 136.203 |
| IBIZA 4 | SULZER 2 | D | 95.099 | 129.790 | 104.748 | 136.203 |
...
| SON REUS 1 | TURBINA GAS 1 | TG | 94.008 | 286.684 | 871.667 | 858.170 |
| SON REUS 2 | TURBINA GAS 2 | TG | 94.008 | 286.684 | 871.667 | 858.170 |
| SON REUS 3 | TURBINA GAS 3 | TG | 94.008 | 286.684 | 871.667 | 858.170 |
| SON REUS 4 | TURBINA GAS 4 | TG | 94.008 | 286.684 | 871.667 | 858.170 |
...
| SALINAS, LAS 1 | DIESEL 1 | D | 138.483 | 205.580 | 249.442 | 317.397 |
| SALINAS, LAS 2 | DIESEL 2 | D | 138.483 | 205.580 | 249.442 | 317.397 |
...
| PUNTA GRANDE 2 | DIESEL 1 | D | 237.455 | 270.759 | 305.620 | 419.397 |
| PUNTA GRANDE 3 | DIESEL 2 | D | 237.455 | 270.759 | 305.620 | 419.397 |
| PUNTA GRANDE 7 | DIESEL 3 | D | 237.455 | 270.759 | 305.620 | 419.397 |
| PUNTA GRANDE 9 | GAS 1 | TG | 789.412 | 900.129 | 1.016.023 | 1.394.271 |
| PUNTA GRANDE 11 | DIESEL 4 | D | 489.435 | 558.080 | 629.934 | 864.448 |
| PUNTA GRANDE 12 | DIESEL 5 | D | 489.435 | 558.080 | 629.934 | 864.448 |
...
| CANDELARIA 3 | DIESEL 1 | D | 301.517 | 363.169 | 473.690 | 535.153 |
| CANDELARIA 4 | DIESEL 2 | D | 301.517 | 363.169 | 473.690 | 535.153 |
| CANDELARIA 5 | GAS 3 | TG | 432.175 | 520.543 | 678.956 | 767.053 |
| CANDELARIA 6 | DIESEL 3 | D | 301.517 | 363.169 | 473.690 | 535.153 |
...
| PALMAR, EL 5 | DIESEL 5 | D | 46.363 | 35.538 | 50.985 | 59.300 |
| PALMAR, EL 11 | DIESEL 11 | D | 0 | 51.885 | 74.438 | 0 |
| PALMAR, EL 12 | DIESEL-MOV.1 | D | 118.689 | 90.977 | 130.521 | 151.808 |
| PALMAR, EL 13 | DIESEL 12 | D | 148.361 | 113.722 | 163.152 | 189.760 |
| PALMAR, EL 14 | DIESEL 13 | D | 148.361 | 113.722 | 163.152 | 189.760 |
| PALMAR, EL 15 | DIESEL 14 | D | 207.706 | 159.210 | 228.412 | 265.664 |
| PALMAR, EL 16 | DIESEL 15 | D | 207.706 | 159.210 | 228.412 | 265.664 |
| PALMAR, EL 17 | DIESEL 16 | D | 264.269 | 202.567 | 290.614 | 338.010 |
| PALMAR, EL 18 | DIESEL 17 | D | 264.269 | 202.567 | 290.614 | 338.010 |
| LLANOS BLANCOS 1 | DIESEL-MOV.1 | D | 109.588 | 141.905 | 170.569 | 180.011 |
| LLANOS BLANCOS 9 | DIESEL 7 | D | 66.780 | 86.473 | 103.941 | 109.694 |
| LLANOS BLANCOS 11 | DIESEL 9 | D | 94.177 | 121.949 | 146.583 | 154.697 |
| LLANOS BLANCOS 12 | DIESEL 10 | D | 124.999 | 161.860 | 194.555 | 205.325 |
| LLANOS BLANCOS 13 | DIESEL 11 | D | 124.999 | 161.860 | 194.555 | 205.325 |
| LLANOS BLANCOS 14 | DIESEL 12 | D | 124.999 | 161.860 | 194.555 | 205.325 |
| LLANOS BLANCOS 15 | DIESEL 13 | D | 124.999 | 161.860 | 194.555 | 205.325 |
...
| MELILLA 7 | G-7 | D | 509.477 | 361.550 | 231.982 | 285.066 |
| MELILLA 8 | G-8 | D | 509.477 | 361.550 | 231.982 | 285.066 |
...
| CEUTA 8 | G-8 | D | 702.537 | 741.000 | 880.930 | 899.717 |
...
| --- | --- | --- | --- |
| Grupo | Denominación Registro | Tipo | RCIT<sub>i</sub> |
| Grupo | Denominación Registro | Tipo | 2006 |
...
| Grupo | Denominación Registro | Tipo | EUROS/MW |
| --- | --- | --- | --- |
| Grupo | Denominación Registro | Tipo | RCITi |
| Grupo | Denominación Registro | Tipo | 2006 |
| BCO. TIRAJANA 1 | GAS 1 | TG | 19.728 |
| BCO. TIRAJANA 2 | GAS 2 | TG | 26.500 |
...
| PUNTA GRANDE 11 | DIESEL 4 | D | 82.490 |
...
| Emplazamiento | Denominación | Denominación Registro | Fecha de puesta en marcha | RCIT<sub>i</sub>2006 Euros/MW |
| --- | --- | --- | --- | --- |
...
| Gran Canaria | Bco. Tirajana 7 | Turbina de vapor 3 (CC1) | 22/11/2004 | 110.430 |
...
| La Gomera | El Palmar 19 | Diesel 18 | 04/12/2004 | 228.640 |
| Mallorca | Son Reus 11 | Turbina de vapor 11 (CC206FA) | 01/06/2005 | 102.460 |
...
| TOTAL 2002 | TOTAL 2002 |  |  |  |  | 323,9 | 289,5 |
...
| TOTAL 2003 | TOTAL 2003 |  |  |  |  | 449,3 | 396,7 |
...
| TOTAL 2004 | TOTAL 2004 |  |  |  |  | 240,9 | 218,1 |
...
|  | El Hierro | Llanos Blancos 16 | Diesel 14 | 21/10/2005 | D | 2,0 | 1,9 |
|  | El Hierro | Llanos Blancos 17 | Diesel 15 | 01/12/2005 | D | 2,0 | 1,9 |
| TOTAL 2005 | TOTAL 2005 |  |  |  |  | 194,3 | 173,3 |
...
| 2003 | Mallorca | San Juan Dios 4 | F | 40,00 |
| 2003 | Mallorca | San Juan Dios 5 | F | 40,00 |
| 2003 | La Gomera | El Palmar 11 | D | 0,73 |
| 2004 | La Gomera | El Palmar 5 | D | 0,50 |
| 2005 | Mallorca | Son Molinas 1 | TG | 14,00 |
| 2005 | Ceuta | Ceuta 5 | D | 3,12 |
...
| 2003 | Melilla -> Ceuta | Traslado 4 grupos electrógenos a Ceuta | D | 4,00 |
| 2004 | La Palma -> Fuerteventura | Traslado Los Guinchos 11 a Las Salinas | TG | 16,60 |
| 2004 | Melilla -> Ceuta | Traslado 4 grupos electrógenos a Ceuta | D | 4,00 |
| 2005 | Mallorca -> Ibiza | Traslado Son Molinas 4 a Ibiza | TG | 25,0 |
| 2005 | Ceuta -> Melilla | Vuelta a Melilla de los 4 grupos electrógenos | D | 4,00 |
