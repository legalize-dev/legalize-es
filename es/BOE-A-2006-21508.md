...
pdf_url: "https://www.boe.es/boe/dias/2006/12/09/pdfs/A43281-43289.pdf"
subjects: ["Aparatos de medida", "Carburantes y combustibles", "Formularios administrativos", "Metrología y metrotecnia", "Reglamentaciones técnicas", "Vehículos de motor"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2006/11/22/itc3749"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2006-21508"
url_pdf: "https://www.boe.es/boe/dias/2006/12/09/pdfs/A43281-43289.pdf"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2006/12/16/pdfs/A03495-03503.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2006/12/16/pdfs/A02531-02539.pdf"
page_start: "43281"
page_end: "43289"
image_marker: "A"
legislative_status: "L"
alerts: "Industria; Tecnología e investigación; Transportes y tráfico"
references_previous: "DEROGA BOE-A-1999-7859; DE CONFORMIDAD con BOE-A-2006-14017"
...
Norma derogada, con efectos de 24 de octubre de 2020, por la disposición derogatoria única.k) de la Orden ICT/155/2020, de 7 de febrero. [Ref. BOE-A-2020-2573#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2020-2573).
...
![](https://www.boe.es/datos/imagenes/disp/2006/294/21508_001.png)
...
Coeficiente de absorción luminosa: 0,01 m<sup>-1</sup>.
...
s) Se deben aportar los tiempos de respuesta eléctricos, para todas las salidas eléctricas (salida al registrador, al visualizador analógico y visualizador digital) que posee el opacímetro, indicando la escala (opacidad o coeficiente de absorción luminosa), la longitud efectiva del trayecto del haz luminoso L<sub>A</sub> y las características de respuesta. Se debe proporcionar el valor del tiempo de respuesta del indicador digital.
...
La comprobación se realizará con un filtro con un valor de opacidad entre el 40 % y el 60 %. Se considerará aceptable si el valor leído se encuentra en el siguiente intervalo: el valor del filtro ± 10 % (unidades absolutas) de opacidad o el valor del filtro ± 0,25 m<sup>-1</sup>en coeficiente de absorción luminosa. El opacímetro no debe permitir realizar medidas de opacidad y/o coeficiente de absorción luminosa si no se ha realizado la comprobación o ésta no ha sido satisfactoria. El usuario debe conservar el registro de las comprobaciones realizadas, durante al menos un año. En estos registros, que debe emitir el instrumento a través del software, debe constar la fecha y los datos obtenidos.
...
Valor final del coeficiente de absorción en m<sup>-1</sup>.
...
Longitud efectiva L<sub>A</sub> de una muestra de gas de escape.
...
Un generador de humo, que puede ser un vehículo o un motor que proporcionen humos con valores de coeficiente de absorción luminosa entre 1,5 m<sup>-1</sup> y 3,5 m<sup>-1</sup>.
...
Los errores absolutos máximos permitidos para este ensayo son: 2 % en unidades de opacidad y 0,15 m<sup>-1</sup> en unidades de coeficiente de absorción luminosa.
...
La diferencia entre el valor de k leído y el valor obtenido según la Ley de Beer-Lambert no debe superar el valor del error absoluto máximo permitido que es 0,05 m<sup>-1</sup>.
...
La diferencia entre los valores obtenidos en los valores de cero y de máximo de escala no debe superar el error máximo permitido que es 0,5 % en N y 0,03 m<sup>-1</sup> para k.
...
La diferencia entre la lectura mayor y la menor no debe superar el error absoluto máximo permitido que es 0,5 % en N y 0,03 m<sup>-1</sup> para k.

Repetibilidad:

Se realizan 10 medidas consecutivas de cada uno de los filtros, tanto en N como en k.

La diferencia entre la lectura mayor y la menor no debe superar el error absoluto máximo permitido que es 1 % en N y 0,05 m<sup>-1</sup> para k.

Variaciones de la alimentación eléctrica:

El ensayo consiste en someter el opacímetro a los valores extremos de la tensión nominal (V<sub>nom</sub>) y de la frecuencia nominal (ƒ<sub>nom</sub>) durante un período de tiempo suficientemente largo para poder efectuar las medidas exigidas.
...
| Tensión de alimentación (V) | Límite superior | V<sub>nom</sub> + 10% |
| --- | --- | --- |
| Tensión de alimentación (V) | Límite inferior | V<sub>nom</sub> – 15% |
| Frecuencia de alimentación (Hz) | Límite superior | ƒ<sub>nom</sub> + 2% |
| Frecuencia de alimentación (Hz) | Límite inferior | ƒ<sub>nom</sub> – 2% |
...
Se realiza una medida antes y otra después de la aplicación de cada una de las descargas. La diferencia entre la lectura mayor y la menor no debe superar el error absoluto máximo permitido que es 1 % en N y 0,05 m<sup>-1</sup> para k.
...
La diferencia entre las lecturas no debe superar el error absoluto máximo permitido que es 1 % en N y 0,05 m<sup>-1</sup> para k.
...
0,15 m<sup>-1</sup> para valores de k menores de 2 m<sup>-1</sup>.

8% del valor de k de la lectura del opacímetro de referencia mayores o iguales a 2 m<sup>-1</sup>.

La diferencia entre la lectura máxima y mínima tanto del opacímetro de referencia como del opacímetro a ensayar no debe ser superior a 0,45 m<sup>-1</sup>.
...
Un generador de humo, que puede ser un vehículo o un motor que proporcionen humos con valores de coeficiente de absorción luminosa entre 1,5 m<sup>-1</sup> y 3,5 m<sup>-1</sup>. Un opacímetro de referencia que se deberá comparar anualmente con el opacímetro de referencia nacional.
...
2 % en unidades de opacidad y 0,15 m<sup>-1</sup> en unidades de coeficiente de absorción luminosa.
...
0,20 m<sup>-1</sup> para valores de k menores de 2 m<sup>-1</sup>.

10 % del valor de k de la lectura del opacímetro de referencia para valores mayores o iguales a 2 m<sup>-1</sup>.

La diferencia entre la lectura máxima y la mínima tanto del opacímetro de referencia como del opacímetro a ensayar no debe ser superior a 0,45 m<sup>-1</sup>.
