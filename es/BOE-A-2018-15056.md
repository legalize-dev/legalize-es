...
| Ejercicio FEAGA | N.º de programa | Total puntos | NIF | Beneficiario | Tipo beneficiario | Presupuesto total ejercicio FEAGA XXX | a) | b) | c) | d) | a) | b) | c) | a) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Ejercicio FEAGA | N.º de programa | Total puntos | NIF | Beneficiario | Tipo beneficiario | Presupuesto total ejercicio FEAGA XXX | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización | Puntuación: Criterios priorización |
| Ejercicio FEAGA | N.º de programa | Total puntos | NIF | Beneficiario | Tipo beneficiario | Presupuesto total ejercicio FEAGA XXX | 1. Proponente | 1. Proponente | 1. Proponente | 1. Proponente | 2. Programa | 2. Programa | 2. Programa | 3. CCAA |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
