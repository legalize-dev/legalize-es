...
Vestíbulo: (5,39 euros/hora m<sup>2</sup>) x (número metros cuadrados) x (número de horas de utilización).

Terrazas: (3,63 euros/hora m<sup>2</sup>) x (número metros cuadrados) x (número de horas de utilización).

Patio: (3,57 euros/hora m<sup>2</sup>) x (número metros cuadrados) x (número de horas de utilización).
