---
title: "Resolución de 2 de agosto de 2016, de la Secretaría de Estado de Energía, por la que se aprueban las normas de gestión de garantías del sistema gasista"
identifier: "BOE-A-2016-7563"
country: "es"
rank: "resolucion"
publication_date: "2016-08-05"
last_updated: "2023-06-01"
status: "in_force"
source: "https://www.boe.es/eli/es/res/2016/08/02/(1)"
department: "Ministerio de Industria, Energía y Turismo"
pdf_url: "https://www.boe.es/boe/dias/2016/08/05/pdfs/BOE-A-2016-7563.pdf"
subjects: ["Aval", "Comercialización", "Contratos", "Créditos", "Distribución de energía", "Garantías", "Gas", "Hidrocarburos", "Mercados", "Política energética", "Portugal", "Reglamentaciones técnicas", "Seguro de caución"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/res/2016/08/02/(1)"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2016-7563"
url_pdf: "https://www.boe.es/boe/dias/2016/08/05/pdfs/BOE-A-2016-7563.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2016-7563"
page_start: "55958"
page_end: "56042"
image_marker: "A"
legislative_status: "L"
alerts: "Comercio; Derecho Mercantil; Energía; Sistema financiero"
references_previous: "SUSTITUYE BOE-A-2015-13348; DE CONFORMIDAD con BOE-A-2015-11725; DE CONFORMIDAD con BOE-A-1998-23284"
references_subsequent: "SE MODIFICA BOE-A-2023-13071; SE CORRIGEN errores BOE-A-2016-8926"
...
![1](https://www.boe.es/datos/imagenes/disp/2016/188/07563_14685.png)
...
![2](https://www.boe.es/datos/imagenes/disp/2016/188/07563_14886.png)
...
![3](https://www.boe.es/datos/imagenes/disp/2016/188/07563_14932.png)
...
![4](https://www.boe.es/datos/imagenes/disp/2016/188/07563_15025.png)
...
![5](https://www.boe.es/datos/imagenes/disp/2016/188/07563_15084.png)

        Siendo:

        N<sub>d</sub>: número de Transacciones realizadas de productos de carácter diario e intradiario con entrega en el PVB-ES correspondiente al Día de gas d.
...
> <small>Se sustituye el apartado 4.2 por el texto que figura en el anejo I de la Resolución de 11 de mayo de 2023, según establece su apartado primero. [Ref. BOE-A-2023-13071](https://www.boe.es/buscar/doc.php?id=BOE-A-2023-13071)</small>
...
> <small>Se sustituye por el modelo que figura en el anejo II de la Resolución de 11 de mayo de 2023, según establece su apartado segundo. [Ref. BOE-A-2023-13071](https://www.boe.es/buscar/doc.php?id=BOE-A-2023-13071)</small>
...
![6](https://www.boe.es/datos/imagenes/disp/2016/188/07563_15158.png)

donde:

I. δ<sub>USU</sub>: desviación de las salidas y el riesgo derivado de las operaciones de cesión de gas en el PVB respecto a las entradas y las adquisiciones de gas en el PVB.

II. ∑salidas<sub>USU</sub> RT: salidas totales de la red de transporte que ha efectuado el usuario a lo largo del último año móvil.

III. ∑cesiones<sub>USU</sub> PVB: cesiones de gas en el PVB realizadas por el usuario a lo largo del último año móvil.
...
![7](https://www.boe.es/datos/imagenes/disp/2016/188/07563_15239.png)

donde:

a. ∑salidas<sub>USU</sub> RT: salidas totales de la red de transporte que ha efectuado el usuario en el periodo de cálculo, en los días con desbalance negativo.

b. ∑cesiones<sub>USU</sub> PVB: cesiones de gas en el PVB realizadas por el usuario en el periodo de cálculo, en los días con desbalance negativo.

c. ∑entradas<sub>USU</sub> RT: entradas a la red de transporte que ha efectuado el usuario en el periodo de cálculo, en los días con desbalance negativo.

d. ∑adquisiciones<sub>USU</sub> PVB: adquisiciones de gas en el PVB realizadas por el usuario en el periodo de cálculo, en los días con desbalance negativo.

e. En el caso de nuevos usuarios que no dispongan ni de demanda ni de cesión de gas en el PVB en el año móvil anterior,δ<sub>USU</sub> tomará el valor de 0,05.
...
| Servicio | Servicio | Producto | Verano | Invierno |
| --- | --- | --- | --- | --- |
| Servicio | Servicio | Producto | Garantías | Garantías |
| AASS. | AASS. | Anual. | Tf x Qa x FA | Tf x Qa x FA |
| Planta regasificación. | Regasificación. | Anual. | (Tf x Qa + Tv x Qa x 30) x FA | (Tf x Qa + Tv x Qa x 30) x FA |
| Planta regasificación. | Regasificación. | Trimestral. | (Tf x Qa + Tv x Qa x 30) x FT | (2 x Tf x Qa + Tv x Qa x 30) x FT |
| Planta regasificación. | Regasificación. | Mensual. | (Tf x Qa + Tv x Qa x 30) x FM | (2 x Tf x Qa + Tv x Qa x 30) x FM |
| Planta regasificación. | Regasificación. | Diario / intradiario. | (0,06 x Tf x Qa + Tv x Qa) x FD | (0,1 x Tf x Qa + Tv x Qa) x FD |
| Planta regasificación. | Carga de cisternas. | Anual. | (Tf x Qa + (Tv+IEH) x Qa x 30) x FA | (Tf x Qa + (Tv+IEH) x Qa x 30) x FA |
| Planta regasificación. | Carga de cisternas. | Trimestral. | (Tf x Qa + (Tv+IEH) x Qa x 30) x FT | (2 x Tf x Qa + (Tv+IEH) x Qa x 30) x FT |
| Planta regasificación. | Carga de cisternas. | Mensual. | (Tf x Qa + (Tv+IEH)x Qa x 30) x FM | (2 x Tf x Qa + (Tv+IEH) x Qa x 30) x FM |
| Planta regasificación. | Carga de cisternas. | Diario / intradiario. | (0,06 x Tf x Qa + (Tv+IEH) x Qa) x FD | (0,1 x Tf x Qa + (Tv+IEH) x Qa) x FD |
| Planta regasificación. | Descarga de buques. | Diario. | (Tf x n buques + Tv x Qa) x FD | (Tf x n buques + Tv x Qa) x FD |
| Planta regasificación. | Trasvase de GNL (Buque-Buque o Planta-Buque). | Diario. | (Tf x n operación + Tv x Qa) x FD | (Tf x n operación + Tv x Qa) x FD |
| Planta regasificación. | Puesta en frío. | Diario. | (Tf x n operación + Tv x Qa) x FD | (Tf x n operación + Tv x Qa) x FD |
| PVB. | Entrada a transporte y entrada por CI (no intraeuropeas). | Anual. | Tf x Qa x FA | Tf x Qa x FA |
| PVB. | Entrada a transporte y entrada por CI (no intraeuropeas). | Trimestral. | Tf x Qa x FT | 2 x Tf x Qa x FT |
| PVB. | Entrada a transporte y entrada por CI (no intraeuropeas). | Mensual. | Tf x Qa x FM | 2 x Tf x Qa x FM |
| PVB. | Entrada a transporte y entrada por CI (no intraeuropeas). | Diario / intradiario. | 0,06 x Tf x Qa x FD | 0,1 x Tf x Qa x FD |
| PVB. | Salida por CI (no intraeuropeas). | Anual. | (Tf x Qa + Tv x Qa x 30) x FA | (Tf x Qa + Tv x Qa x 30) x FA |
| PVB. | Salida por CI (no intraeuropeas). | Trimestral. | (Tf x Qa + Tv x Qa x 30) x FT | (2 x Tf x Qa + Tv x Qa x 30) x FT |
| PVB. | Salida por CI (no intraeuropeas). | Mensual. | (Tf x Qa + Tv x Qa x 30) x FM | (2 x Tf x Qa + Tv x Qa x 30) x FM |
| PVB. | Salida por CI (no intraeuropeas). | Diario / intradiario. | (0,06 x Tf x Qa + Tv x Qa) x FD | (0,1 x Tf x Qa + Tv x Qa) x FD |
| PVB. | Entrada por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Anual. | (Tf+Prima subasta) x Qa xFA | (Tf+Prima subasta) x Qa xFA |
| PVB. | Entrada por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Trimestral. | (Tf+Prima subasta) x Qa x FT | (2 x Tf + Prima subasta) x Qa x FT |
| PVB. | Entrada por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Mensual. | (Tf+Prima subasta) x Qa x FM | (2 x Tf + Prima subasta) x Qa x FM |
| PVB. | Entrada por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Diario / intradiario. | (0,06 x Tf + Prima subasta) x Qa x FD | (0,1 x Tf + Prima subasta) x Qa x FD |
| PVB. | Salida por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Anual. | (Tf+Prima subasta) x Qa x FA | (Tf+Prima subasta) x Qa x FA |
| PVB. | Salida por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Trimestral. | (Tf+Prima subasta) x Qa x FT | (2 x Tf + Prima subasta) x Qa x FT |
| PVB. | Salida por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Mensual. | (Tf+Prima subasta) x Qa xFM | (2 x Tf + Prima subasta) x Qa x FM |
| PVB. | Salida por CI Intraeuropeas (VIP Pirineos y VIP Portugal). | Diario / intradiario. | (0,06 x Tf + Prima subasta) x Qa x FD | (0,1 x Tf + Prima subasta) x Qa x FD |
| PVB. | Salida por término de conducción. | Anual - Grupo 1, Grupo 2 y Peaje 3.5. | (Tf x Qa + Tv x Qa x 30) x FA | (Tf x Qa + Tv x Qa x 30) x FA |
| PVB. | Salida por término de conducción. | Trimestral - Grupo 1, Grupo 2 y Peaje 3.5. | (Tf x Qa + Tv x Qa x 30) x FT | (2 x Tf x Qa + Tv x Qa x 30) x FT |
| PVB. | Salida por término de conducción. | Mensual - Grupo 1, Grupo 2 y Peaje 3.5. | (Tf x Qa + Tv x Qa x 30) x FM | (2 x Tf x Qa + Tv x Qa x 30) x FM |
| PVB. | Salida por término de conducción. | Diario/intradiario - Grupo 1, Grupo 2 y Peaje 3.5. | (0,06 x Tf x Qa + Tv x Qa) x FD | (0,1 x Tf x Qa + Tv x Qa) x FD |
| PVB. | Salida por término de conducción. | Anual - Peaje 3.1, 3.2, 3.3 y 3.4. | (Tf + Tv x Qm) x NºC x FA | (Tf + Tv x Qm) x NºC x FA |
| PVB. | Salida por término de conducción. | Trimestral - Peaje 3.1, 3.2, 3.3 y 3.4. | (Tf + Tv x Qm) x NºC x FT | (2xTf + Tv x Qm) x NºC x FT |
| PVB. | Salida por término de conducción. | Mensual - Peaje 3.1, 3.2, 3.3 y 3.4. | (Tf + Tv x Qm) x NºC x FM | (2 xTf + Tv x Qm) x NºC x FM |
| MS capacidad. | Tratamiento cesiones de capacidad. | Comprador (sujeto que adquiere capacidad). | Garantía contrato origen x (cantidad diaria comprador / cantidad diaria original vendedor) | Garantía contrato origen x (cantidad diaria comprador / cantidad diaria original vendedor) |
| MS capacidad. | Tratamiento cesiones de capacidad. | Vendedor (sujeto que cede capacidad). | Garantía contrato origen x (cantidad diaria final vendedor / cantidad diaria original vendedor) | Garantía contrato origen x (cantidad diaria final vendedor / cantidad diaria original vendedor) |
...
iii. T<sub>v</sub>: Término variable del peaje o canon o precio resultante de la subasta (si procede).

iv. Q<sub>a</sub>: Caudal del gas natural a facturar o capacidad de almacenamiento contratada
...
> <small>Redactado conforme a la corrección de errores publicada por Resolución de 28 de septiembre de 2016. [Ref. BOE-A-2016-8926](https://www.boe.es/buscar/doc.php?id=BOE-A-2016-8926).</small>
