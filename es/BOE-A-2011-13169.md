...
pdf_url: "https://www.boe.es/boe/dias/2011/07/30/pdfs/BOE-A-2011-13169.pdf"
subjects: ["Administración electrónica", "Administraciones Públicas", "Comunicaciones electrónicas", "Documentos públicos", "Firma electrónica", "Normas de calidad", "Procedimiento administrativo", "Redes de telecomunicación", "Registros telemáticos", "Reglamentaciones técnicas"]
department_code: "9529"
rank_code: "1370"
ambito_code: "1"
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/res/2011/07/19/(3)"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2011-13169"
url_pdf: "https://www.boe.es/boe/dias/2011/07/30/pdfs/BOE-A-2011-13169.pdf"
page_start: "87094"
page_end: "87107"
image_marker: "A"
legislative_status: "L"
alerts: "Derecho Administrativo; Organización de la Administración; Tecnología e investigación; Telecomunicaciones"
references_previous: "DE CONFORMIDAD con BOE-A-2010-1331; DE CONFORMIDAD con BOE-A-2007-12352"
---
...
## ANEXO I. Metadatos mínimos obligatorios del documento electrónico

| Metadato | Descripción/Condiciones de uso | ¿Repetible?<sup>1</sup> | Tipo | Esquema de valores |
| --- | --- | --- | --- | --- |
...
| Identificador | Identificador normalizado del documento. | 1 | Cadena de caracteres | ES_ <Órgano>_<AAAA>_<ID específico><sup>2</sup> Ejemplo: ES E00010207 2010 MPR000000000000000000000010207 |
...
| Tipo documental | Descripción del tipo documental del documento. | 1 | Cadena de caracteres | – Acta. |
| Tipo documental | Descripción del tipo documental del documento. | 1 | Cadena de caracteres | – Certificado. |
|  |  |  |  | – Diligencia. |
...
| Si «Tipo de firma» = CSV | Si «Tipo de firma» = CSV | Si «Tipo de firma» = CSV | Si «Tipo de firma» = CSV | Si «Tipo de firma» = CSV |
...
| Si «Estado de elaboración» = | Si «Estado de elaboración» = | Si «Estado de elaboración» = | Si «Estado de elaboración» = | Si «Estado de elaboración» = |
| – Copia electrónica auténtica con cambio de formato (Ley 11/2007Art.30.1). | – Copia electrónica auténtica con cambio de formato (Ley 11/2007Art.30.1). | – Copia electrónica auténtica con cambio de formato (Ley 11/2007Art.30.1). | – Copia electrónica auténtica con cambio de formato (Ley 11/2007Art.30.1). | – Copia electrónica auténtica con cambio de formato (Ley 11/2007Art.30.1). |
| – Copia electrónica parcial auténtica. | – Copia electrónica parcial auténtica. | – Copia electrónica parcial auténtica. | – Copia electrónica parcial auténtica. | – Copia electrónica parcial auténtica. |
...
> <sup>1</sup> Nótese que la repetibilidad indicada en la tabla sólo se refiere a los metadatos que acompañan al documento electrónico en un intercambio, sin perjuicio de la posibilidad de asignación de otros metadatos gestionados a nivel interno de cada administración cuyas consideraciones atenderán a la Norma Técnica de Interoperabilidad de Política de gestión de documentos electrónicos.

> <sup>2</sup> Codificación del Identificador del documento:
...
## ANEXO II. Esquemas XML para intercambio de documentos electrónicos

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_001.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_002.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_003.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_004.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_005.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_006.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_007.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13169_008.png)
...
| Firma basada en certificados | Información del firmante(s) del documento (persona física, jurídica o sello de órgano). | Propiedades o etiquetas de la firma. |
| Firma basada en certificados | Emisor del certificado del firmante(s). | Propiedades o etiquetas de la firma. |
| Firma basada en certificados | Fecha y hora de la firma(s). | Propiedades o etiquetas de la firma. |
