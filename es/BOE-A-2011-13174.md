...
pdf_url: "https://www.boe.es/boe/dias/2011/07/30/pdfs/BOE-A-2011-13174.pdf"
subjects: ["Administración electrónica", "Administraciones Públicas", "Normas de calidad", "Notificaciones telemáticas", "Procedimiento administrativo", "Redes de telecomunicación", "Registros telemáticos", "Reglamentaciones técnicas"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2011-13174"
...
references_subsequent: "SE DEROGA BOE-A-2021-13749"
...
Téngase en cuenta que la presente Norma Técnica se sustituye por la Norma Técnica de Interoperabilidad de Modelo de Datos para el intercambio de asientos entre las Entidades Registrales (SICRES4), según establece el apartado primero de la Resolución de 22 de julio de 2021. [Ref. BOE-A-2021-13749#pr-2](https://www.boe.es/buscar/doc.php?id=BOE-A-2021-13749)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_001.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_002.png)

### *Tabla 1. Datos de Origen (o Remitente)*

1. Segmento de Origen (o Remitente)

| Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | Segmento de Origen (o Remitente) | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Código Entidad Registral de Origen. | Alfanumérico | 21 | Obligatorio | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Decodificación de Entidad Registral de Origen. | Alfanumérico | 80 | Opcional | Descripción de la Entidad Registral de Origen. | Descripción de la Entidad Registral de Origen. |
| Número de registro de entrada (en Origen). | Alfanumérico | 20 | Obligatorio | Número de registro de entrada en la Entidad Registral Origen. | Número de registro de entrada en la Entidad Registral Origen. |
| Fecha y hora de entrada (en Origen)<sup>2</sup>. | Alfanumérico | 14 | Obligatorio | Formato AAAAMMDDHHMMSS. | Formato AAAAMMDDHHMMSS. |
| Timestamp de entrada. | Alfanumérico | Variable | Opcional | Sello de tiempo del registro de entrada en Origen. | Sello de tiempo del registro de entrada en Origen. |
| Código de la Unidad de Tramitación de Origen | Alfanumérico | 21 | Opcional | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Decodificación de la Unidad de Tramitación Origen. | Alfanumérico | 80 | Opcional | Descripción de la Unidad de Tramitación de Origen. | Descripción de la Unidad de Tramitación de Origen. |

> <sup>2</sup> Corresponde con la fecha y hora de presentación por parte del ciudadano.

### *Tabla 2. Datos de destino*

2. Segmento de destino

| Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | Segmento de destino (o destinatario) | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Código Entidad Registral de destino. | Alfanumérico | 21 | Obligatorio | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Decodificación Entidad Registral de destino. | Alfanumérico | 80 | Opcional | Descripción de Entidad Registral de destino. | Descripción de Entidad Registral de destino. |
| Código de la Unidad de Tramitación de destino. | Alfanumérico | 21 | Opcional | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Decodificación de la Unidad de Tramitación de destino. | Alfanumérico | 80 | Opcional | Descripción de la Unidad de Tramitación de destino. | Descripción de la Unidad de Tramitación de destino. |
...
| Segmento de interesado | Segmento de interesado | Segmento de interesado | Segmento de interesado | Segmento de interesado | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| Segmento de interesado | Segmento de interesado | Segmento de interesado | Segmento de interesado | Segmento de interesado | ☑ Múltiple |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Descripción de identificación de interesado. Tipo. | Alfanumérico | 1 | Opcional | Identificación del interesado: – «N» = NIF. – «C» = CIF. – «P» = Pasaporte. – «E» = Documento de identificación de extranjeros. – «X» = Otros de persona física. – «O» = Código de origen. | Identificación del interesado: – «N» = NIF. – «C» = CIF. – «P» = Pasaporte. – «E» = Documento de identificación de extranjeros. – «X» = Otros de persona física. – «O» = Código de origen. |
| Documento de identificación del interesado. | Alfanumérico | 17 | Opcional | Alfanumérico con sintaxis adecuada en función del campo documento de identificación. | Alfanumérico con sintaxis adecuada en función del campo documento de identificación. |
| Razón social del interesado. | Alfanumérico | 80 | Condicional | Si es persona jurídica. Es necesario que se registre la razón social o el nombre y primer apellido. | Si es persona jurídica. Es necesario que se registre la razón social o el nombre y primer apellido. |
| Nombre del interesado. | Alfanumérico | 30 | Condicional | Texto. Es necesario que se registre la razón social o el nombre y primer apellido. | Texto. Es necesario que se registre la razón social o el nombre y primer apellido. |
| Primer apellido del interesado. | Alfanumérico | 30 | Condicional | Texto. Es necesario que se registre la razón social o el nombre y primer apellido. | Texto. Es necesario que se registre la razón social o el nombre y primer apellido. |
| Segundo apellido del interesado. | Alfanumérico | 30 | Opcional | Identificación del interesado: – «N» = NIF. – «C» = CIF. – «P» = Pasaporte. – «E» = Documento de identificación de extranjeros. – «X» = Otros de persona física. – «O» = Código de origen. | Identificación del interesado: – «N» = NIF. – «C» = CIF. – «P» = Pasaporte. – «E» = Documento de identificación de extranjeros. – «X» = Otros de persona física. – «O» = Código de origen. |
| Documento de identificación del Representante. | Alfanumérico | 17 | Opcional | Alfanumérico con sintaxis adecuada en función del campo Documento de identificación. | Alfanumérico con sintaxis adecuada en función del campo Documento de identificación. |
| Razón social del Representante. | Alfanumérico | 80 | Opcional | Si es persona jurídica. | Si es persona jurídica. |
| Nombre del Representante. | Alfanumérico | 30 | Opcional | Texto. | Texto. |
| Primer apellido del Representante. | Alfanumérico | 30 | Opcional | Texto. | Texto. |
| Segundo apellido del Representante. | Alfanumérico | 30 | Opcional | Texto. | Texto. |
| País del interesado. | Alfanumérico | 4 | Condicional | Atributo según catálogo del INE. | Atributo según catálogo del INE. |
| Provincia del interesado. | Alfanumérico | 2 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Municipio del interesado. | Alfanumérico | 5 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Dirección del interesado. | Alfanumérico | 160 | Condicional | Dirección postal del interesado. | Dirección postal del interesado. |
| Código postal del interesado. | Alfanumérico | 5 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Correo electrónico del interesado. | Alfanumérico | 160 | Opcional | Correo electrónico. | Correo electrónico. |
| Teléfono de contacto del interesado. | Alfanumérico | 20 | Opcional | Teléfono de contacto. | Teléfono de contacto. |
| Dirección electrónica del interesado. | Alfanumérico | 160 | Condicional | En caso de disponer de buzón de notificaciones telemáticas seguras. | En caso de disponer de buzón de notificaciones telemáticas seguras. |
| Canal preferente de notificación del interesado. | Alfanumérico | 2 | Condicional | Canal de preferencia para el contacto de la administración. A fecha de emisión de la norma, los canales habilitados son: – «01» = Dirección postal. – «02» = Dirección electrónica habilitada. – «03» = Comparecencia electrónica. | Canal de preferencia para el contacto de la administración. A fecha de emisión de la norma, los canales habilitados son: – «01» = Dirección postal. – «02» = Dirección electrónica habilitada. – «03» = Comparecencia electrónica. |
| País del Representante. | Alfanumérico | 4 | Condicional | Atributo según catálogo del INE. | Atributo según catálogo del INE. |
| Provincia del Representante. | Alfanumérico | 2 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Municipio del Representante. | Alfanumérico | 5 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Dirección del Representante. | Alfanumérico | 160 | Condicional | Dirección postal del Representante. | Dirección postal del Representante. |
| Código postal del Representante. | Alfanumérico | 5 | Condicional | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). | Atributo según catálogo del anexo de la OM del Padrón (11/7/1997). |
| Correo electrónico del Representante. | Alfanumérico | 160 | Opcional | Correo electrónico del Representante. | Correo electrónico del Representante. |
| Teléfono de contacto del Representante. | Alfanumérico | 20 | Opcional | Teléfono de contacto del Representante. | Teléfono de contacto del Representante. |
| Dirección electrónica del Representante. | Alfanumérico | 160 | Condicional | En caso de disponer de buzón de notificaciones telemáticas seguras. | En caso de disponer de buzón de notificaciones telemáticas seguras. |
| Canal preferente de notificación del Representante. | Alfanumérico | 2 | Condicional | Canal de preferencia para el contacto de la administración. A fecha de emisión de la norma, los canales habilitados son: – «01» = Dirección postal. – «02» = Dirección electrónica habilitada. – «03» = Comparecencia electrónica. | Canal de preferencia para el contacto de la administración. A fecha de emisión de la norma, los canales habilitados son: – «01» = Dirección postal. – «02» = Dirección electrónica habilitada. – «03» = Comparecencia electrónica. |
| Observaciones | Alfanumérico | 160 | Condicional | Observaciones del interesado y/o del Representante. | Observaciones del interesado y/o del Representante. |
...
| Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | Segmento de Asunto | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| «Abstract» o resumen. | Alfanumérico | 240 | Obligatorio | Texto. | Texto. |
...
| Número de expediente. | Alfanumérico | 80 | Opcional | Número del expediente objeto de la tramitación administrativa. | Número del expediente objeto de la tramitación administrativa. |
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_003.png)
...
| Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | ☑ Opcional |
| --- | --- | --- | --- | --- | --- |
| Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | Segmento de Anexo | ☑ Múltiple |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Descripción del fichero anexado. | Alfanumérico | 80 | Obligatorio | Nombre del fichero original. | Nombre del fichero original. |
| Identificador de fichero. | Alfanumérico | 50 | Obligatorio | Se compondrá siguiendo la normalización definida en el apartado VII.2. | Se compondrá siguiendo la normalización definida en el apartado VII.2. |
| Validez del documento<sup>3</sup>. | Alfanumérico | 2 | Opcional | Indica la categoría de autenticidad del documento<sup>4</sup>: – «01» = Copia (el documento adjunto en el proceso de intercambio es una copia del original sin estar cotejada por ningún organismo oficial y, por tanto, sin validez jurídica). – «02» = Copia compulsada (el documento adjunto en el proceso de intercambio es una copia del original y cotejada por un organismo oficial y, por tanto, con validez jurídica). – «03» = Copia original (el documento adjunto en el proceso de intercambio es una copia del documento pero con exactamente la misma validez jurídica que el original). – «04» = Original (el documento adjunto en el proceso de intercambio es original electrónico). | Indica la categoría de autenticidad del documento<sup>4</sup>: – «01» = Copia (el documento adjunto en el proceso de intercambio es una copia del original sin estar cotejada por ningún organismo oficial y, por tanto, sin validez jurídica). – «02» = Copia compulsada (el documento adjunto en el proceso de intercambio es una copia del original y cotejada por un organismo oficial y, por tanto, con validez jurídica). – «03» = Copia original (el documento adjunto en el proceso de intercambio es una copia del documento pero con exactamente la misma validez jurídica que el original). – «04» = Original (el documento adjunto en el proceso de intercambio es original electrónico). |
| Tipo de documento<sup>5</sup>. | Alfanumérico | 2 | Obligatorio | Indica el tipo de documento: – «01» = Formulario (el documento adjunto es un formulario con campos rellenos por el ciudadano remitente). – «02» = Documento adjunto al formulario (además del formulario, otro documento es adjuntado, acompañando al formulario). – «03» = Fichero técnico interno (el documento adjunto es un fichero interno. Por lo general, estos ficheros pueden resultar útiles para la Entidad Registral de destino, pero no son ficheros para presentar directamente a los usuarios de gestión). | Indica el tipo de documento: – «01» = Formulario (el documento adjunto es un formulario con campos rellenos por el ciudadano remitente). – «02» = Documento adjunto al formulario (además del formulario, otro documento es adjuntado, acompañando al formulario). – «03» = Fichero técnico interno (el documento adjunto es un fichero interno. Por lo general, estos ficheros pueden resultar útiles para la Entidad Registral de destino, pero no son ficheros para presentar directamente a los usuarios de gestión). |
| Certificado. | Alfanumérico | Variable | Opcional | Certificado del fichero Anexo (parte pública). | Certificado del fichero Anexo (parte pública). |
| Firma del documento. | Alfanumérico | Variable | Opcional | Firma electrónica del fichero Anexo. | Firma electrónica del fichero Anexo. |
| Timestamp. | Alfanumérico | Variable | Opcional | Sello de tiempo del fichero Anexo. | Sello de tiempo del fichero Anexo. |
| Validación OSCP del certificado. | Alfanumérico | Variable | Opcional | Validación del certificado. | Validación del certificado. |
| Hash. | Alfanumérico | Variable | Obligatorio | Huella binaria del fichero Anexo que garantiza la integridad de los archivos enviados. | Huella binaria del fichero Anexo que garantiza la integridad de los archivos enviados. |
| Tipo MIME. | Alfanumérico | 20 | Opcional | Tipo del fichero Anexo. | Tipo del fichero Anexo. |
| Anexo. | Alfanumérico | Variable | Opcional | Fichero Anexo codificado en Base64. | Fichero Anexo codificado en Base64. |
| Identificador del documento firmado. | Alfanumérico | 50 | Opcional | Si el Anexo es firma de otro documento, se especifica el «identificador de fichero» objeto de la firma. Este campo tomará el valor de sí mismo para indicar que contiene firma embebida. | Si el Anexo es firma de otro documento, se especifica el «identificador de fichero» objeto de la firma. Este campo tomará el valor de sí mismo para indicar que contiene firma embebida. |
| Observaciones. | Alfanumérico | 50 | Opcional | Observaciones del fichero adjunto. | Observaciones del fichero adjunto. |

> <sup>3</sup> Permite indicar la validez del documento anexado. La validez del documento es la categoría de autenticidad y validez jurídica del documento adjunto durante el proceso de intercambio

> <sup>4</sup> El tipo de copia puede tener que adaptarse conforme a los esquemas de valores de la NTI de Documento electrónico una vez aprobada.

> <sup>5</sup> El tipo del documento es la categoría en cuanto a la forma que toma el documento adjunto durante el proceso de intercambio

### *Tabla 6. Datos de Internos y Control*

6. Segmento de Internos y Control

| Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | Segmento de Internos y Control | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Tipo de transporte de entrada. | Alfanumérico | 2 | Opcional | Formas de llegada al registro de entrada. – «01» = Servicio de Mensajeros. – «02» = Correo postal. – «03» = Correo postal certificado. – «04» = Burofax. – «05» = En mano. – «06» = Fax. – «07» = Otros. | Formas de llegada al registro de entrada. – «01» = Servicio de Mensajeros. – «02» = Correo postal. – «03» = Correo postal certificado. – «04» = Burofax. – «05» = En mano. – «06» = Fax. – «07» = Otros. |
| Número de transporte de entrada. | Alfanumérico | 20 | Opcional | Referencia del transporte. Código. En el caso de certificados, número del mismo. | Referencia del transporte. Código. En el caso de certificados, número del mismo. |
| Nombre de usuario. | Alfanumérico | 80 | Opcional | Nombre de usuario de Origen. | Nombre de usuario de Origen. |
...
| Identificador de intercambio. | Alfanumérico | 33 | Obligatorio | Identificador de intercambio único de la operación. Se compondrá siguiendo la normalización definida en el apartado VII.1. | Identificador de intercambio único de la operación. Se compondrá siguiendo la normalización definida en el apartado VII.1. |
| Aplicación y versión emisora. | Alfanumérico | 4 | Opcional | Identifica la aplicación y su versión. | Identifica la aplicación y su versión. |
| Tipo de Anotación. | Alfanumérico | 2 | Obligatorio | Indica el motivo de la anotación (siguiendo la normalización definida en el aparado V.2). Los únicos valores posibles para el mensaje de datos de intercambio son: – «01» = Pendiente (sin identificador de intercambio). – «02» = Envío. – «03» = Reenvío. – «04» = Rechazo. | Indica el motivo de la anotación (siguiendo la normalización definida en el aparado V.2). Los únicos valores posibles para el mensaje de datos de intercambio son: – «01» = Pendiente (sin identificador de intercambio). – «02» = Envío. – «03» = Reenvío. – «04» = Rechazo. |
| Descripción del Tipo de Anotación. | Alfanumérico | 80 | Opcional | Descripción del tipo de Anotación. | Descripción del tipo de Anotación. |
| Tipo de Registro. | Alfanumérico | 1 | Obligatorio | – «0» = Registro de entrada. – «1» = Registro de salida. | – «0» = Registro de entrada. – «1» = Registro de salida. |
...
| Observaciones del apunte. | Alfanumérico | 50 | Opcional | Observadores del registro de datos de intercambio recogidos por el funcionario de registro. | Observadores del registro de datos de intercambio recogidos por el funcionario de registro. |
| Indicador de pruebas. | Número | 1 | Obligatorio | Indica si el asiento registral es una prueba: – «0» = Normal. – «1» = Prueba. | Indica si el asiento registral es una prueba: – «0» = Normal. – «1» = Prueba. |
| Código Entidad Registral de inicio. | Alfanumérico | 21 | Obligatorio | Código único de la Entidad Registral de inicio obtenido del Directorio Común. | Código único de la Entidad Registral de inicio obtenido del Directorio Común. |
| Decodificación Entidad Registral de inicio. | Alfanumérico | 80 | Opcional | Descripción de la Entidad Registral de inicio. | Descripción de la Entidad Registral de inicio. |
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_004.png)
...
| Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | ☑ Opcional |
| --- | --- | --- | --- | --- | --- |
| Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | Segmento de Formulario Genérico | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Expone. | Alfanumérico | 4.000 | Obligatorio | Exposición de los hechos y antecedentes relacionados con la solicitud. | Exposición de los hechos y antecedentes relacionados con la solicitud. |
| Solicita. | Alfanumérico | 4.000 | Obligatorio | Descripción del objeto de la solicitud. | Descripción del objeto de la solicitud. |
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_005.png)
...
| De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | ☑ Obligatorio |
| --- | --- | --- | --- | --- | --- |
| De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | De Mensaje de Control | ☑ Único |
| SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 | SICRES 3.0 |
| Descripción | Tipo | Longitud | Obligación | Comentarios | Comentarios |
| Código Entidad Registral de Origen. | Alfanumérico | 21 | Obligatorio | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Código Entidad Registral de destino. | Alfanumérico | 21 | Obligatorio | Código único obtenido del Directorio Común. | Código único obtenido del Directorio Común. |
| Identificador de intercambio. | Alfanumérico | 33 | Obligatorio | Identificador de intercambio único de la operación. Se compondrá siguiendo la normalización en el apartado VII.1. | Identificador de intercambio único de la operación. Se compondrá siguiendo la normalización en el apartado VII.1. |
| Tipo de mensaje. | Alfanumérico | 2 | Obligatorio | Indica el tipo de mensaje (siguiendo la normalización definida en el apartado V.3). Los valores que el tipo de mensaje de control puede tomar son: – «01» = ACK (acepción). – «02» = Error. – «01» = Confirmación. | Indica el tipo de mensaje (siguiendo la normalización definida en el apartado V.3). Los valores que el tipo de mensaje de control puede tomar son: – «01» = ACK (acepción). – «02» = Error. – «01» = Confirmación. |
...
| Fecha y hora de entrada en destino. | Alfanumérico | 14 | Opcional | Formato AAAAMMDDHHMMSS. | Formato AAAAMMDDHHMMSS. |
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_006.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_007.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_008.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_009.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_010.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_011.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_012.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_013.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_014.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_015.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_016.png)
...
![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_017.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_018.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_019.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_020.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_021.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_022.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_023.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_024.png)

# Esquema XML del mensaje de datos de intercambio

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_025.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_026.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_027.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_028.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_029.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_030.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_031.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_032.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_033.png)

# Representación gráfica del esquema del mensaje de control

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_034.png)

# Esquema XML del mensaje de control

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_035.png)

![](https://www.boe.es/datos/imagenes/disp/2011/182/13174_036.png)
