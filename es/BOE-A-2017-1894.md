---
title: "Circular 2/2017, de 8 de febrero, de la Comisión Nacional de los Mercados y la Competencia, por la que se regulan los procedimientos de constitución, gestión y reparto del fondo de pagos compensatorios del mecanismo de fomento del uso de biocarburantes y otros combustibles renovables con fines de transporte"
identifier: "BOE-A-2017-1894"
country: "es"
rank: "circular"
publication_date: "2017-02-24"
last_updated: "2017-02-24"
status: "in_force"
source: "https://www.boe.es/eli/es/cir/2017/02/08/2"
department: "Comisión Nacional de los Mercados y la Competencia"
pdf_url: "https://www.boe.es/boe/dias/2017/02/24/pdfs/BOE-A-2017-1894.pdf"
subjects: ["Carburantes y combustibles", "Certificaciones", "Comercialización", "Comisión Nacional de los Mercados y la Competencia", "Pagos", "Políticas de medio ambiente", "Productos petrolíferos", "Transportes"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/cir/2017/02/08/2"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2017-1894"
url_pdf: "https://www.boe.es/boe/dias/2017/02/24/pdfs/BOE-A-2017-1894.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2017-1894"
page_start: "12979"
page_end: "12984"
image_marker: "A"
legislative_status: "L"
alerts: "Energía; Medio ambiente; Sistema financiero"
references_previous: "DEROGA BOE-A-2012-10989; DE CONFORMIDAD con BOE-A-2015-13208; DE CONFORMIDAD con BOE-A-2008-16487"
references_subsequent: "SE MODIFICA BOE-A-2020-7796"
...
### PC<sub>in</sub> = α<sub>T</sub> × DT<sub>in</sub>

Donde:

PC<sub>in</sub> es el importe del pago compensatorio, expresado en euros, a realizar por el sujeto obligado i-ésimo en el año n.

α<sub>T</sub>es un valor de 763 €/certificado.

DT<sub>in</sub> es el déficit de certificados de biocarburantes para el sujeto í-ésimo en el año n de acuerdo a la siguiente fórmula:

### DT<sub>in</sub> = max {0, OB<sub>in ×</sub> (D<sub>in</sub>+G<sub>in</sub>) – CBD<sub>in</sub> – CBG<sub>in</sub>}

Donde:

OB<sub>in</sub> indica el objetivo obligatorio mínimo de venta o consumos de biocarburantes que deberá ser acreditado por el sujeto obligado i-ésimo en el año n.

CBD<sub>in</sub> es la cantidad de certificados de biocarburantes en diésel del año n que sean titularidad del sujeto obligado i-ésimo.

CBG<sub>in</sub> es la cantidad de certificados de biocarburantes en gasolina del año n que sean titularidad del sujeto obligado i-ésimo.

D<sub>in</sub> es la cantidad de gasóleo de automoción vendida o consumida por el sujeto obligado i-ésimo en el año n, expresada en toneladas equivalentes de petróleo (tep). Esta cantidad incluirá las mezclas de biocarburantes con gasóleo de origen fósil, así como las cantidades de biocarburantes puros susceptibles de ser mezclados con gasóleo de automoción.

G<sub>in</sub> es la cantidad de gasolinas vendidas o consumidas por el sujeto obligado i-ésimo en el año n, expresada en toneladas equivalentes de petróleo (tep). Esta cantidad incluirá las mezclas de biocarburantes con gasolinas de origen fósil, así como las cantidades de biocarburantes puros susceptibles de ser mezclados con gasolinas.
...
4. El importe de α<sub>T</sub> se entenderá automáticamente actualizado sin necesidad de modificación de esta Circular, desde la entrada en vigor de un nuevo valor que, en su caso, pudiera aprobar la Secretaría de Estado de Energía, de conformidad con lo previsto en el apartado 4 del artículo 11 de la Orden ITC/2877/2008.
...
### PFC<sub>in</sub> = β × ET<sub>in</sub>

Donde:

PFC<sub>in</sub> es el pago con cargo al fondo de pagos compensatorios del sujeto obligado i-ésimo en el año n.

β es un valor máximo de 763 €/certificado.

ET<sub>in</sub> es el exceso de certificados de biocarburantes para el sujeto í-ésimo en el año n en relación al objetivo obligatorio mínimo anual de biocarburantes que se calculará de acuerdo a la siguiente fórmula:

### ET<sub>in</sub> = max {0, (CBD<sub>in</sub> +CBG<sub>in</sub>) - OB<sub>in</sub>× (D<sub>in</sub> + G<sub>in</sub>)}
...
5. En ningún caso el importe total del reparto del fondo compensatorio de un ejercicio podrá exceder el importe unitario máximo β establecido en 763 € por certificado, o el valor que lo sustituya, de acuerdo con lo previsto en el apartado 4 del artículo 11 de la Orden ITC/2877/2008.

6. Si el ingreso en concepto de pagos compensatorios por el déficit de certificados del año natural anterior se realizara por el sujeto obligado entre el 1 de agosto y el 31 de diciembre de cada año, *éste*pasará a dotar el fondo compensatorio junto con sus correspondientes intereses de demora.
...
### (CBD<sub>in</sub> + CBG<sub>in</sub>) ≥ 0,5 × OB<sub>in</sub> × (D<sub>in</sub> + G<sub>in</sub>)
