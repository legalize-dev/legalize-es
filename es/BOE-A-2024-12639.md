...
pdf_url: "https://www.boe.es/boe/dias/2024/06/22/pdfs/BOE-A-2024-12639.pdf"
subjects: ["Consumidores y usuarios", "Dirección General de Ordenación del Juego", "Formularios administrativos", "Informática", "Internet", "Juego", "Protección de datos personales", "Registros administrativos", "Reglamentaciones técnicas"]
...
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2024-12639"
url_pdf: "https://www.boe.es/boe/dias/2024/06/22/pdfs/BOE-A-2024-12639.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2024-12639"
page_start: "72281"
page_end: "72360"
image_marker: "A"
legislative_status: "L"
alerts: "Consumidores y usuarios; Cultura y ocio; Derecho Administrativo; Tecnología e investigación"
references_previous: "MODIFICA BOE-A-2014-10302; MODIFICA BOE-A-2012-9658; DE CONFORMIDAD con BOE-A-2023-6735; CITA BOE-A-2011-9280"
---
...
| Tipo de operador | Registro de Usuarios | Cuenta de Juego | Cuenta de Operador | Cuenta de Botes y Partidas Vivas | Registro de Juego | Ajustes de Apuestas | Catálogo de Eventos |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Tipo de operador | Tipo de registro | Tipo de registro | Tipo de registro | Tipo de registro | Tipo de registro | Tipo de registro | Tipo de registro |
...
| Periodicidad | RUD | RUT | RUR | RUG | CJD/CJT | OPT/ORT | BOT | JUC | JUA | CEV |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Periodicidad | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro | Tipo de Registro |
| Tiempo real. | – | – | – | – | – | – | – | √ | – | – |
| Diaria. | √ | – | – | – | √ | – | – | – | – | √ |
| Mensual. | √ | √ | √ | √ | √ | √ | √ | – | √ | √ |
...
| TipoVDocumental. | Tipo y fecha de la primera verificación documental positiva. Campo opcional, solo es obligatorio si VDocumental =«S». ![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_6.png) Tipo, es el modo en que se ha realizado la verificación documental. Detalle en el apartado «Listas y enumerados». Si el Tipo seleccionado no está en la lista y se selecciona OTR hay que rellenar el campo OtroEspecificar con los datos del Tipo de Verificación Documental utilizado. |
...
| Cuentas. | Desglose del saldo final, para cada una de las cuentas de juego que puede tener el mismo jugador: ![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_8.png) Cuenta es el identificador de la cuenta de juego en la plataforma. |
...
| DesgloseCruzadas. | Campo obligatorio en los juegos de tipo ADX y AOX. Se deberá indicar si se trata de un reto o no. Se considera que hay un reto cuando el apostante conoce a la persona contra la que está apostando. Se reportará cada cruce que se ha realizado sobre un Hecho, y de cada uno de dichos cruces: – Reto: «S» si es cruce de tipo «Reto», en el que los apostantes conocen los identificadores del resto de jugadores. – Ticket: lista de tickets asociados a cada cruce separados por comas. – LayBack: tipo de apuesta de cada uno de los tickets (Lay/Back). ![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_14.png) |
...
| 17 | Fútbol. |
| 37 | Squash. |
| 999 OtroCodigoEspecificar: Sumo | Sumo (no estaba incluido en el catálogo). |
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_15.png)
...
| Cabecera del registro (tipo RegistroCabecera): | Cabecera del registro (tipo RegistroCabecera): |
| --- | --- |
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_16.png)
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_17.png)
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_18.png)
...
| --- | --- |
| Cabecera del lote (tipo LoteCabecera): | Cabecera del lote (tipo LoteCabecera): |
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_19.png)

DesgloseTipoJuego.

Importe total y desglose por tipo de juego.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_20.png)

DesgloseConcepto.

Importe total y desglose por concepto.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_21.png)

DesgloseConceptoOP.

Importe total y desglose por operador y concepto.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_22.png)

DesgloseConceptoBonosT.

Importe total y desglose por concepto de bonos (CONCESION, LIBERACION Y CANCELACION) totalizado.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_23.png)

DesgloseConceptoBonosD.

Importe total y desglose por concepto de bonos (CONCESION, LIBERACION Y CANCELACION) con detalle.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_24.png)

DesgloseBotes.

Importe total y desglose por operador.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_25.png)

DesgloseBotesId.

Importe total y desglose por bote.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_26.png)

DesgloseMedioPagoT.

Importe total y desglose por medio y tipo de pago, totalizada.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_27.png)

DesgloseMedioPagoD.

Importe total y desglose de cada una de las operaciones de depósito o retirada de efectivo desglosada.

![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_28.png)
...
![](https://www.boe.es/datos/imagenes/disp/2024/151/12639_14531753_29.png)

Ejemplo: Forma correcta de Jugador sin depósito.

```
<Depositos> <Total>0</Total>
</Depositos>
```
