...
*D*<sub>T</sub>*:* Desvíos en retribución e ingresos previstos de ejercicios anteriores correspondientes a la actividad de transporte.

El desvío de retribuciones e ingresos de ejercicios anteriores *(D*<sub>T</sub>*)* se calculará conforme a la siguiente fórmula:

### *D*<sub>T</sub> = *DR*<sub>T</sub> ± *DIC*<sub>T</sub> + *DTSO*
...
### *D*<sub>D</sub> = *DR*<sub>D</sub> ± *DIC*<sub>D</sub>
