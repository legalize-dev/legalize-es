---
title: "Orden ETU/995/2017, de 6 de octubre, por la que se aprueban instrucciones técnicas complementarias del capítulo IX \"Electricidad\" del Reglamento General de Normas Básicas de Seguridad Minera"
identifier: "BOE-A-2017-11908"
country: "es"
rank: "orden"
publication_date: "2017-10-17"
last_updated: "2017-10-17"
status: "in_force"
source: "https://www.boe.es/eli/es/o/2017/10/06/etu995"
department: "Ministerio de Energía, Turismo y Agenda Digital"
pdf_url: "https://www.boe.es/boe/dias/2017/10/17/pdfs/BOE-A-2017-11908.pdf"
subjects: ["Electricidad", "Minas", "Reglamentaciones técnicas", "Seguridad e higiene en el trabajo", "Seguridad industrial"]
department_code: "9282"
rank_code: "1350"
ambito_code: "1"
official_number: "ETU/995/2017"
enactment_date: "2017-10-06"
official_journal: "Boletín Oficial del Estado"
journal_issue: "250"
consolidation_status: "Finalizado"
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2017/10/06/etu995"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2017-11908"
url_pdf: "https://www.boe.es/boe/dias/2017/10/17/pdfs/BOE-A-2017-11908.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2017-11908"
page_start: "100676"
page_end: "100713"
image_marker: "A"
legislative_status: "L"
alerts: "Industria; Tecnología e investigación; Trabajo y empleo"
references_previous: "DE CONFORMIDAD con BOE-A-1985-10836; CITA BOE-A-2016-3539; CITA BOE-A-1986-8940; CITA BOE-A-1985-20808"
---
...
## IET-ITC 09.0.01. Instalaciones eléctricas en minas y actividades reglamentariamente afines. Terminología
...
3.32 Tensión de contacto límite convencional (U<sub>L</sub>): Valor máximo de la tensión de contacto que puede mantenerse indefinidamente en las condiciones específicas de las influencias externas.
...
## IET-ITC-09.0.02. Instalaciones eléctricas en minas y actividades reglamentariamente afines. Prescripciones técnicas comunes a todas las instalaciones
...
| --- | --- | --- |
| Muy baja tensión | U<sub>n</sub>≤ 50 V | U<sub>n</sub>≤ 75 V |
| Baja tensión | 50 V < U<sub>n</sub> ≤ 1.000 V | 75 V < U<sub>n</sub> ≤ 1.500 V |
| Alta tensión | U<sub>n</sub> > 1.000 V | U<sub>n</sub> > 1.500 V |
...
4.2 Dispositivo de corte automático: Un dispositivo de protección cortará automáticamente la alimentación de la parte de la instalación protegida por este dispositivo si, como consecuencia de un defecto en esa parte, la tensión de contacto alcanza, en algún punto de la instalación, un valor superior a la tensión de contacto límite convencional U<sub>L</sub>, para la cual se fijan los valores límites siguientes:

a) U<sub>L</sub>= 50 V (Valor eficaz) para emplazamientos no conductores.

b) U<sub>L</sub>= 24 V (Valor eficaz) para emplazamientos conductores.
...
![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7304.png)

Esta prescripción se considera satisfecha si se cumple que:

### Z<sub>s</sub>× I<sub>a</sub> ≤ U<sub>0</sub>

donde:

Z<sub>s</sub> = impedancia del bucle de defecto.

I<sub>a</sub> = corriente que asegura el funcionamiento del dispositivo de corte en el tiempo asignado en las tablas 2 o 3.

U<sub>0</sub> = tensión entre fase y neutro.
...
4.5.4 Equilibrio de la tensión: Para sistemas TN-S en baja tensión en los que pueda producirse un defecto directo entre fase y tierra (por ejemplo, con líneas aéreas) debe cumplirse la condición siguiente con objeto de impedir que el conductor de protección, o cualquier parte que esté unida a él, alcance una tensión, con relación a la tierra, superior a U<sub>L</sub>, salvo que el proyecto justifique la imposibilidad de que se produzca el defecto.

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7351.png)

donde:

R<sub>B</sub> = Resistencia total de puesta a tierra.

R<sub>E</sub>= La más baja resistencia prevista de puesta a tierra de masas no unidas al conductor de protección, en todos los casos donde aparezca un defecto a tierra de un conductor de fase.

U<sub>0</sub> = Tensión entre fase y neutro.

U<sub>L</sub> = Tensión de contacto límite convencional.
...
I<sub>a</sub> = Intensidad de la corriente que garantiza el funcionamiento automático del dispositivo de protección en el tiempo asignado en las tablas 2 y 3.

U<sub>L</sub> = Tensión de contacto límite convencional (50 V o 24 V).

R<sub>A</sub> = Suma de las resistencias de las puestas a tierra y de los conductores de protección de las masas.

### Figura 2 . Bucle de defecto en red con esquema TT

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7393.png)
...
4.7.1 De carácter general: En los esquemas IT, la instalación debe estar aislada de tierra o bien conectada a tierra a través de una impedancia cuyo valor, justificado por medio de cálculo, garantice que ante un defecto franco la tensión límite convencional U<sub>L</sub> no es sobrepasada y las masas se conectan a una o varias puestas a tierra, individualmente, en grupos o en conjunto.

Cuando la corriente de defecto, en el caso de un solo defecto a masa, es de un valor suficientemente bajo, y la tensión límite convencional U<sub>L</sub> no es sobrepasada, el corte de la alimentación no es obligatorio (véase apartado 4.7.5). Deben tomarse medidas con el fin de evitar todo riesgo peligroso para una persona en contacto con partes conductoras simultáneamente accesibles, en caso de que ocurran dos defectos simultáneos (fase-tierra o fase-fase).

4.7.2 Aislamiento o puesta a tierra de la instalación: En este caso el punto neutro de la alimentación, si está montada en estrella, será el que se conecta a tierra a través de la impedancia, o un punto neutro artificial que puede conectarse directamente a tierra, si la impedancia resultante de la constitución de este neutro artificial tiene un valor, justificado por medio de cálculo, que garantiza que ante un defecto franco la tensión límite convencional U<sub>L</sub> no es sobrepasada.
...
En este caso la resistencia total a tierra R<sub>A</sub> de todas las masas conectadas a una toma de tierra y del conductor de protección correspondiente debe responder a la condición siguiente:
...
R<sub>A</sub>= Suma de las resistencias de la toma de tierra y de los conductores de protección de las masas.

### Figura 3. Defecto a tierra en red con esquema IT con alimentación aislada de tierra

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7438.png)
...
![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7532.png)
...
La elevación de potencial de la masa, suma de la caída de tensión en el conductor de protección distribuido y la caída de tensión en la resistencia de toma de tierra del transformador R<sub>N</sub>.

### ∆UR<sub>CP</sub> + ∆UR<sub>N</sub> ≤ U<sub>L</sub>

donde:

∆UR<sub>CP</sub> = Caída de tensión en el conductor de protección.

∆UR<sub>N</sub> = Caída de tensión en la resistencia de toma de tierra de la alimentación.

U<sub>L</sub> = Tensión de contacto límite convencional (50 V o 24 V).

### Figura 5. Defecto a tierra en red con esquema IT con neutro impedante y puesta a tierra de alimentación y masas común

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7573.png)
...
Si la tensión de contacto excede de la tensión límite convencional U<sub>L</sub>, el dispositivo de protección debe desconectar la alimentación del circuito, de acuerdo con el apartado 4.3.

Si la tensión de contacto no excede de la tensión límite convencional U<sub>L</sub> y si las condiciones siguientes se cumplen, no es obligatorio desconectar la alimentación:
...
2.º Las longitudes *l*<sub>1</sub> y *l*<sub>2</sub> (véase la figura 6) de los conductores de sección *S*<sub>1</sub>y *S*<sub>2</sub>, respectivamente, estarán en la relación:

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7679.png)

donde:

*L*<sub>1</sub> (*), expresa la máxima longitud del conductor de sección *S*<sub>1</sub> protegido contra cortocircuitos por un dispositivo de protección situado en el punto M.

*L*<sub>2</sub> (*), expresa la máxima longitud del conductor de sección *S*<sub>2</sub> protegido contra cortocircuitos por un dispositivo de protección situado en el punto M.

*l*<sub>1</sub>y *l*<sub>2</sub>,longitudes de cable de sección *S*<sub>1</sub>y*S*<sub>2</sub> respectivamente que cumplen con la mencionada relación.

> (*) Las longitudes *L*<sub>1</sub>y *L*<sub>2</sub>deben determinarse por medios apropiados, teniendo en cuenta la tensión de la red, la impedancia de la fuente y los parámetros del conductor y del dispositivo de protección.
...
### Figura 6. Esquema representativo de las longitudes máximas de cable de sección S<sub>1</sub>y/o S<sub>2</sub>protegidas por un dispositivo de protección

![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7808.png)
...
![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7852.png)
...
I<sub>N</sub>= Intensidad nominal o de regulación.
...
| Función | Clase E | Clase B | Clase F | Clase H |
| --- | --- | --- | --- | --- |
| Función | Aislamiento/Temperatura | Aislamiento/Temperatura | Aislamiento/Temperatura | Aislamiento/Temperatura |
...
1.º En ningún momento habrá piezas accesibles con tensión superior a la U<sub>L</sub>.
...
![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7945.png)

> * En esta fórmula se ha tomado como valor de la intensidad de corriente que descompone el agua C<sub>i</sub>/50 y se ha considerado que, al cabo de una hora sin ventilación, la concentración de hidrógeno en la sala alcanza el 1%, valor igual al hidrógeno existente más el desprendido por las baterías durante la hora mencionada.
...
![1](https://www.boe.es/datos/imagenes/disp/2017/250/11908_7992.png)

> * En esta fórmula se ha tomado como valor de la intensidad de corriente que descompone el agua C<sub>i</sub> /20 y se considera el hidrógeno diluido al 1 por 1.000 en la corriente de ventilación.
...
## IET-ITC-09.0.03. Instalaciones eléctricas en minas y actividades reglamentariamente afines. Prescripciones técnicas para las instalaciones en labores subterráneas
...
| --- | --- | --- |
| Muy baja tensión | U<sub>n</sub>≤ 50 V | U<sub>n</sub>≤ 75 V |
| Baja tensión | 50 V < U<sub>n</sub> ≤ 1.100 V | 75 V < U<sub>n</sub> ≤ 1.500 V |
| Alta tensión | U<sub>n</sub> > 1.100 V | U<sub>n</sub> > 1.500 V |
...
La sección mínima del conductor de protección, instalado de forma independiente de los cables o canalizaciones, será de 35 mm<sup>2</sup>, si es de cobre, o de 100 mm<sup>2</sup> si es de acero. Se instalará de forma que se evite el contacto por error o por avería con un conductor activo.
...
Los conductores de alimentación de las luminarias tendrán una sección mínima de 2,5 mm<sup>2</sup> y su aislamiento será compatible con las temperaturas de servicio, generadas en los recintos de conexión.
