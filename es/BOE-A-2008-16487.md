...
Norma derogada, con efectos de 17 de julio de 2024, por la disposición derogatoria única de la Orden TED/728/2024, de 15 de julio. [Ref. BOE-A-2024-14545#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2024-14545)
...
### PFC<sub>in</sub> = EG<sub>in</sub> • α<sub>G</sub> + ED<sub>in</sub> • α<sub>D</sub> + ET<sub>in</sub> • α<sub>T</sub>

Donde:

PFC<sub>in</sub>, es el pago con cargo al fondo de pagos compensatorios del sujeto obligado i-ésimo en el año n.

EG<sub>in</sub>, ED<sub>in</sub> y ET<sub>in</sub> son los excesos de biocarburantes en relación a los objetivos de gasolinas, gasóleos y global para el sujeto í-ésimo en el año n en relación a los objetivos de biocarburantes en gasolinas y gasóleos, que se calculará de acuerdo a las fórmulas siguientes:

| { | EG<sub>in</sub> = max {0, CBG<sub>in</sub> – [OB<sub>in</sub> • (D<sub>in</sub> + G<sub>in</sub>) – OBD<sub>in</sub> • D<sub>in</sub>]} |
| --- | --- |
| { | ED<sub>in</sub> = max {0, CBD<sub>in</sub> – [OB<sub>in</sub> • (D<sub>in</sub> + G<sub>in</sub>) – OBG<sub>in</sub> • G<sub>in</sub>]} |
| { | ET<sub>in</sub> = max {0, CBG<sub>in</sub> + CBD<sub>in</sub> – OB<sub>in</sub> • (D<sub>in</sub>+ G<sub>in</sub>) – EG<sub>in</sub> – ED<sub>in</sub>]} |
...
| { | CBG<sub>in</sub> ≥ 0,7 • OBG<sub>in</sub> • G<sub>in</sub> |
| --- | --- |
| { | CBD<sub>in</sub> ≥ 0,7 • OBD<sub>in</sub> • D<sub>in</sub> |
...
En relación con la sostenibilidad de los biocarburantes, los sujetos obligados habrán de remitir la citada información agregada por cada tipo de biocarburante, con indicación de la instalación de almacenamiento o fábrica desde la que el producto se ha puesto en el mercado y alternativa utilizada para la acreditación de los criterios de sostenibilidad, expresada en m<sup>3</sup> a 15 ºC.
...
> <small>Se añade por el art. único de la Orden TED/302/2021, de 29 de marzo. [Ref. BOE-A-2021-5035](https://www.boe.es/buscar/doc.php?id=BOE-A-2021-5035)</small>
...
## ANEXO. Cálculo de las toneladas equivalentes de petróleo de diferentes biocarburantes
