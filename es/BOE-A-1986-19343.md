...
| Clase de semilla a producir | Tamaño de parcelas (mínimo) – Ha | Aislamiento (mínimo) – m | Plantas fuera de tipo (máximo) | Plantas fuera de tipo (máximo) | Parentales femeninos emitiendo polen (máximo) | Mazorcas fuera de tipo y con granos fuera de tipo (máximo) |
| --- | --- | --- | --- | --- | --- | --- |
| Clase de semilla a producir | Tamaño de parcelas (mínimo) – Ha | Aislamiento (mínimo) – m | Parentales femeninos después de las depuraciones | Parentales masculinos que hayan emitido polen | Parentales femeninos emitiendo polen (máximo) | Mazorcas fuera de tipo y con granos fuera de tipo (máximo) |
...
| Material parental en caso de variedades fecun. libre. | – | 300 | 1 por 1.000 fuera de tipo | 1 por 1.000 fuera de tipo | – | 1 por 1.000 fuera de tipo. |
| S. base en caso de var. fecund. libre. | – | 300 | 2 por 1.000 fuera de tipo | 2 por 1.000 fuera de tipo | – | 1 por 1.000 fuera de tipo. |
...
| b) Var. de fecundación libre. | 5 | 220 | 5 por 1.000 fuera de tipo | 5 por 1.000 fuera de tipo | – | – |
| S. cert. en var. de fecundación libre. | 5 | 220 | 5 por 1.000 fuera de tipo | 5 por 1.000 fuera de tipo | – | – |
