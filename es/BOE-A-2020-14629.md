---
title: "Orden TED/1079/2020, de 11 de noviembre, por la que se establecen las bases reguladoras para la concesión de ayudas a la prevención de riesgos y seguridad minera en el ámbito de una minería autóctona y sostenible"
identifier: "BOE-A-2020-14629"
country: "es"
rank: "orden"
publication_date: "2020-11-20"
last_updated: "2020-11-20"
status: "expired"
source: "https://www.boe.es/eli/es/o/2020/11/11/ted1079"
department: "Ministerio para la Transición Ecológica y el Reto Demográfico"
pdf_url: "https://www.boe.es/boe/dias/2020/11/20/pdfs/BOE-A-2020-14629.pdf"
subjects: ["Asociaciones", "Asociaciones empresariales", "Ayudas", "Cámaras Oficiales Mineras", "Centros tecnológicos", "Colegios Profesionales", "Empresas", "Formación profesional", "Ingenieros de Minas", "Inversiones", "Minas", "Pequeña y Mediana Empresa", "Secretaría de Estado de Energía", "Seguridad e higiene en el trabajo", "Sindicatos", "Subvenciones"]
department_code: "9575"
rank_code: "1350"
ambito_code: "1"
official_number: "TED/1079/2020"
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/2020/11/11/ted1079"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2020-14629"
url_pdf: "https://www.boe.es/boe/dias/2020/11/20/pdfs/BOE-A-2020-14629.pdf"
page_start: "102877"
page_end: "102899"
image_marker: "A"
legislative_status: "L"
alerts: "Industria; Trabajo y empleo"
references_previous: "DEROGA BOE-A-2015-11697; DE CONFORMIDAD con BOE-A-2003-20977"
---
...
| De | A | Intervalo de minoración (en % de cuantía justificada) |
| --- | --- | --- |
| Intervalo de tasa de incumplimiento (desviación en puntos) | Intervalo de tasa de incumplimiento (desviación en puntos) | Intervalo de minoración (en % de cuantía justificada) |
| 0,00 | 10,00 | 0 % |
| 10,01 | 15,00 | 5 % |
| 15,01 | 20,00 | 10 % |
| 20,01 | 25,00 | 20 % |
...
| Explotación. | Sostenimiento de túneles y galerías. Mejoras generales y de dimensionamiento. | 25 |
| Explotación. | Acondicionamiento de zonas abandonadas que puedan suponer un riesgo para las personas y/o el medio ambiente. | 15 |
| Explotación. | Sostenimiento. Instalación de sistemas de control geotécnico. | 15 |
| Explotación. | Reacondicionamiento/nuevos accesos y asfaltado de viales. | 5 |
| Maquinaria minera móvil. | Sustitución de maquinaria peligrosa. | 25 |
| Maquinaria minera móvil. | Adaptación a los requisitos de seguridad aplicables (elementos de seguridad). | 15 |
| Maquinaria minera móvil. | Nuevas instalaciones para el mantenimiento de la maquinaria. | 5 |
| Establecimientos de beneficio. Cintas transportadoras y molinos. | Sustitución de equipos e instalaciones peligrosas. | 25 |
| Establecimientos de beneficio. Cintas transportadoras y molinos. | Adaptación a los requisitos de seguridad (sistemas antiatrapamiento, paradas de emergencia, elementos de seguridad, etc.). | 15 |
...
| Establecimientos de beneficio. Otras instalaciones y equipos de trabajo. | Sistemas de protección colectiva (sistemas de acceso, plataformas, barandillas, pasamanos, escalas, escaleras, líneas de vida, etc.). | 10 |
| Establecimientos de beneficio. Otras instalaciones y equipos de trabajo. | Nuevos equipos de trabajo o adaptación (manejo de cargas pesadas, sistemas antivibraciones, antirruido, adaptación a requisitos de seguridad, etc.). | 5 |

### *Tabla 2. Criterios de puntuación. Proyectos de inversiones materiales*

| Datos del solicitante (A), tipología de inversión subvencionable (B) y apartados del proyecto (C) | Datos del solicitante (A), tipología de inversión subvencionable (B) y apartados del proyecto (C) | Datos del solicitante (A), tipología de inversión subvencionable (B) y apartados del proyecto (C) | Puntuación máxima (MÁX) | Umbral de puntuación | Tipo de puntuación |
| --- | --- | --- | --- | --- | --- |
...
| A. Entidad solicitante. | A.1. Incorporación de la variable de género. | Que más del 45 % del órgano de dirección de la entidad esté integrado por mujeres. | 2 |  | B |
| A. Entidad solicitante. | A.1. Incorporación de la variable de género. | Que la máxima responsabilidad en la dirección técnica del proyecto/actuación recaiga en una mujer. | 2 |  | B |
| A. Entidad solicitante. | A.1. Incorporación de la variable de género. | Tener definido un Plan de igualdad en el supuesto de no ser obligatorio. | 2 |  | B |
| A. Entidad solicitante. | A.2. Integración laboral de las personas con discapacidad. | Para entidades con un número inferior a 50 trabajadores tener por lo menos 1 trabajador con discapacidad. | 2 |  | B |
| A. Entidad solicitante. | A.2. Integración laboral de las personas con discapacidad. | Para entidades con 50 o más trabajadores superar el límite legal establecido del 2 %. | 2 |  | B |
| B. Tipología de inversión subvencionable. | B. Tipología de inversión subvencionable. | B. Tipología de inversión subvencionable. | 25 | Ver tabla 1 | Ver tabla 1 |
| C.1. Justificación del proyecto y objetivos específicos en relación con la seguridad minera. | C.1. Justificación del proyecto y objetivos específicos en relación con la seguridad minera. | C.1. Justificación del proyecto y objetivos específicos en relación con la seguridad minera. | 2 |  | B |
| C.2. Descripción del proyecto. | C.2.1. Descripción técnica detallada y clara de los problemas a corregir. | C.2.1. Descripción técnica detallada y clara de los problemas a corregir. | 2 |  | B |
| C.2. Descripción del proyecto. | C.2.2. Metodología y condiciones técnicas de desarrollo del trabajo o trabajos: lugares y situación geográfica, centros donde se realizarán, soluciones propuestas, etc. | C.2.2. Metodología y condiciones técnicas de desarrollo del trabajo o trabajos: lugares y situación geográfica, centros donde se realizarán, soluciones propuestas, etc. | 8 |  | B |
| C.3. Fases de proyecto y calendario de trabajo. | C.3. Fases de proyecto y calendario de trabajo. | C.3. Fases de proyecto y calendario de trabajo. | 2 |  | B |
| C.4. Ejecución y dirección del proyecto por parte del solicitante. (Incluye subcontratación en su caso). | C.4. Ejecución y dirección del proyecto por parte del solicitante. (Incluye subcontratación en su caso). | C.4. Ejecución y dirección del proyecto por parte del solicitante. (Incluye subcontratación en su caso). | 2 |  | B |
| C.5. Presupuesto detallado. | C.5.1. Presupuesto total desglosado por conceptos y en su caso, con cálculos de costes unitarios e indicación de los criterios empleados para llegar a los mismos. | C.5.1. Presupuesto total desglosado por conceptos y en su caso, con cálculos de costes unitarios e indicación de los criterios empleados para llegar a los mismos. | 20 | 5 | V |
| C.5. Presupuesto detallado. | C.5.2. Ayuda solicitada y en su caso, plan de financiación. | C.5.2. Ayuda solicitada y en su caso, plan de financiación. | 2 |  | B |
| C.6. Planos. | C.6.1. Plano general señalando la ubicación de la inversión. | C.6.1. Plano general señalando la ubicación de la inversión. | 8 |  | V |
| C.6. Planos. | C.6.2. Planos de detalle correspondientes a los estados inicial y final. (incluye Perfiles y cortes en su caso). | C.6.2. Planos de detalle correspondientes a los estados inicial y final. (incluye Perfiles y cortes en su caso). | 10 | 2 | V |
| C.7. Fotografías donde se muestre el lugar o lugares de aplicación de las inversiones en su estado inicial. | C.7. Fotografías donde se muestre el lugar o lugares de aplicación de las inversiones en su estado inicial. | C.7. Fotografías donde se muestre el lugar o lugares de aplicación de las inversiones en su estado inicial. | 10 | 5 | V |
| C.8. Parte del Documento sobre seguridad y salud en la que se constate la inminencia del riesgo a corregir y la planificación de acción preventiva. | C.8. Parte del Documento sobre seguridad y salud en la que se constate la inminencia del riesgo a corregir y la planificación de acción preventiva. | C.8. Parte del Documento sobre seguridad y salud en la que se constate la inminencia del riesgo a corregir y la planificación de acción preventiva. | 5 |  | B |
...
| A. Actuaciones formativas en relación a riesgos de seguridad. | A.2 Riesgos específicos de las cintas transportadoras. | 30 |
| A. Actuaciones formativas en relación a riesgos de seguridad. | A.3 Caídas a distinto nivel. | 20 |
| A. Actuaciones formativas en relación a riesgos de seguridad. | A.4 Otros riesgos en establecimientos de beneficio. | 15 |
| A. Actuaciones formativas en relación a riesgos de seguridad. | A.5 Condiciones del terreno y su control. | 10 |
| A. Actuaciones formativas en relación a riesgos de seguridad. | A.6 Manipulación de cargas mediante maquinaria. | 5 |
...
| B. Actuaciones formativas en relación a riesgos higiénicos y ergonómicos específicos. | B.2 Lesiones físicas en los trabajadores por posturas forzadas, movimientos repetitivos y vibraciones. | 10 |
| B. Actuaciones formativas en relación a riesgos higiénicos y ergonómicos específicos. | B.3 Exposición al ruido. | 10 |
| C. Actividades formativas específicas. | C.1 Simulacros de evacuación en caso de emergencia. | 30 |
| C. Actividades formativas específicas. | C.2 Primeros auxilios. | 20 |
| C. Actividades formativas específicas. | C.3 Metodología de observación y coaching para el comportamiento. | 20 |
| C. Actividades formativas específicas. | C.4 Uso de autorrescatadores. | 15 |
| C. Actividades formativas específicas. | C.5 Trabajos de mantenimiento. | 10 |
| C. Actividades formativas específicas. | C.6 Trabajos eléctricos. | 5 |
| C. Actividades formativas específicas. | C.7 Uso de equipos de protección individual. | 5 |

### *Tabla 4. Criterios de puntuación. Actuaciones de formación*

| Concepto | Concepto | Puntos | Umbral de puntuación | Descripción |
| --- | --- | --- | --- | --- |
...
| 1. Calidad del equipo docente. | 1.2. Capacitación acreditada. | 0 a 5 | 2 | Los puntos otorgados son el resultado de multiplicar por 5 el cociente entre el número de docentes que cuentan con una experiencia mayor de cinco años en puestos de trabajo relacionados con las materias a impartir y el número total de docentes en la propuesta. |
| 1. Calidad del equipo docente. | 1.3. Experiencia docente acreditada. | 0 a 5 | 2 | Los puntos otorgados son el resultado de multiplicar por 5 el cociente entre el número de docentes que cuentan con más de 500 horas de docencia en la formación a impartir y el número total de docentes de la propuesta. |
| 1. Calidad del equipo docente. | 1.4. Formación en prevención de riesgos laborales. | 0 a 2 |  | Los puntos otorgados serán el resultado de aplicar la siguiente fórmula: Puntos = (n.º docentes con nivel básico + 1,5 x n.º docentes con nivel medio + 2 x n.º docentes con nivel superior)/Total docentes en la oferta. |
...
| 2. Metodología y material didáctico. | 2.2. Manual formativo. | 0 a 3 |  | Se otorgará hasta un máximo de 3 puntos en función del manual formativo aportado en la solicitud y su adecuación a los riesgos existentes en el puesto de trabajo de los alumnos destinatarios de la formación. Los puntos otorgados son el resultado de multiplicar por 3 el cociente entre la suma de las horas lectivas de aquellos cursos para los que se entregue un manual adecuado y el número de horas lectivas totales del proyecto formativo. |
| 2. Metodología y material didáctico. | 2.3. Método de evaluación de los alumnos. | 0 a 3 |  | Se otorgará hasta un máximo de 3 puntos en función de que los métodos de evaluación se adapten al puesto de trabajo de los alumnos destinatarios de la formación. Los puntos otorgados son el resultado de multiplicar por 3 el cociente entre la suma de las horas lectivas de aquellos cursos que empleen métodos de evaluación adaptados al puesto de trabajo de los alumnos a los que va dirigido y el número de horas lectivas totales del proyecto formativo. |
| 3. Tipología de cursos. | 3. Tipología de cursos. | 5 a 30 |  | Ver tabla 3. Los puntos otorgados son el resultado del cociente entre el valor obtenido al multiplicar el número de horas lectivas de los cursos destinados a cada uno de los riesgos específicos indicados más abajo por la puntuación asignada por riesgo específico, y el número de horas lectivas totales. Cada curso debe abordar un único riesgo específico. |
| 4. Optimización de recursos. | 4. Optimización de recursos. | 0 10 | 2 | Se asignará un máximo de 10 puntos, resultado de aplicar la siguiente fórmula: |
| 5. Incorporación de la variable de género. | 5. Incorporación de la variable de género. | 0 a 2 |  | Se asignará un máximo de 2 puntos en aquellos proyectos en donde la entidad beneficiaria, o el equipo docente, cumpla una de las siguientes condiciones: |
| 6. Integración laboral de las personas con discapacidad. | 6. Integración laboral de las personas con discapacidad. | 0 a 2 |  | Se asignará un máximo de 2 puntos en aquellos proyectos en donde la entidad beneficiaria, o el equipo docente, cumpla una de las siguientes condiciones: |
