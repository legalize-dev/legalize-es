...
pdf_url: "https://www.boe.es/boe/dias/2015/04/25/pdfs/BOE-A-2015-4520.pdf"
subjects: ["Comercialización", "Formularios administrativos", "Ganado caprino", "Ganado ovino", "Ganado vacuno", "Leche", "Ministerio de Agricultura Alimentación y Medio Ambiente", "Producción alimentaria", "Productos lácteos", "Registros administrativos", "Tasas"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/rd/2015/04/24/319"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-2015-4520"
url_pdf: "https://www.boe.es/boe/dias/2015/04/25/pdfs/BOE-A-2015-4520.pdf"
url_epub: "https://www.boe.es/diario_boe/epub.php?id=BOE-A-2015-4520"
url_pdf_catalan: "https://www.boe.es/boe_catalan/dias/2015/04/25/pdfs/BOE-A-2015-4520-C.pdf"
url_pdf_gallego: "https://www.boe.es/boe_gallego/dias/2015/04/25/pdfs/BOE-A-2015-4520-G.pdf"
page_start: "36129"
page_end: "36141"
image_marker: "A"
legislative_status: "L"
alerts: "Alimentación; Comercio; Ganadería y animales; Organización de la Administración"
references_previous: "DEROGA BOE-A-2013-2439; DEROGA BOE-A-2005-11750"
references_subsequent: "SE MODIFICA BOE-A-2022-8119; SE MODIFICA BOE-A-2021-794; SE MODIFICA BOE-A-2019-2979; SE MODIFICA BOE-A-2016-3652"
...
| D. | D. | D. |
| --- | --- | --- |
| NIF: | Con domicilio en: | Con domicilio en: |
| Actuando en nombre propio/en representación de: | Actuando en nombre propio/en representación de: | Actuando en nombre propio/en representación de: |
| Con NIF: | y domicilio social en: | y domicilio social en: |
| Localidad: | Municipio: | Municipio: |
| Provincia: | Código Postal: | Código Postal: |
| Teléfono: Fax: correo eléctronico: | Teléfono: Fax: correo eléctronico: | Teléfono: Fax: correo eléctronico: |
| Y con instalaciones en: | Y con instalaciones en: | Y con instalaciones en: |
...
| Litros entregados | Identificador Nº contrato 1<sup>1</sup> | TIPO PRECIO<sup>2</sup> |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| MEDIA MATERIA GRASA<sup>3</sup> (% con dos decimales) | MEDIA PROTEÍNA<sup>4</sup> (%con dos decimales) | IMPORTE TOTAL ABONADO<sup>5</sup> (€ con dos decimales) |
| --- | --- | --- |
|  |  |  |

> <sup>1</sup> Se hará constar el número de contrato que asigne la base de datos de contratos cuando se proceda al registro del mismo.

> <sup>2</sup> Fijo, variable, mixto.

> <sup>3</sup> Porcentaje (%) de materia grasa: Es la cantidad de materia grasa que forma parte de la composición de la leche, expresada en tanto por ciento en peso, con dos decimales Se indicará la media de materia grasa ponderada correspondiente al mes de que se trate según la información contenida en los boletines de análisis oficiales.

> <sup>4</sup> Porcentaje (%) Proteína: Expresa el contenido de proteína de la leche. Se indicará la media de proteína correspondiente al mes de que se trate según la información contenida en los boletines de análisis oficiales. En todo caso, con dos decimales.

> <sup>5</sup> Importe abonado al productor: Será la cantidad abonada al productor exclusivamente por la compra de leche, teniendo en cuenta bonificaciones y penalizaciones por calidad u otros conceptos y excluyendo el Impuesto sobre el Valor Añadido o el Impuesto General Indirecto Canario.
...
| Litros entregados (A) | Identificador Nº contrato 1<sup>6</sup> | TIPO PRECIO<sup>7</sup> |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| Valor medio mensual del grado<sup>8</sup> (% con dos decimales) | Importe total abonado<sup>9</sup> (B) (€ con dos decimales) | Importe medio (€/L)<sup>10</sup> (B/A) (€ con dos decimales) | Euros/hectogrado<sup>11</sup> (€ con dos decimales) |
| --- | --- | --- | --- |
|  |  |  |  |

> <sup>6</sup> Se hará constar el número de contrato que asigne la base de datos de contratos cuando se proceda a su registro.

> <sup>7</sup> Fijo, variable, mixto.

> <sup>8</sup> Grado: punto porcentual de extracto seco quesero (ESQ) de grasa más proteína, de cada litro de leche de oveja y cabra. Este valor puede ir referido en hectogrados, que es el valor porcentual en 100 litros de leche. Se indicará la media mensual ponderada de las compras de leche correspondientes al mes de que se trate contenida en los boletines de análisis oficiales.

> <sup>9</sup> Importe total abonado al productor: Será la cantidad abonada al productor exclusivamente por la compra de leche, teniendo en cuenta bonificaciones y penalizaciones por calidad u otros conceptos y excluyendo el Impuesto sobre el Valor Añadido o el Impuesto General Indirecto Canario

> <sup>10</sup> El importe medio abonado en euros/litro será el resultado de dividir el importe total abonado entre la cantidad de litros entregados.

> <sup>11</sup> Precio por grado: Precio por cada punto porcentual de extracto seco quesero (ESQ), de grasa y proteína, referido a un litro de leche. Precio por hectogrado: Precio por cada punto porcentual de extracto seco quesero (ESQ), de grasa y proteína, referido a 100 litros de leche.
...
| Litros entregados (A) | Identificador Nº contrato 1<sup>1</sup> | TIPO PRECIO<sup>2</sup> |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| Valor medio mensual del grado<sup>3</sup> (% con dos decimales) | Importe total abonado<sup>4</sup> (B) (€ con dos decimales) | Importe medio (€/L<sup>5</sup> (B/A) (€ con dos decimales) | Euros/hectogrado<sup>6</sup> (€ con dos decimales) |
| --- | --- | --- | --- |
|  |  |  |  |

> <sup>1</sup> Se hará constar el número de contrato que asigne la base de datos de contratos cuando se proceda a su registro.

> <sup>2</sup> Fijo, variable o mixto.

> <sup>3</sup> Grado: punto porcentual de extracto seco quesero (ESQ) de grasa más proteína, de cada litro de leche de oveja y cabra. Este valor puede ir referido en hectogrados, que es el valor porcentual en 100 litros de leche. Se indicará la media mensual ponderada de las compras de leche correspondientes al mes de que se trate contenida en los boletines de análisis oficiales.

> <sup>4</sup> Importe total abonado al productor: Será la cantidad abonada al productor exclusivamente por la compra de leche, teniendo en cuenta bonificaciones y penalizaciones por calidad u otros conceptos y excluyendo el Impuesto sobre el Valor Añadido o el Impuesto General Indirecto Canario.

> <sup>5</sup> El importe medio abonado en euros/litro será el resultado de dividir el importe total abonado entre la cantidad de litros entregados.

> <sup>6</sup> Precio por grado: Precio por cada punto porcentual de extracto seco quesero (ESQ), de grasa y proteína, referido a un litro de leche. Precio por hectogrado: Precio por cada punto porcentual de extracto seco quesero (ESQ), de grasa y proteína, referido a 100 litros de leche.
...
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |
| TELÉFONO | FAX | CORREO ELECTRÓNICO | CORREO ELECTRÓNICO | CORREO ELECTRÓNICO | CORREO ELECTRÓNICO |
|  |  |  |  |  |  |
...
![6210.png](https://www.boe.es/datos/imagenes/disp/2019/53/02979_6210.png)

> <small>Se añade por la disposición final 1.4 del Real Decreto 95/2019, de 1 de marzo. [Ref. BOE-A-2019-2979#df](https://www.boe.es/buscar/doc.php?id=BOE-A-2019-2979)</small>
