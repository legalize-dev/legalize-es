...
![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_007.png)
...
n<sub>b</sub>, n<sub>ca</sub> = El número de bancos y cajas de ahorros declarantes.
...
![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_008.png)
...
![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_009.png)
...
![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_010.png)

Siendo:

I<sub>e</sub> = índice efectivo
...
P<sub>i</sub> = Precio total de la operación

R<sub>i</sub> = Tipo de rendimiento interno de cada operación
...
![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_011.png)

Para el cálculo del tipo de depósitos interbancarios:

![](https://www.boe.es/datos/imagenes/disp/2012/161/09058_012.png)

Siendo:

R<sub>d</sub> = La media ponderada de los tipos de interés diarios, o la «Referencia interbancaria a un año», tal y como se define en el número 7 de este anejo, los días en que no se hayan cruzado operaciones en el mercado español

R<sub>i</sub>= Los tipos de interés de cada una de las operaciones cruzadas

E = El importe efectivo de cada operación

n = El número de operaciones cruzadas en el día

I<sub>DI</sub>= El tipo míbor a un año
