...
pdf_url: "https://www.boe.es/boe/dias/1988/04/08/pdfs/A10571-10580.pdf"
subjects: ["Análisis", "Envases", "Etiquetas", "Leche", "Normas de calidad"]
...
scope: "Estatal"
url_eli: "https://www.boe.es/eli/es/o/1988/03/28/(4)"
url_html_consolidada: "https://www.boe.es/buscar/act.php?id=BOE-A-1988-8753"
url_pdf: "https://www.boe.es/boe/dias/1988/04/08/pdfs/A10571-10580.pdf"
page_start: "10571"
page_end: "10580"
image_marker: "A"
legislative_status: "L"
references_previous: "DE CONFORMIDAD con BOE-A-1983-19755; DE CONFORMIDAD con BOE-A-1982-21847"
references_subsequent: "SE DEROGA BOE-A-2016-11480; SE DEROGA BOE-A-2013-3402"
...
Norma derogada por la disposición derogatoria única del Real Decreto 600/2016, de 2 de diciembre. [Ref. BOE-A-2016-11480#dd](https://www.boe.es/buscar/doc.php?id=BOE-A-2016-11480).
...
| Contenido de cenizas (P<sub>2</sub>O<sub>5</sub> incluido) | (máx.) 2,5 m/m | (min.) 7,5 m/m |
...
> <small>Se derogan los apartados 7, 8.1, 8.4, 9.2, 9.3, 10, 11 excepto subapartado1,12,13 y 14 por el art. 44.1 del Real Decreto 176/2013, de 8 de marzo. [Ref. BOE-A-2013-3402](https://www.boe.es/buscar/doc.php?id=BOE-A-2013-3402).</small>
...
> <small>Se derogan los apartados 7, 8.1, 8.4, 9, 10, 11 excepto subapartado1,12,13 y 14 por el art. 44.2 del Real Decreto 176/2013, de 8 de marzo. [Ref. BOE-A-2013-3402](https://www.boe.es/buscar/doc.php?id=BOE-A-2013-3402).</small>
...
![](https://www.boe.es/datos/imagenes/disp/1988/85/08753_001.png)
...
5.2.2 Colocar la tapa sobre la cápsula, introducir la cápsula así tapada en el desecador (4.4), dejar enfriar a temperatura ambiente y pesar con precisión de 0,1 miligramos (m<sub>0</sub>).

5.3 Muestra de prueba: Introducir de 3 a 5 gramos de la muestra para prueba (5.1) en la cápsula, tapar ésta y pesar con precisión de 0,1 miligramos (m<sub>1</sub>).
...
Designemos como m<sub>2</sub> la masa final registrada, en gramos.
...
|  | μ<sub>1</sub> – μ<sub>2</sub> | × 100 |
| --- | --- | --- |
|  | μ<sub>1</sub> – μ<sub>0</sub> | × 100 |

donde:

m<sub>0</sub> = Masa en gramos de la cápsula y su tapa tras la operación 5.2.

m<sub>1</sub>= Masa en gramos de la cápsula, su tapa y la muestra de prueba antes del secado (5.3).

m<sub>2</sub> = Masa en gramos de la cápsula, su tapa y la muestra de prueba tras el secado (5.4.3 ó 5.4.4).
...
4.1 Ácido sulfúrico concentrado D<sub>20</sub>, 1,84 g/ml.

4.2 Sulfato de potasio anhidro (K<sub>2</sub>SO<sub>4</sub>).

4.3 Sulfato de cobre (II) pentahidratado (CuSO<sub>4</sub>-5H<sub>2</sub>O).

4.4 Sacarosa (C<sub>12</sub>H<sub>22</sub>O<sub>11</sub>).
...
| (V<sub>1</sub>– V<sub>2</sub>) × T × 14 × 100 × 6,38 | = | 8,932 (V<sub>1</sub> – V<sub>2</sub>) × T |
| --- | --- | --- |
| m × 1.000 | = | m |

donde:

V<sub>1</sub> = Volumen en mililitros de la solución estándar de ácido clorhídrico (4.7) utilizado para la determinación (6.5).

V<sub>2</sub> = Volumen en mililitros de la solución estándar de ácido clorhídrico (4.7) utilizada para el ensayo en blanco.
...
# Determinación de cenizas (P<sub>2</sub> O<sub>5</sub> incluido)

### 1. Objeto y ámbito de aplicación

El presente método permite determinar las cenizas de: Las caseínas ácidas (P<sub>2</sub> O<sub>5</sub> incluido).

### 2. Definición

Cenizas (P<sub>2</sub>O<sub>5</sub> incluido): Sustancias determinadas según el metodo descrito a continuación, expresadas como porcentaje en masa.
...
### Mg (CH<sub>3</sub>CO<sub>2</sub>)<sub>2</sub>, 4H<sub>2</sub>O, solución de 120 g/l
...
7.1 Modo y fórmula de cálculo: Las cenizas (P<sub>2</sub>O<sub>5</sub> incluido) de la muestra, expresadas como porcentaje en masa, viene dadas por la fórmula:

|  | (m<sub>1</sub> – m<sub>2</sub>) – (m<sub>3</sub> – m<sub>4</sub>) | × 100 |
| --- | --- | --- |
|  | m<sub>0</sub> | × 100 |

donde

m<sub>0</sub> = Masa, en gramos, de la muestra de prueba.

m<sub>1</sub>= Masa, en gramos, de la cápsula A con su contenido.

m<sub>2</sub> = Masa, en gramos, de la cápsula A vacía.

m<sub>3</sub> = Masa, en gramos, de la cápsula B con su contenido.

m<sub>4</sub> = Masa, en gramos, de la cápsula B vacía.
...
Cenizas (P<sub>2</sub>O<sub>5</sub> incluido): Sustancias determinadas según el método descrito a continuación y expresados como porcentaje en masa.
...
6.1 Método y fórmula de cálculo. Las cenizas (P<sub>2</sub>O<sub>5</sub> incluido) de la muestra, expresadas como porcentaje en masa, vienen dadas por la fórmula:

|  | m<sub>1</sub> – m<sub>2</sub> | × 100 |
| --- | --- | --- |
|  | m<sub>0</sub> | × 100 |
...
m<sub>1</sub> = Masa, en gramos, de la cápsula con su contenido.

m<sub>2</sub> = Masa, en gramos, de la cápsula vacía.
