...
a) Para el producto de 5 MW: El consumo medio horario durante el periodo de entrega en cada periodo tarifario, menos el valor de la potencia residual de referencia (P<sub>max</sub>), deberá ser igual o superior al recurso asignado.
...
![](https://www.boe.es/datos/imagenes/disp/2013/262/11461_001.png)
...
P<sub>rog</sub><sub>h</sub>: programa de consumo horario para la hora h (kWh)
