...
: Retribución total del gestor técnico del sistema en el año *n*.

: Base de retribución del gestor técnico del sistema en el año *n*. Será aquella del periodo regulatorio *p* al que el año *n* pertenezca.

: Retribución por incentivos del gestor técnico del sistema en el año *n*.
...
1. El margen sobre el término de retribución por OPEX  incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p,* se calculará a partir de la siguiente fórmula:

Donde:

: Margen, en porcentaje (%).

2. El margen  se establece en un 5 %.
