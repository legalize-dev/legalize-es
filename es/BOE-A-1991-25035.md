...
El valor máximo de la resistencia a la tracción Rm,máx deberá ser inferior a 580 N/mm².
...
El valor máximo de la resistencia a la tracción Rm,máx deberá ser inferior o igual a 350 N/mm2.
...
2.1 Espesor de las paredes.–Si el producto PS.V es inferior o igual a 3 bar.m3, el fabricante seleccionará uno de los métodos descritos en los puntos 2.1.1 y 2.1.2 para determinar el espesor de las paredes del recipiente; si el producto PS.V es superior a 3 bar.m3 o si la temperatura máxima de servicio sobrepasa los 100 ºC, el espesor se determinará por el método descrito en el punto 2.1.1
...
A = alargamiento de rotura (LO= 5,65 V SO), porcentaje.
