...
| Países | B | O/C | P | S | Observaciones |
| --- | --- | --- | --- | --- | --- |
| Países | Productos cárnicos de animales domésticos | Productos cárnicos de animales domésticos | Productos cárnicos de animales domésticos | Productos cárnicos de animales domésticos | Observaciones |
| Albania. | ‒ | X | X | X | ‒ |
| Argentina. | X | X | ‒ | X | (1) |
| Australia. | X | X | X | X | ‒ |
| Austria. | X | X | X | X | ‒ |
