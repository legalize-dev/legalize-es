...
| Tecnología | Código de identificación de la instalación tipo de referencia | Grupo/subgrupo (art. 2 Real Decreto 413/2014) | Año de autorización de explotación definitiva «a» | Código de identificación de la instalación tipo | m<sub>ITR_j,a</sub> |
| --- | --- | --- | --- | --- | --- |
