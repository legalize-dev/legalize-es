...
|  |  | Euros |
| --- | --- | --- |
| 1. | Por evaluación de un expediente de una sustancia activa (nueva o existente) para su inclusión en el anexo I, IA o IB: | 100.000 |
| 2. | Por evaluación (autorización o registro) de un expediente de un producto biocida: | 2.100 |
| 3. | Por evaluación (autorización o registro) de un expediente en aplicación de formulaciones marco: | 1.000 |
| 4. | Por reconocimiento de autorizaciones o registros concedidos en otros Estados Miembros: | 1.000 |
| 5. | Por autorizaciones provisionales: | 7.500/producto +4.500/sustancia activa |
| 6. | Por uso temporal de productos biocidas (120 días): | 2.100 |
| 7. | Por notificación sobre el procedimiento orientado a investigación y desarrollo: | 2.100 |
