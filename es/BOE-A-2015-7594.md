...
![1](https://www.boe.es/datos/imagenes/disp/2015/161/07594_10972.png)
...
*CF*<sub>s</sub>: estimación del coste en frontera del gas natural en el semestre natural ‘s’, expresado en c€/KWh<sub>PCS</sub> y calculado de acuerdo a la siguiente ecuación:

![1](https://www.boe.es/datos/imagenes/disp/2015/161/07594_11103.png)
...
*RL*<sub>s</sub>: valor que resulte de la aplicación de la fórmula siguiente:

![1](https://www.boe.es/datos/imagenes/disp/2015/161/07594_11151.png)
...
*PA*<sub>s,j</sub>: estimación del coste de los peajes de acceso para el año del semestre ‘s’ y que esté en vigor en dicho semestre, aplicables a un consumidor acogido al escalón ‘j’ del Grupo 2 expresado en c€/KWh<sub>PCS</sub> y calculado de acuerdo a la siguiente ecuación:

![1](https://www.boe.es/datos/imagenes/disp/2015/161/07594_11193.png)

donde *β*<sub>s</sub> se corresponde con lo descrito anteriormente y el resto de parámetros:

*Trf*<sub>s</sub>: término fijo del peaje de regasificación expresado en c€/kWh/día/mes.

*Trc*<sub>s</sub>: término de reserva de capacidad del peaje de transporte y distribución expresado en c€/kWh/mes.

*Tfc*<sub>s,j</sub>: término fijo del término de conducción del escalón ‘j’ del Grupo 2 expresado en c€/kWh/dia/mes.

*Tvc*<sub>s,j</sub>: término variable del término de conducción del peaje de transporte y distribución del escalón ‘j’ del Grupo 2 expresado en c€/kWh.

*Tvr*<sub>s</sub>: término variable del peaje de regasificación expresado en c€/kWh.

*Tgnl*<sub>s</sub>: peaje de almacenamiento de GNL expresado en c€/MWh/día.

*Cas*<sub>s</sub>: coste de almacenamiento subterráneo expresado en c€/kWh y calculado mediante la siguiente fórmula:

![1](https://www.boe.es/datos/imagenes/disp/2015/161/07594_11236.png)

donde:

*Drs*<sub>s</sub>: Número de días de almacenamiento estratégico.

*Tfas*<sub>s</sub>: Término fijo del canon de almacenamiento subterráneo expresado en c€/kWh/mes.

*Tvi*<sub>s</sub>: Término de inyección del canon de almacenamiento subterráneo expresado en c€/KWh.

*Tve*<sub>s</sub>: Término de extracción del canon de almacenamiento subterráneo expresado en c€/kWh.
