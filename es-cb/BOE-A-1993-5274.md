...
|  |  | Pesetas |
| --- | --- | --- |
| Tasa mínima por autorizaciones para construcciones de obra de los apartados a, b, c y d siguientes. | Tasa mínima por autorizaciones para construcciones de obra de los apartados a, b, c y d siguientes. | 3.000 |
...
| Por cada ml. o fracción totalmente ocupada a partir de 6 ml. | Por cada ml. o fracción totalmente ocupada a partir de 6 ml. | 500 |
| b) Autorización para la construcción de cerramientos provisionales con materiales de clase inferior como alambre, estacas u otros elementos análogos o similares: | b) Autorización para la construcción de cerramientos provisionales con materiales de clase inferior como alambre, estacas u otros elementos análogos o similares: |  |
| Por cada ml. o fracción a partir de 30 ml. | Por cada ml. o fracción a partir de 30 ml. | 100 |
...
| Por cada ml. de fachada y por cada planta a la vía regional a partir de 4 ml. | Por cada ml. de fachada y por cada planta a la vía regional a partir de 4 ml. | 750 |
...
| Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | 25.000 |
| Accesos de anchura de la plataforma de la vía que accede de mas de 7 metros. | Accesos de anchura de la plataforma de la vía que accede de mas de 7 metros. | 50.000 |

Tarifa 2. Obras de conservación y reparación.

|  |  | Pesetas |
| --- | --- | --- |
| Tasa mínima por autorizaciones para reparaciones y conservación de obras de los apartados a, b y c siguientes. | Tasa mínima por autorizaciones para reparaciones y conservación de obras de los apartados a, b y c siguientes. | 2.000 |
...
| Por cada hueco, a partir de cinco huecos. | Por cada hueco, a partir de cinco huecos. | 400 |
| Por cada ml. de fachada y por cada planta a la vía regional a partir de 10 ml. | Por cada ml. de fachada y por cada planta a la vía regional a partir de 10 ml. | 200 |
...
| Por cada ml. o fracción a partir de 6 ml. | Por cada ml. o fracción a partir de 6 ml. | 200 |
...
| Por cada ml. o fracción a partir de 30 ml. | Por cada ml. o fracción a partir de 30 ml. | 65 |
...
| Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | 4.000 |
| Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | 10.000 |
| Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | 20.000 |
...
| Tasa mínima por autorización para instalaciones y canalizaciones de 105 apartados a, b, c, d, e, f y g siguientes. | Tasa mínima por autorización para instalaciones y canalizaciones de 105 apartados a, b, c, d, e, f y g siguientes. | 3.000 |
...
| Por cada metro cuadrado de superficie total ocupada dentro de la zona de influencia a partir de los 3 metros cuadrados. | Por cada metro cuadrado de superficie total ocupada dentro de la zona de influencia a partir de los 3 metros cuadrados. | 1.000 |
...
| Por cada poste o elementos a partir de tres postes. | Por cada poste o elementos a partir de tres postes. | 1.000 |
| c) Autorización para la apertura de zanjas para la colocación de conductores de líquidos para abastecimientos, alcantarillado, riegos y drenaje, y para nuevas conducciones de energía eléctrica, líneas de comunicación, gas. etc.: | c) Autorización para la apertura de zanjas para la colocación de conductores de líquidos para abastecimientos, alcantarillado, riegos y drenaje, y para nuevas conducciones de energía eléctrica, líneas de comunicación, gas. etc.: |  |
| Por cada ml. de conducción transversal a la calzada a partir de los 4 ml. | Por cada ml. de conducción transversal a la calzada a partir de los 4 ml. | 750 |
| Por cada ml. de conducción longitudinal a la calzada a partir de 20 ml. | Por cada ml. de conducción longitudinal a la calzada a partir de 20 ml. | 150 |
| d) Autorización por apertura de pozos, sondeos, etc.: | d) Autorización por apertura de pozos, sondeos, etc.: |  |
| Por cada unidad a partir de una. | Por cada unidad a partir de una. | 3.000 |
...
| Por cada metro cuadrado o fracción ocupada y por cada año, en su caso, a partir de 4 metros cuadrados. | Por cada metro cuadrado o fracción ocupada y por cada año, en su caso, a partir de 4 metros cuadrados. | 750 |
| g) Autorización de talas: | g) Autorización de talas: |  |
| Por cada ml. o fracción de zona de tala en línea paralela a la vía a partir de 10 ml. | Por cada ml. o fracción de zona de tala en línea paralela a la vía a partir de 10 ml. | 300 |
