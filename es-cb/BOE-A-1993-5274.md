...
| --- | --- | --- | --- |
|  | Clase de navegación | Clase de navegación | Clase de navegación |
| Por periodos completos de veinticuatro horas y fracciones superiores a seis horas. | I | 300 | 1.539 |
| Por periodos completos de veinticuatro horas y fracciones superiores a seis horas. | II | 180 | 923 |
| Por la fracción de hasta seis horas. | I | 150 | 770 |
| Por la fracción de hasta seis horas. | II | 90 | 462 |
...
| Vías de entrada y salida de las mercancías y tipo de comercio | Origen inicial nacional | Origen Inicial extranjero | Origen Inicial nacional | Origen Inicial extranjero |
| --- | --- | --- | --- | --- |
| Vías de entrada y salida de las mercancías y tipo de comercio | Entradas | Entradas | Entradas | Entradas |
| Vías de entrada y salida de las mercancías y tipo de comercio | Por vía terrestre | Por vía terrestre | Por vía marítima | Por vía marítima |
| Salidas del puerto |  |  |  |  |
| Por vía terrestre: |  |  |  |  |
| Destino final nacional. | 1,0 | 4,0 | 1,0 | * |
...
| Grupo de mercancías | Cabotaje Embarque/ desembarque – Pesetas/Tonelada de peso o fracción | Embarque – Pesetas/tonelada de peso o fracción | Desembarque – Pesetas/ tonelada de peso o fracción |
| --- | --- | --- | --- |
| Grupo de mercancías | Cabotaje Embarque/ desembarque – Pesetas/Tonelada de peso o fracción | Exterior | Exterior |
...
| Días de ocupación | A) Zona de tránsito | B) Zona de almacenamiento |
| --- | --- | --- |
| Días de ocupación | Pesetas por metro cuadrado y día | Pesetas por metro cuadrado y día |
| 1,° y 2.° días. | ‒ | ‒ |
...
| Tráfico | Bloque (1) — Pesetas | Bloque (2) — Pesetas | Motocicletas — Pesetas | Turismos — Pesetas | Furgonetas, caravanas — Pesetas | Autocares 20 plazas — Pesetas | Autocares 20 plazas — Pesetas |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Tráfico | Pasajeros | Pasajeros | Vehículos | Vehículos | Vehículos | Vehículos | Vehículos |
...
| Grupo | Embarque — Pesetas | Desembarque — Pesetas | Embarque — Pesetas | Desembarque — Pesetas |
| --- | --- | --- | --- | --- |
| Grupo | Cabotaje | Cabotaje | Exterior | Exterior |
...
| --- | --- | --- | --- | --- | --- |
| Tipo de plazas | Medidas entre fingers | Tarifa — Pesetas/mes | Tarifa — Pesetas/mes | Tarifa — Pesetas/mes | Tarifa — Pesetas/mes |
| Tipo de plazas | Medidas entre fingers | Tarifa reducida (Con embarcación amarrada antes del 1 de enero de 2001) | Tarifa reducida (Con embarcación amarrada antes del 1 de enero de 2001) | Tarifa normal (Con embarcación amarrada después del 1 de enero de 2001) | Tarifa normal (Con embarcación amarrada después del 1 de enero de 2001) |
| Tipo de plazas | Medidas entre fingers | General | Jubilados | General | Jubilados |
...
|  |  | Pesetas |
| --- | --- | --- |
| a) Por subida, estancia durante las primeras veinticuatro horas (dos mareas) y bajada | a) Por subida, estancia durante las primeras veinticuatro horas (dos mareas) y bajada | 7.955 |
| b) Por estancia durante las segundas veinticuatro horas (dos mareas) | b) Por estancia durante las segundas veinticuatro horas (dos mareas) | 4.227 |
| c) Por estancia durante las terceras veinticuatro horas (dos mareas) | c) Por estancia durante las terceras veinticuatro horas (dos mareas) | 5.919 |
| d) Por estancia durante las cuartas veinticuatro horas (dos mareas) | d) Por estancia durante las cuartas veinticuatro horas (dos mareas) | 8.452 |
| e) Por estancia durante cada veinticuatro horas siguientes | e) Por estancia durante cada veinticuatro horas siguientes | 12.682 |
...
|  |  | Pesetas |
| --- | --- | --- |
| a) Por cada día o fracción a pinazas, gabarras, embarcaciones para servicio del puerto y buques de comercio | a) Por cada día o fracción a pinazas, gabarras, embarcaciones para servicio del puerto y buques de comercio | 588 |
| b) Por cada día o fracción a buques de pesca con cubierta y embarcaciones de recreo con motor | b) Por cada día o fracción a buques de pesca con cubierta y embarcaciones de recreo con motor | 292 |
| c) Por cada día o fracción a buques de pesca sin cubierta y embarcaciones de recreo sin motor | c) Por cada día o fracción a buques de pesca sin cubierta y embarcaciones de recreo sin motor | 80 |
...
|  |  | Pesetas |
| --- | --- | --- |
| Tasa mínima por autorizaciones para construcciones de obra de los apartados a, b, c y d siguientes. | Tasa mínima por autorizaciones para construcciones de obra de los apartados a, b, c y d siguientes. | 6.000 |
| a) Autorización para la construcción de pasos salvacunetas para peatones y vehículos aceras muros de contención y/o de cerramientos de hierros, sillería piedra ladrillo y otros materiales de clase análoga o superior: | a) Autorización para la construcción de pasos salvacunetas para peatones y vehículos aceras muros de contención y/o de cerramientos de hierros, sillería piedra ladrillo y otros materiales de clase análoga o superior: |  |
| Por cada metro lineal o fracción totalmente ocupada a partir de 6 metros lineales. | Por cada metro lineal o fracción totalmente ocupada a partir de 6 metros lineales. | 750 |
| b) Autorización para la construcción de cerramientos provisionales con materiales de clase inferior como alambre, estacas u otros elementos análogos o similares: | b) Autorización para la construcción de cerramientos provisionales con materiales de clase inferior como alambre, estacas u otros elementos análogos o similares: |  |
| Por cada metro lineal o fracción a partir de 30 metros lineales. | Por cada metro lineal o fracción a partir de 30 metros lineales. | 150 |
| c) Autorización para la construcción y ampliación de edificios destinados a viviendas, oficinas y comercios, construcciones de naves, casetas para transformadores, naves industriales, almacenes y garajes y otros similares: | c) Autorización para la construcción y ampliación de edificios destinados a viviendas, oficinas y comercios, construcciones de naves, casetas para transformadores, naves industriales, almacenes y garajes y otros similares: |  |
| Por cada metro lineal de fachada y por cada planta a la vía regional a partir de 4 metros lineales. | Por cada metro lineal de fachada y por cada planta a la vía regional a partir de 4 metros lineales. | 1.500 |
| d) Autorización para la construcción de nuevo acceso a la vía regional en función de la potencial afección del mismo a la seguridad vial. | d) Autorización para la construcción de nuevo acceso a la vía regional en función de la potencial afección del mismo a la seguridad vial. |  |
| Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | 25.000 |
| Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros | Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros | 50.000 |
| Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | 100.000 |

Tarifa 2. Obras de conservación y reparación.

|  |  | Pesetas |
| --- | --- | --- |
| Tasa mínima por autorizaciones para reparaciones y conservación de obras de los apartados a, b y c siguientes. | Tasa mínima por autorizaciones para reparaciones y conservación de obras de los apartados a, b y c siguientes. | 4.000 |
| a) Autorizaciones para reparación o modificación esencial de huecos de fachadas, reformas y reparación de edificios, entendiendo por tales las que afecten a partes esenciales de los mismos, como travesías, entramados horizontales o cubiertas, obras de revoco y retejado, la suma, en su caso, de las siguientes: | a) Autorizaciones para reparación o modificación esencial de huecos de fachadas, reformas y reparación de edificios, entendiendo por tales las que afecten a partes esenciales de los mismos, como travesías, entramados horizontales o cubiertas, obras de revoco y retejado, la suma, en su caso, de las siguientes: |  |
| Por cada hueco, a partir de cinco huecos. | Por cada hueco, a partir de cinco huecos. | 600 |
| Por cada metro lineal de fachada y por cada planta a la vía regional a partir de 10 metros lineales. | Por cada metro lineal de fachada y por cada planta a la vía regional a partir de 10 metros lineales. | 300 |
| b) Autorización para la reparación del grupo a), tarifa 1 anterior: | b) Autorización para la reparación del grupo a), tarifa 1 anterior: |  |
| Por cada metro lineal o fracción a partir de 6 metros lineales. | Por cada metro lineal o fracción a partir de 6 metros lineales. | 300 |
| c) Autorización para la reparación del grupo b), tarifa 1 anterior: | c) Autorización para la reparación del grupo b), tarifa 1 anterior: |  |
| Por cada metro lineal o fracción a partir de 30 metros lineales. | Por cada metro lineal o fracción a partir de 30 metros lineales. | 100 |
| d) Autorización para la reparación del grupo d), tarifa 1 anterior: | d) Autorización para la reparación del grupo d), tarifa 1 anterior: |  |
| Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | Accesos de anchura de la plataforma de la vía que accede menor o igual a 4 metros. | 10.000 |
| Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | Accesos de anchura de la plataforma de la vía que accede de 4 a 7 metros. | 20.000 |
| Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | Accesos de anchura de la plataforma de la vía que accede de más de 7 metros. | 25.000 |

Tarifa 3. Instalaciones y canalizaciones.

|  |  | Pesetas |
| --- | --- | --- |
| «Autorizaciones previas condicionadas» para instalación de estaciones de servicio y otro tipo de instalación que requieran crear o utilizar un acceso de la carretera | «Autorizaciones previas condicionadas» para instalación de estaciones de servicio y otro tipo de instalación que requieran crear o utilizar un acceso de la carretera | 50.000 |
| Tasa mínima por autorización para instalaciones y canalizaciones de los apartados a), b), c), d), e), f) y g) siguientes. | Tasa mínima por autorización para instalaciones y canalizaciones de los apartados a), b), c), d), e), f) y g) siguientes. | 5.500 |
...
| Por cada metro cuadrado de superficie total ocupada dentro de la zona de influencia a partir de los 3 metros cuadrados. | Por cada metro cuadrado de superficie total ocupada dentro de la zona de influencia a partir de los 3 metros cuadrados. | 1.500 |
...
| Por cada poste o elementos a partir de tres postes. | Por cada poste o elementos a partir de tres postes. | 2.000 |
| c) Autorización para la apertura de zanjas para la colocación de conductores de líquidos para abastecimientos, alcantarillado, riegos y drenajes, y para nuevas conducciones de energía eléctrica, líneas de comunicación, gas. etc.: | c) Autorización para la apertura de zanjas para la colocación de conductores de líquidos para abastecimientos, alcantarillado, riegos y drenajes, y para nuevas conducciones de energía eléctrica, líneas de comunicación, gas. etc.: |  |
| Por cada metro lineal de conducción transversal a la calzada a partir de los 4 metros lineales. | Por cada metro lineal de conducción transversal a la calzada a partir de los 4 metros lineales. | 2.000 |
| Por cada metro lineal de conducción longitudinal a la calzada a partir de 20 metros lineales. | Por cada metro lineal de conducción longitudinal a la calzada a partir de 20 metros lineales. | 300 |
| d) Autorización por apertura de pozos, sondeos, etc.: | d) Autorización por apertura de pozos, sondeos, etc.: |  |
| Por cada unidad a partir de una. | Por cada unidad a partir de una. | 6.000 |
| e) Autorización de canteras y yacimientos de toda clase, renovables cada año: | e) Autorización de canteras y yacimientos de toda clase, renovables cada año: |  |
| Para extracción anual igual o inferior a 100 metros cúbicos y por cada año. | Para extracción anual igual o inferior a 100 metros cúbicos y por cada año. | 11.000 |
| Para extracción anual superior a 100 metros cúbicos y por cada año. | Para extracción anual superior a 100 metros cúbicos y por cada año. | 26.000 |
| f) Autorización de ocupación temporal de aceras, arcenes y/o terrenos en la zona de dominio público con instalaciones provisionales de cualquier tipo: | f) Autorización de ocupación temporal de aceras, arcenes y/o terrenos en la zona de dominio público con instalaciones provisionales de cualquier tipo: |  |
| Por cada metro cuadrado o fracción ocupada y por cada año, en su caso, a partir de 4 metros cuadrados. | Por cada metro cuadrado o fracción ocupada y por cada año, en su caso, a partir de 4 metros cuadrados. | 1.000 |
| g) Autorización de talas: | g) Autorización de talas: |  |
| Por cada metro cuadrado o fracción de zona de tala en línea paralela a la vía a partir de 10 metros lineales. | Por cada metro cuadrado o fracción de zona de tala en línea paralela a la vía a partir de 10 metros lineales. | 1,80 euros |
